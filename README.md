...
- Dungeon, Thronebound, Tutorial, Bond, Personal, Guild, and Bounty quests
...
- Lustria scouting, resource-vein discovery, extraction, Combat Power gates, and conquest

## Starting progression

Tier 0 contains only the Throne Room. The Thronebound is Classless. Define the identity and four resources, enter System Mode in the Throne Room, summon the first Administrator (always the Manager), then fill the current Administrator Capacity and pay the Tier cost to awaken Tier 1.
...
Values separated by `|` are distinct fields. Administrator targets may use an Administrator ID or exact name.

 ...
 * Development State: Progression-gated player interface and Tier 0-3 Story spine implemented; Tier 4-10 branching framework defined; Tier 2 deployment sealed.
...
(function installDungeonManagement(global) {
  ...
  const SAVE_CARD_RESERVE_PREFIX = "DMS_SAVE_RESERVE_";
  ...
  const ACTIVITY_PACES = Object.freeze({ Idle: ["Timeless"], System: ["Timeless"], Travel: ["Slow", "Standard", "Fast"], Survey: ["Slow", "Standard"], Construction: ["Slow", "Standard", "Fast"], Administration: ["Timeless", "Slow", "Standard"], Production: ["Slow", "Standard", "Fast"], Training: ["Slow", "Standard"], Bond: ["Slow", "Standard"], Recruitment: ["Timeless", "Slow"], Defense: ["Timeless", "Slow", "Fast"], Exploration: ["Slow", "Standard"], Exploitation: ["Standard", "Fast"] });
  ...
  const QUEST_CATEGORIES = Object.freeze(["Story", "Dungeon", "Thronebound", "Tutorial", "Bond", "Personal", "Guild", "Bounty"]);
  const QUEST_MISSION_TYPES = Object.freeze(["Internal", "Investigation", "Hunt", "Bounty", "Escort", "Exploration", "Survey", "Gathering", "Defense", "Recovery", "Subjugation", "Dungeon Raid", "Emergency"]);
  const STORY_SECTOR_STATES = Object.freeze(["Unobserved", "Initial Observation", "Local Survey", "Encountered", "Mapped", "Established"]);
  const STORY_DEVELOPMENT_PATHS = Object.freeze({
    concealment: Object.freeze({ name: "Concealment", doctrine: "Hidden Dominion", intent: "Reduce exposure, conceal routes, and make discovery difficult." }),
    "controlled-contact": Object.freeze({ name: "Controlled Contact", doctrine: "Measured Exchange", intent: "Permit selected contact while controlling access and information." }),
    "dominion-accord": Object.freeze({ name: "Dominion Accord", doctrine: "Recognized Accord", intent: "Seek regulated recognition and negotiate from within Dominion law." }),
    patronage: Object.freeze({ name: "Patronage", doctrine: "Chosen Patronage", intent: "Secure protection and opportunity through a powerful external relationship." }),
    "armed-independence": Object.freeze({ name: "Armed Independence", doctrine: "Sovereign Deterrence", intent: "Preserve autonomy through visible defensive and military strength." })
  });
  const STORY_TIER_FRAMEWORK = Object.freeze({
    ...
    5: Object.freeze({ chain: "Claims", purpose: "Resolve the Dungeon's first durable claim to routes, resources, or territory.", structure: "entry → selected-path claim → convergence" }),
    6: Object.freeze({ chain: "Rival Powers", purpose: "Confront rivalry, alliance, vassalage, or proxy conflict with another Dungeon power.", structure: "entry → selected-path response → convergence" }),
    7: Object.freeze({ chain: "Sovereign Doctrine", purpose: "Advance or revise the Dungeon's doctrine as Advanced development becomes possible.", structure: "entry → doctrine trial → convergence" }),
    8: Object.freeze({ chain: "Lustrian Stakes", purpose: "Accept the political consequences of large-scale operations and conquest.", structure: "entry → regional consequence → convergence" }),
    9: Object.freeze({ chain: "Worldway", purpose: "Define the Dungeon's interworld posture toward Lustria and the Thronebound's Homeworld.", structure: "entry → worldway branch → convergence" }),
    10: Object.freeze({ chain: "Legacy", purpose: "Resolve the Dungeon's sovereign capstone and the legacy it leaves across connected worlds.", structure: "entry → final doctrine expression → capstone" })
  });
  const SYSTEM_CONCEPTS = Object.freeze([
    ...
    Object.freeze({ id: "story-progress", command: "story progress", tier: 0, triggerGroups: Object.freeze([{ all: ["story", "progress"] }, { all: ["story", "map"] }, { all: ["campaign", "progress"] }]) }),
  ...
  const RESOURCE_GRADES = CLASS_GRADES;
  ...
  const GLOBAL_LUSTRIA_LORE = Object.freeze([
    Object.freeze({
      title: "Lore — Nexus Realm of Lustria",
      keys: "Lustria, nexus realm of Lustria, artificial nexus realm",
      entry: "Lustria is an artificial nexus realm attributed to the Architect. Dungeon gates connect it to otherwise separate worlds. Its immense, shifting landscapes contain magical ecosystems, contested resources, and ruins older than present civilizations. No current power has proven itself Lustria's original inheritor, and the realm's intended purpose remains unknown."
    }),
    Object.freeze({
      title: "Lore — The Architect",
      keys: "the Architect, creator of Lustria, Architect mystery, Architect's purpose",
      entry: "The Architect is the presumed maker of Lustria, dungeon thrones, and the nexus's interworld design. Current peoples possess evidence of the Architect's work but no confirmed knowledge of the creator's identity, species, motives, location, or ultimate purpose. Apotheosis may reveal capabilities without resolving those mysteries."
    }),
    Object.freeze({
      title: "Lore — Architect Ruins and Relics",
      keys: "Architect ruins, Architect relics, ancient nexus ruins, energized relic material",
      entry: "Ruins and artifacts attributed to the Architect predate Lustria's present powers. Their materials, energy, and functions can support research, construction, portal studies, and dungeon development. Similar design does not prove every ruin served the same purpose, and recovered capabilities do not reveal the Architect's identity or intent."
    }),
    Object.freeze({
      title: "Lore — Lustrian Peoples",
      keys: "Lustrian peoples, native Lustrians, Lustrian city-states, Lustrian nomads",
      entry: "Lustria contains peoples from countless connected worlds and communities that consider themselves native to the nexus. Empires, kingdoms, refugee city-states, nomadic societies, faiths, colonies, and adventurer communities coexist. No ancestry or culture represents every Lustrian, and claims of original inheritance remain disputed."
    }),
    Object.freeze({
      title: "Lore — Crossworld Culture",
      keys: "crossworld culture, connected-world customs, portal diaspora, interworld community",
      entry: "Lustrian communities mix languages, customs, religions, technologies, and magical traditions carried through dungeon gates. Some preserve a strong Homeworld identity; others form new portal diasporas or blended cultures. Familiar ancestry does not guarantee shared values, and comparable practices may arise from unrelated worlds."
    }),
    Object.freeze({
      title: "Lore — Dominion of Lustria",
      keys: "Dominion of Lustria, Dominion Overseers, Dominion tribute, dungeon regulation",
      entry: "The Dominion claims sovereignty over much of Lustria and fields its largest organized military. It presents itself as guardian of nexus stability and regulates dungeons, gates, tribute, and strategic regions. Because defeated dungeons may become dormant and reform, Dominion policy emphasizes surveillance, restriction, political control, and containment rather than relying on permanent eradication."
    }),
    Object.freeze({
      title: "Lore — Dungeon Thrones",
      keys: "dungeon throne, throne-core, Architect throne, dormant throne",
      entry: "A dungeon throne is an enduring Architect construct that acts as the dungeon's core and heart. It channels Lustrian power and stabilizes dungeon functions. A defeated or masterless dungeon may enter dormancy, rebuild, and reconnect because the throne's underlying principle persists even when its current manifestation is lost."
    }),
    Object.freeze({
      title: "Lore — Thronebound Bond",
      keys: "Thronebound bond, bound Dungeon master, throne bond, Dungeon's chosen master",
      entry: "The Thronebound is the individual bound to a dungeon throne as its active master and interpretive will. The bond grants System access, Gate Authority, and influence over the dungeon's development while tying the Thronebound's progression to the throne. It does not erase personality, origin, responsibility, or outside relationships."
    }),
    Object.freeze({
      title: "Lore — Dungeon Themes",
      keys: "Dungeon Theme, thematic Dungeon, inherited Dungeon Theme, Theme expression",
      entry: "A Dungeon Theme is the pattern through which its throne and Thronebound express architecture, rooms, resources, inhabitants, hazards, abilities, and atmosphere. The same mechanical function can manifest in radically different forms. The Thronebound's choices shape interpretation, and an inherited or divine Theme does not dictate morality."
    }),
    Object.freeze({
      title: "Lore — Dungeon Growth",
      keys: "Dungeon growth, throne development, dungeon expansion, Theme development",
      entry: "A dungeon grows by increasing the stable power and complexity its throne can support. Tier advancement unlocks new facilities and higher-order functions; construction creates their themed manifestations; Expansion increases a facility's working scale; facility Tier Ups improve its quality and yield. Growth need not correspond to a larger mapped floor plan."
    }),
    Object.freeze({
      title: "Lore — Gate Authority",
      keys: "Gate Authority, personal Dungeon portal, return portal, portal stability",
      entry: "Gate Authority is a Thronebound's ability to invoke the dungeon's nexus connection, not necessarily a learned spell. Unless externally suppressed, it can open a limited return portal from the Thronebound's position to the dungeon. Early use is small, brief, and constrained by the dungeon's daily portal stability. Travel outward follows separate Anchor rules."
    }),
    Object.freeze({
      title: "Lore — Lustrian Magic",
      keys: "Lustrian magic, innate magic, learned magic, Symbology",
      entry: "Lustria is highly saturated with mana. Magic includes innate gifts and learned disciplines: bodily enhancement, sensory or mana affinity, Symbology, incantation, spirit work, healing, protection, and destructive arts. Connected worlds may possess their own magic or comparable forces, so Lustrian scholars classify effects without requiring one universal theory."
    }),
    Object.freeze({
      title: "Lore — Enchanted Craft",
      keys: "enchanted craft, Lustrian artificing, magical equipment, crafted enchantment",
      entry: "Lustrian craft binds magical function into tools, armor, weapons, vehicles, structures, and consumables. Methods include Symbology, alchemy, spirit work, crystal engineering, biological cultivation, and imported technologies. An item's Grade measures refinement; its form and operating theory remain culturally and thematically specific."
    }),
    Object.freeze({
      title: "Lore — Evolution",
      keys: "Lustrian Evolution, Evolution breakthrough, magical metamorphosis, evolved being",
      entry: "Evolution occurs when a being accumulates enough power and stability to contain and express a more advanced state. Results may be subtle, biological, magical, technological, or entirely non-biological. Evolution usually improves capability, resilience, and lifespan, but it does not guarantee visible transformation, immortality, or identical outcomes across species."
    }),
    Object.freeze({
      title: "Lore — Lustrian Ecosystems",
      keys: "Lustrian ecosystems, mana-bearing flora, magical fauna, artificial ecology",
      entry: "Lustria contains crystalline deserts, bioluminescent forests, mana-bearing plants, metal-skinned beasts, and other ecologies that cross ordinary biological categories. Mana, Resonance Cores, dungeon emissions, ancient systems, and neighboring Sectors can influence an ecosystem. Adjacent environments may differ radically without being illusory."
    }),
    Object.freeze({
      title: "Lore — Lustrian Resource Sites",
      keys: "Lustrian resource Site, resource vein, harvest Site, extractable vein",
      entry: "A Lustrian resource Site is a specific vein, grove, deposit, ruin, creature habitat, or magical phenomenon that can yield useful materials. A dungeon must discover and assess a Site before targeting it. Extraction depends on access, ownership, logistics, remaining reserves, danger, and compatible facilities rather than discovery alone."
    }),
    Object.freeze({
      title: "Lore — Adventurer Guilds of Lustria",
      keys: "Lustrian Adventurer Guild, Guild quest, adventurer rank, dungeon raid",
      entry: "Adventurer Guilds professionalize dangerous work that would otherwise require armies. They operate in major cities, train and rank members, and connect clients with qualified adventurers. Dominion authorities sponsor many operations, while private and illegal patrons also commission work. Adventurers may protect, exploit, raid, or work for dungeons according to shifting loyalties."
    }),
    Object.freeze({
      title: "Lore — Rival Dungeons",
      keys: "rival Dungeon, rival Thronebound, competing Dungeon, Dungeon rivalry",
      entry: "Rival dungeons compete for territory, gates, resources, followers, and influence. Their Thronebound range from new claimants to established powers with servants, allies, and political networks. A rival is not automatically hostile; competition may become trade, alliance, espionage, tribute, sabotage, a raid, or war."
    }),
    Object.freeze({
      title: "Lore — Dungeon Politics",
      keys: "Dungeon politics, Dungeon diplomacy, Dungeon alliance, Dungeon tribute",
      entry: "Dungeons act as political powers once others can identify and negotiate with them. Relations may involve recognition, secrecy, treaties, trade, alliances, tribute, vassalage, espionage, territorial boundaries, or war. Dungeon Tier affects leverage but does not decide legitimacy, trust, or diplomatic outcome by itself."
    }),
    Object.freeze({
      title: "Lore — Lustrian Trade",
      keys: "Lustrian merchant guild, cross-portal trade, portal merchants, interworld commerce",
      entry: "Merchant guilds move goods, information, and contracts among Lustrian factions and through stabilized dungeon gates. Where rare resources or portal access are involved, their leverage can rival local rulers. Trade connects incompatible world economies through barter, Lustrian Marks, contracts, and negotiated access to transportation."
    }),
    Object.freeze({
      title: "Lore — Native Resource Interests",
      keys: "Lustrian native interests, resource stewardship, local resource rights, indigenous resource claim",
      entry: "Lustrian resources may already be inhabited, claimed, cultivated, revered, or protected. Local communities often value territorial rights and long-term stewardship even where a dungeon sees an unused resource vein. Ownership and cultural significance must be discovered rather than assumed absent."
    }),
    Object.freeze({
      title: "Lore — Dungeon Expansion Conflict",
      keys: "Dungeon expansion conflict, contested extraction, territorial extraction dispute, expansion resistance",
      entry: "Dungeon construction, extraction, and territorial control can disrupt existing communities, ecologies, trade routes, and claims. Conflict may be avoided or intensified through reconnaissance, negotiation, compensation, stewardship, secrecy, coercion, or conquest. Mechanical access to a resource does not establish uncontested ownership."
    }),
    Object.freeze({
      title: "Lore — Dungeon Tiers",
      keys: "Dungeon Tier system, nexus maturity, dungeon throughput, Tier advancement",
      entry: "Dungeon Tier is Lustria's conventional measure of a throne-dungeon nexus's maturity and stable throughput. It measures how much power the dungeon can safely draw, stabilize, distribute, and express. Tier does not directly measure physical size, room count, army size, or the Thronebound's personal strength. Each Tier from 0 through 10 has its own classification card."
    }),
    Object.freeze({
      title: "Lore — Dungeon Administrators",
      keys: "Dungeon Administrator, Administrator manifestation, major-linked individual, Administrator summoning",
      entry: "Administrators are sapient major-linked individuals created, summoned, or manifested through a throne's interpretation of Dungeon Theme, active roles, current needs, Thronebound influence, and accumulated knowledge. Their existence and growth strongly benefit from the dungeon, encouraging loyalty without removing personality, disagreement, ambition, or independent relationships."
    }),
    Object.freeze({
      title: "Lore — Dungeon-Supported Population",
      keys: "Dungeon-supported population, Worker origin, Soldier origin, population manifestation",
      entry: "A dungeon creates or acquires Workers and Soldiers through Theme-consistent means such as summoning, fabrication, growth, animation, spirit embodiment, recruitment, or immigration. Relevant Administrators stabilize and organize the process but need not be the population's biological source. The method is narrative; the Dungeon System treats each result as supported population."
    }),
    Object.freeze({
      title: "Lore — Lustrian Power Classification",
      keys: "Lustrian power classification, Dominion appraisal, capability classification, crossworld appraisal",
      entry: "Dominion and Guild appraisers use standardized Tier, Class, Grade, Rank, and specialization terms to compare capabilities from incompatible worlds. These labels describe measurable function without dictating appearance or metaphysics. Evolution Tier, Class, Class Tier, Skill, Trait, Rank, and Grade each have separate meanings and individual cards."
    }),
    Object.freeze({
      title: "Lore — Dungeon Resource Roles",
      keys: "Dungeon resource roles, Construction resource, Sustenance resource, Development resource",
      entry: "Dungeon Systems classify themed substances by strategic role rather than appearance: Construction builds and upgrades; Sustenance supports population; Development advances linked characters; Energy powers dungeon functions and serves as internal currency. Stone, steel, living bone, nanomaterial, condensed shadow, or another substance may fill the same role."
    }),
    Object.freeze({
      title: "Lore — Construction Resource",
      keys: "Construction Resource role, dungeon building material, facility construction material, room upgrade material",
      entry: "The Construction Resource is the dungeon's themed material for building facilities, expanding them, and completing structural Tier Ups. Its name, appearance, source, and collection method are unique to the Dungeon Theme. The System tracks its amount and role consistently even when it is metal, crystal, living matter, force, or something stranger."
    }),
    Object.freeze({
      title: "Lore — Sustenance Resource",
      keys: "Sustenance Resource role, population sustenance, dungeon food resource, workforce upkeep resource",
      entry: "The Sustenance Resource supports the dungeon's Workers, Soldiers, and other dependent population. It may be food, biomass, mana, fuel, maintenance substrate, spiritual essence, or another Theme-consistent necessity. Its narrative form is player-defined; facilities produce and consume it through the shared dungeon economy."
    }),
    Object.freeze({
      title: "Lore — Development Resource",
      keys: "Development Resource role, linked character development, Administrator development material, Thronebound advancement material",
      entry: "The Development Resource is the themed substance used to advance the Thronebound and Administrators. It supports Class Ups, training, Rank development, and other linked-character functions when appropriate facilities are available. It is distinct from general Energy even if the Dungeon Theme describes both as related forces."
    }),
    Object.freeze({
      title: "Lore — Dungeon Energy",
      keys: "Dungeon Energy role, internal Dungeon currency, themed Dungeon energy, facility power currency",
      entry: "Dungeon Energy is the throne's primary operational and development currency. It powers construction, facilities, research, portals, training, summoning, and other System functions. Its lore name and manifestation are unique to the Dungeon Theme. Unlike material resources, it represents usable stabilized power rather than one required substance."
    }),
    Object.freeze({
      title: "Lore — Lustrian Marks",
      keys: "Lustrian Mark, Dominion currency, authenticated Mark, Lustrian trade currency",
      entry: "The Lustrian Mark is the Dominion's official currency and a common denominator among incompatible world economies. Taxes, tribute, Guilds, merchants, and the Veil use it, alongside barter. A Mark is authenticated value rather than one mandatory object and may appear as coin, note, magical seal, crystal balance, or account record."
    }),
    Object.freeze({
      title: "Lore — Dominion Dungeon Law",
      keys: "Tier 4 legal limit, Tier 5 authorization, Dominion charter, unsanctioned Dungeon",
      entry: "Dominion practice generally treats Tier 4 as the ceiling of unsanctioned dungeon development, not a physical limit or an identical law everywhere. A discovered dungeon seeking Tier 5+ recognition may face registration, tribute, inspection, territorial agreements, or a charter. Lower-Tier dungeons may still break law through conquest, forbidden research, illegal gates, attacks, or disputed claims."
    }),
    Object.freeze({
      title: "Lore — Lustrian Sectors",
      keys: "Lustrian Sector, Sector manifestation, operational Sector, Sector boundary",
      entry: "A Sector is a Lustrian region whose magical environment is internally consistent enough to map and treat as one operational area; its physical size is not fixed. Natural nexus processes, Architect systems, dungeon influence, old ruins, divine forces, magical disasters, and neighboring interference may shape its manifestation."
    }),
    Object.freeze({
      title: "Lore — Linked Servants",
      keys: "Linked Servant, external Dungeon servant, bonded retainer, external bonded being",
      entry: "A Linked Servant is an existing external being joined to a dungeon bond. They are not automatically an Administrator, though one may later receive that office. Linked Servants retain an identity and origin outside the dungeon. Their access, support, obligations, and development depend on the separate Core Bond joining them to it."
    }),
    Object.freeze({
      title: "Lore — Lustrian Rank Convention",
      keys: "Lustrian Rank system, operational Rank, F-to-SSS scale, ranked capability",
      entry: "Lustria uses F, E, D, C, B, A, S, SS, and SSS as a shared operational scale for Administrators, adventurers, threats, quests, and some professions. Rank is relative to a field, not interchangeable personal power: an A-Rank researcher and A-Rank combatant are not equivalent. Each Rank has an individual card."
    }),
    Object.freeze({
      title: "Lore — Wild Dungeons",
      keys: "Wild Dungeon, instinctive Thronebound, Dungeon-created master, feral Dungeon",
      entry: "A Wild Dungeon lacks a conventional civilized Thronebound or has a master that is instinctive, incomprehensible, missing, or inseparable from the dungeon. Its origin may involve a chosen beast, dungeon-created master, failed manifestation, inherited memory, or throne operating through instinct; none is universally proven. Guilds treat Wild Dungeons as unpredictable ecological and military hazards."
    }),
    Object.freeze({
      title: "Lore — Dungeon Conflict Outcomes",
      keys: "defeated Dungeon outcome, Dungeon defeat terms, postwar Dungeon, Dungeon conquest outcome",
      entry: "Dungeon defeat is not one universal result. Recognized outcomes include political Submission, metaphysical Vassalization, and Core Consumption. A victor may also receive a limited Dungeon Legacy. These concepts have separate cards because each changes sovereignty, Theme influence, resources, and possible reformation differently."
    }),
    Object.freeze({
      title: "Lore — Lustrian Geographic Hierarchy",
      keys: "Realm Region Sector Site, Lustrian Region, Lustrian Site, geographic hierarchy",
      entry: "Lustria uses the practical hierarchy Realm → Region → Sector → Site. Lustria is the Realm. A Region is a broad cultural or environmental grouping. A Sector is an operational magical area. A Site is a specific city, ruin, vein, settlement, dungeon, Guild hall, fortress, anomaly, Resonance Core, or other local destination."
    }),
    Object.freeze({
      title: "Lore — Dungeon Signatures",
      keys: "Dungeon Signature, dungeon emissions, signature fingerprint, artifact authentication",
      entry: "Every dungeon produces a metaphysical Signature derived from its throne, Theme, Thronebound, Tier, and current activity. It can authenticate portals and artifacts, distinguish populations, reveal environmental alterations, expose vassal influence, and identify emissions. Signature strength generally rises with Tier and active operations; concealment changes detection, not true identity."
    }),
    Object.freeze({
      title: "Lore — Resonance",
      keys: "magical Resonance, resonant compatibility, Lustrian resonance principle, resonance pattern",
      entry: "Resonance is the Lustrian principle that magical patterns influence compatible patterns. It is shared descriptive language, not proof that every phenomenon uses one mechanism. Scholars apply it to Crystals, Themes, Signatures, Anchors, bonds, Sector Cores, and vassal influence. Other cultures may explain the same relationships through divinity, biology, technology, or different magic."
    }),
    Object.freeze({
      title: "Lore — Portal Anchors",
      keys: "portal Anchor, recorded spatial signature, known Anchor, anchored destination",
      entry: "An Anchor is a spatial signature the dungeon has recorded and can target repeatedly. Outbound dungeon portals open only to valid known Anchors. Early Anchors normally require the Thronebound to visit the destination personally. Later methods can create transferable Gateway Anchors, but interference, suppression, or damage may still prevent a connection."
    }),
    Object.freeze({
      title: "Lore — Portal Gate Development",
      keys: "Portal Gate facility, Gateway Anchor, portal throughput, stable Dungeon gate",
      entry: "A Portal Gate improves portal diameter, duration, mass throughput, traveler count, operating frequency, and destination stability. It enables durable Gateway Anchors, whose physical form adapts to the Dungeon Theme. The facility strengthens known routes; it does not eliminate Anchor requirements or external suppression."
    }),
    Object.freeze({
      title: "Lore — World Gate Array",
      keys: "World Gate Array, Tier 9 gate network, coordinated major gates, interworld logistics array",
      entry: "A World Gate Array is the Tier 9 capstone of dungeon portal development. It coordinates multiple major gates, high-throughput routes, remote operations, and Homeworld–Lustria logistics while relaxing many earlier operating limits. Valid Anchors, energy, route security, and resistance from outside powers remain relevant."
    }),
    Object.freeze({
      title: "Lore — Resonance Crystals",
      keys: "Resonance Crystal, Crystal evolution service, evolution conduit, Resonance Crystal city",
      entry: "Resonance Crystals guide and stabilize difficult Evolution breakthroughs. Their influence enriches nearby land, so major crystals often anchor prosperous settlements, training centers, pilgrimages, and regulated or paid evolution services. A crystal assists a compatible being in crossing a threshold; it does not guarantee readiness or determine the resulting form."
    }),
    Object.freeze({
      title: "Lore — The Veil",
      keys: "the Veil, Veil smuggler, Veil intelligence, black quest network",
      entry: "The Veil is a covert Lustrian network of traders, smugglers, mercenaries, and informants serving clients who evade Dominion oversight. It deals in restricted artifacts, intelligence, transport, and black quests. Cooperation offers discreet access and information but exposes a dungeon to betrayal, criminal rivals, and political consequences."
    }),
    Object.freeze({
      title: "Lore — The Verdant Accord",
      keys: "Verdant Accord, Lustrian independence movement, local resource movement, anti-Dungeon expansion",
      entry: "The Verdant Accord is a broad independence and stewardship movement associated with tribes, refugees, and communities seeking local control over Lustrian land and resources. It is not one uniform state or ideology. Accord-aligned groups may negotiate sustainable access, resist Dominion control, oppose dungeon extraction, or cooperate with a dungeon that respects local claims."
    }),
    Object.freeze({
      title: "Lore — Administrator Capacity",
      keys: "Administrator Capacity, major-link capacity, Administrator slot, high-order Dungeon link",
      entry: "Administrator Capacity measures how many persistent high-order links a throne can stabilize in addition to the primary Thronebound bond. Each Administrator consumes far more nexus support than an ordinary Worker or Soldier. Standard capacity is 1 + twice Dungeon Tier. Filling that capacity demonstrates stable distribution before the dungeon advances."
    }),
    ...[
      { tier: 0, keys: "Tier 0 Dungeon, newly bound Dungeon, dormant Dungeon structure", entry: "Tier 0 is a newly bound or reawakened dungeon. Its throne has accepted a Thronebound but supports only the Throne Room, one Administrator link, limited Gate Authority, and the minimum functions needed to become stable. The Thronebound remains Classless until Tier 1." },
      { tier: 1, keys: "Tier 1 Dungeon, first-tier Dungeon, young Dungeon foundation", entry: "Tier 1 is a young functional dungeon. It can establish its basic resource economy, habitation, development facilities, and first Class Selection. Its standard Administrator Capacity is 3. The dungeon has begun expressing its Theme but remains locally limited." },
      { tier: 2, keys: "Tier 2 Dungeon, second-tier Dungeon, young Dungeon expansion", entry: "Tier 2 is a developing young dungeon able to support Soldiers, organized training, administration, and initial Lustrian scouting. Its standard Administrator Capacity is 5. It can project power outside the Throne Room but does not yet possess mature extraction or major gates." },
      { tier: 3, keys: "Tier 3 Dungeon, third-tier Dungeon, established Dungeon entry", entry: "Tier 3 marks an established dungeon. It can sustain stronger defense, equipment work, population organization, and extraction from discovered Lustrian veins. Its standard Administrator Capacity is 7. External factions increasingly treat it as a durable local actor." },
      { tier: 4, keys: "Tier 4 Dungeon, fourth-tier Dungeon, established Dungeon ceiling", entry: "Tier 4 is a mature established dungeon with research, custom development, coordinated warfare, and major storage. Its standard Administrator Capacity is 9. Dominion practice usually treats Tier 4 as the ceiling of unsanctioned growth, though it is not a physical barrier." },
      { tier: 5, keys: "Tier 5 Dungeon, fifth-tier Dungeon, major Dungeon", entry: "Tier 5 is a major dungeon capable of stable interworld infrastructure and advanced education. Its Portal Gate can move people and resources more reliably, making the dungeon a geopolitical power. Its standard Administrator Capacity is 11, and discovered advancement commonly attracts Dominion authorization demands." },
      { tier: 6, keys: "Tier 6 Dungeon, sixth-tier Dungeon, major Dungeon development", entry: "Tier 6 is a deeply developed major dungeon able to sustain elite military cohorts and high-order construction coordination. Its standard Administrator Capacity is 13. Its infrastructure can reshape operations across multiple Sectors rather than serving only local survival." },
      { tier: 7, keys: "Tier 7 Dungeon, seventh-tier Dungeon, high-order Dungeon", entry: "Tier 7 is a high-order dungeon with Advanced-grade developmental potential and the ability to observe distant or dangerous Lustrian Sectors. Its standard Administrator Capacity is 15. Its Signature and environmental influence are difficult to hide through ordinary means." },
      { tier: 8, keys: "Tier 8 Dungeon, eighth-tier Dungeon, sovereign-scale Dungeon", entry: "Tier 8 is sovereign-scale. It can coordinate sustained conquest, govern controlled Sectors, and challenge established regional powers. Its standard Administrator Capacity is 17. Other dungeons and the Dominion judge its diplomacy, armies, and territorial ambitions as strategic threats or alliance opportunities." },
      { tier: 9, keys: "Tier 9 Dungeon, ninth-tier Dungeon, interworld Dungeon power", entry: "Tier 9 is an interworld power. A World Gate Array can coordinate multiple high-throughput routes, remote operations, and Homeworld–Lustria logistics. Its standard Administrator Capacity is 19. Its decisions can affect several worlds and major Lustrian political balances." },
      { tier: 10, keys: "Tier 10 Dungeon, tenth-tier Dungeon, apotheotic Dungeon threshold", entry: "Tier 10 is the apotheotic or Architect-class threshold of known Dungeon development. It supports Mastery-grade work, perfected facilities, and sovereign capstone functions. Its standard Administrator Capacity is 21. Apotheosis grants new capabilities and deeper mysteries; it does not reveal the Architect's identity or Lustria's final purpose." }
    ].map(item => Object.freeze({ title: `Lore — Dungeon Tier ${item.tier}`, keys: item.keys, entry: item.entry })),
    Object.freeze({
      title: "Lore — Administrator Level",
      keys: "Administrator Level, Level 1 Administrator, Administrator experience, Administrator leveling",
      entry: "Administrator Level records experience and development accumulated after manifestation. A newly summoned Administrator normally begins at Level 1 even when their Rank is high. Levels improve through participation, quests, training, and dungeon-supported growth; they do not redefine the Administrator's original manifestation quality."
    }),
    Object.freeze({
      title: "Lore — Administrator Rank",
      keys: "Administrator Rank, manifestation quality, summon Rank, Rank-up bond",
      entry: "Administrator Rank measures the quality, stability, potential, and assignment effectiveness of an Administrator's manifestation. It is distinct from Level and role. Rank is initially determined at summoning; research may improve the odds or minimum quality, while later Rank Ups require development and a sufficiently strong Thronebound bond."
    }),
    ...[
      { rank: "F", keys: "F-Rank, Rank F, F-Rank Administrator", entry: "F-Rank is the minimum stable operational classification. It indicates limited foundation or effectiveness within the measured field, not worthlessness or lack of future growth. An F-Rank Administrator can improve through experience, Bond, development, and eventual Rank Up." },
      { rank: "E", keys: "E-Rank, Rank E, E-Rank Administrator", entry: "E-Rank indicates a limited but established operational foundation. It exceeds the minimum viable F classification while remaining below ordinary professional reliability. Rank describes present category and potential, not personality, loyalty, or Level." },
      { rank: "D", keys: "D-Rank, Rank D, D-Rank Administrator", entry: "D-Rank indicates developing operational capability. A D-Rank individual or assignment can perform meaningful work but remains below Lustria's broadly standard C classification. Field and specialization always determine what that capability means in practice." },
      { rank: "C", keys: "C-Rank, Rank C, C-Rank Administrator", entry: "C-Rank is the broadly standard reliable Lustrian operational classification. It represents competent function within the relevant field, not identical combat power. A C-Rank Administrator, adventurer, researcher, threat, and quest are compared within different contexts." },
      { rank: "B", keys: "B-Rank, Rank B, B-Rank Administrator", entry: "B-Rank indicates clearly above-standard operational capability, quality, or difficulty within a field. B-Rank subjects are notable assets or hazards but remain within classifications that established Lustrian institutions can routinely plan around." },
      { rank: "A", keys: "A-Rank, Rank A, A-Rank Administrator", entry: "A-Rank indicates exceptional operational capability, quality, or difficulty. A-Rank figures and threats command serious institutional attention. The classification remains field-specific: an A-Rank support Administrator is not automatically equivalent to an A-Rank combatant." },
      { rank: "S", keys: "S-Rank, Rank S, S-Rank Administrator", entry: "S-Rank indicates elite capability or manifestation quality beyond ordinary professional scales. S-Rank entities are rare strategic assets or threats. A newly summoned S-Rank Administrator may still be Level 1 because Rank and accumulated experience measure different things." },
      { rank: "SS", keys: "SS-Rank, Rank SS, SS-Rank Administrator", entry: "SS-Rank indicates extraordinary capability or quality even among elite S classifications. Institutions treat SS-Rank subjects as major strategic factors requiring specialized preparation, authority, or containment. Exact expression still depends on field, role, and specialization." },
      { rank: "SSS", keys: "SSS-Rank, Rank SSS, SSS-Rank Administrator", entry: "SSS-Rank is the rare upper bound of the conventional Lustrian Rank scale. It marks near-singular quality, capability, or danger within a field without declaring omnipotence. SSS remains distinct from Dungeon Tier, Evolution Tier, Grade, role, and Level." }
    ].map(item => Object.freeze({ title: `Lore — Rank ${item.rank}`, keys: item.keys, entry: item.entry })),
    Object.freeze({
      title: "Lore — Dungeon Cohorts",
      keys: "Dungeon cohort, Worker cohort, Soldier cohort, cohort advancement",
      entry: "A cohort groups dungeon population by function, approximate Tier, training standard, and support level; it does not imply identical individuals. When the dungeon grows, an existing cohort does not transform at once. Qualified members gradually form a higher-Tier cohort, with training facilities increasing advancement rates. Worker Tier improves job effectiveness; Soldier Tier improves combat power."
    }),
    Object.freeze({
      title: "Lore — Evolution Tier",
      keys: "Evolution Tier, personal Evolution stage, evolved Tier, biological Tier",
      entry: "Evolution Tier measures the overall stage of a being's magical and physical development: how much power they can safely contain and express. It is distinct from Dungeon Tier and Class Tier. Different bodies, species, technologies, and magical traditions can reach comparable Evolution Tiers through completely different transformations."
    }),
    Object.freeze({
      title: "Lore — Dungeon Classes",
      keys: "Dungeon Class, Class Selection, Class path, throne-shaped Class",
      entry: "A Dungeon Class is an organized developmental pattern shaped by the throne to direct a linked character's growth efficiently. During Class Selection, the throne presents several compatible future paths rather than dictating one destiny. Class names and manifestations follow the Dungeon Theme and individual; outside appraisers may see only Tier, Grade, and specialization."
    }),
    Object.freeze({
      title: "Lore — Class Tier",
      keys: "Class Tier, Class evolution stage, Class Up, Class progression Tier",
      entry: "Class Tier records progress along one Class path. It is limited by Dungeon Tier because the throne must stabilize each higher-order pattern. A Class Up evolves the current Class, adds new Class abilities, and may branch into several compatible paths. Class Tier does not replace Level or Evolution Tier."
    }),
    Object.freeze({
      title: "Lore — Skills",
      keys: "Class Skill, General Skill, learned Skill, Skill mastery",
      entry: "A Skill is a learned, trained, deliberately acquired, or Class-granted capability that the user actively expresses. Skills have names, functions, mastery, and—when applicable—Grades. Combat, management, craft, movement, and supernatural techniques can all be Skills. Training improves mastery; a Skill is not an intrinsic Trait merely because it is magical."
    }),
    Object.freeze({
      title: "Lore — Traits",
      keys: "Class Trait, General Trait, intrinsic Trait, Trait mastery",
      entry: "A Trait is a persistent quality intrinsic to a being's current nature, such as resistance, physiology, perception, temperament, or a stable supernatural property. Traits may be natural, evolved, Class-granted, or purchased through dungeon development. They remain distinct from actions and techniques classified as Skills."
    }),
    Object.freeze({
      title: "Lore — Grades",
      keys: "Grade system, ability Grade, resource Grade, Grade advancement",
      entry: "Grade measures the quality, potency, structural refinement, and suitability of an ability or resource for higher-order work. It does not measure rarity alone and is distinct from Tier and Rank. Ordinary Grades progress from Grade 1 Basic through Grade 4 Mastery. Each Grade has an individual card."
    }),
    ...[
      { grade: 1, name: "Basic", keys: "Grade 1, Basic Grade, Grade-1 resource, Basic-grade Skill", entry: "Grade 1 Basic is the first ordinary Grade. It supports foundational abilities, materials, construction, and development associated with Dungeon Tiers 1–3. Basic does not mean useless; it means the subject has not crossed the refinement threshold required for Intermediate work." },
      { grade: 2, name: "Intermediate", keys: "Grade 2, Intermediate Grade, Grade-2 resource, Intermediate-grade Skill", entry: "Grade 2 Intermediate is the second ordinary Grade, conventionally available from Dungeon Tier 4. It represents enough purity, mastery, or structural refinement for work beyond foundational limits and normally covers Tiers 4–6." },
      { grade: 3, name: "Advanced", keys: "Grade 3, Advanced Grade, Grade-3 resource, Advanced-grade Skill", entry: "Grade 3 Advanced is the third ordinary Grade, conventionally available from Dungeon Tier 7. Advanced abilities and resources support high-order work across Tiers 7–9 and require facilities capable of producing, refining, training, or stabilizing that quality." },
      { grade: 4, name: "Mastery", keys: "Grade 4, Mastery Grade, Grade-4 resource, Mastery-grade Skill", entry: "Grade 4 Mastery is the fourth ordinary Grade and corresponds to the Tier 10 threshold. It represents perfected conventional refinement rather than absolute perfection. Mastery-grade production and advancement require capstone facilities and appropriate materials." }
    ].map(item => Object.freeze({ title: `Lore — Grade ${item.grade} ${item.name}`, keys: item.keys, entry: item.entry })),
    Object.freeze({
      title: "Lore — Special Ability Grades",
      keys: "special ability Grade, nonstandard Grade, exceptional ability classification, special Grade system",
      entry: "Some abilities use special classifications outside ordinary Basic-to-Mastery progression. Unique, Apex, and Growth each describe a different reason the ordinary Grade ladder is insufficient. They are not interchangeable, and a special Grade does not automatically make an ability stronger than every ordinarily graded ability."
    }),
    ...[
      { name: "Unique", keys: "Unique Grade, uniquely graded ability, identity-bound ability, singular ability Grade", entry: "Unique Grade marks an ability defined by singular identity, origin, conditions, or expression that ordinary comparison cannot adequately describe. It may be narrow or powerful. Unique identifies exceptional individuality, not guaranteed supremacy, and its improvement follows the ability's own stated rules." },
      { name: "Apex", keys: "Apex Grade, Apex ability, peak-expression ability, apex-class Skill", entry: "Apex Grade marks an ability recognized as an exceptional peak expression of its kind. It is not produced by an ordinary random Grade roll and should arise from explicit lore, achievement, evolution, or singular development. Apex remains bounded by the ability's function, user, costs, and circumstances." },
      { name: "Growth", keys: "Growth Grade, Growth ability, self-evolving Skill, growth-class Trait", entry: "Growth Grade marks an ability whose structure can evolve beyond a fixed ordinary Grade through use, milestones, compatible resources, or defined conditions. Its current effectiveness may begin modestly. Growth describes developmental potential and rules rather than immediate superiority." }
    ].map(item => Object.freeze({ title: `Lore — ${item.name} Grade`, keys: item.keys, entry: item.entry })),
    Object.freeze({
      title: "Lore — Dominion Dungeon Detection",
      keys: "Dungeon detection, Dominion detection, signature tracking, Dungeon discovery chance",
      entry: "Dungeon detection is cumulative rather than purely random. Higher Tier, large portals, major construction, high-grade energy use, population activity, repeated expeditions, and territorial control strengthen observable emissions. Overseers, spies, relics, and Resonance-Core analysis can identify or investigate a Dungeon Signature."
    }),
    Object.freeze({
      title: "Lore — Dungeon Signature Suppression",
      keys: "signature suppression, emission suppression, hidden Dungeon Tier, suppression facility",
      entry: "Signature-suppression facilities reduce detectable dungeon emissions without lowering true Dungeon Tier or changing identity. A Tier 6 dungeon might attempt to resemble Tier 4, but activity still creates evidence. Skilled Overseers, spies, relics, nearby Resonance Cores, or direct investigation may penetrate concealment."
    }),
    Object.freeze({
      title: "Lore — Resonance Cores",
      keys: "Resonance Core, Sector Core, dormant Dungeon seed theory, local magical nexus",
      entry: "A Resonance Core is the physical or metaphysical nexus that stabilizes a Sector's local magical conditions. The Dominion monitors and claims important cores in the name of ecological stability and preventing uncontrolled dungeon emergence. Theories that cores are dormant dungeon seeds, failed thrones, immature thrones, or throne substrate remain unproven."
    }),
    Object.freeze({
      title: "Lore — Core Bonds",
      keys: "Core Bond, bond energy allocation, Linked Servant bond, bond authority",
      entry: "A Core Bond joins an external being to a dungeon. Its support depends on compatibility, bond strength, allocated Energy, dungeon capacity, and the Thronebound's relative authority. Bonds may be voluntary, contractual, or coercive. Light bonds grant limited access and support; major bonds enable growth. Control may fail if the linked being greatly exceeds the bond's stabilizing power."
    }),
    Object.freeze({
      title: "Lore — Quest Rank",
      keys: "quest Rank, ranked Guild quest, required adventurer Rank, mission Rank",
      entry: "Quest Rank states the operational capability considered necessary to attempt a Guild mission. It follows the F–SSS convention but does not guarantee success or prescribe the method used. A quest may be raised or lowered after new intelligence changes its danger, complexity, political sensitivity, or logistical demands."
    }),
    Object.freeze({
      title: "Lore — Quest Categories",
      keys: "quest Category, Guild mission taxonomy, mission work type, category classification",
      entry: "Quest Category describes the kind of work a Guild mission requires rather than its difficulty. Category and Rank are assessed separately, so the same form of mission may appear anywhere on the F–SSS scale. Each standard Category has an individual card describing its purpose."
    }),
    ...[
      { name: "Survey", keys: "Survey quest, Survey mission, assessment quest", entry: "A Survey quest evaluates a place, route, population, resource, dungeon, or anomaly and returns reliable observations. Success depends on the requested coverage and evidence rather than defeating every threat. Survey work often establishes the information needed to assign later mission Ranks." },
      { name: "Gathering", keys: "Gathering quest, Gathering mission, collection contract", entry: "A Gathering quest requires collecting a specified quantity and quality of material, specimen, or product. The target may be harvested, purchased, salvaged, or otherwise acquired unless the contract limits methods. Ownership, contamination, transport, and proof of origin can affect completion." },
      { name: "Escort", keys: "Escort quest, Escort mission, protected travel contract", entry: "An Escort quest protects a person, group, caravan, creature, or shipment during travel or a dangerous operation. Completion depends on delivering the protected target under the agreed conditions. Route choice, logistics, negotiation, and avoidance may matter more than combat." },
      { name: "Hunt", keys: "Hunt quest, Hunt mission, creature hunt contract", entry: "A Hunt quest locates and deals with one or more creatures identified by species, behavior, territory, or threat. The contract specifies whether tracking, capture, deterrence, harvesting, or killing is required. A Hunt differs from a Bounty because its target need not be one uniquely named entity." },
      { name: "Investigation", keys: "Investigation quest, Investigation mission, mystery contract", entry: "An Investigation quest determines causes, identities, motives, or hidden relationships behind an incident. Evidence quality and sound conclusions define success. Combat may occur, but destroying a suspect without resolving the requested question can fail the contract." },
      { name: "Defense", keys: "Defense quest, Defense mission, protection contract", entry: "A Defense quest protects a fixed place, population, event, resource, or operation against an expected threat. Preparations, fortification, deterrence, evacuation, and negotiation may contribute. Conditions define the protected objective and how long it must remain secure." },
      { name: "Recovery", keys: "Recovery quest, Recovery mission, retrieval contract", entry: "A Recovery quest retrieves a specific person, object, record, body, or lost asset. The target already has an identity and expected location or history, unlike open-ended Gathering. Preservation, secrecy, rescue, and chain of custody may be as important as return itself." },
      { name: "Exploration", keys: "Exploration quest, Exploration mission, frontier exploration", entry: "An Exploration quest enters insufficiently known territory to discover routes, Sites, hazards, inhabitants, or opportunities. It is broader and less bounded than Survey work. Findings become persistent lore once observed and recorded, even when the expedition cannot fully map the area." },
      { name: "Subjugation", keys: "Subjugation quest, Subjugation mission, threat suppression contract", entry: "A Subjugation quest neutralizes an organized or persistent threat enough to impose control, surrender, dispersal, containment, or another stated condition. It does not always require extermination. Political consequences and the treatment of defeated groups remain part of the outcome." },
      { name: "Dungeon Raid", keys: "Dungeon Raid quest, Dungeon Raid mission, hostile Dungeon incursion", entry: "A Dungeon Raid quest penetrates a dungeon to achieve a stated objective such as reconnaissance, rescue, sabotage, seizure, submission, or core assault. Dungeon hazards, population, facilities, and changing internal conditions make raids complex operations. Success does not automatically destroy the dungeon." },
      { name: "Bounty", keys: "Bounty quest category, Bounty mission, named-target contract", entry: "A Bounty quest pursues one specifically identified person or entity for capture, confirmed defeat, information, or another stated disposition. Verification and legal authority matter. The target's Rank helps determine difficulty, while the Bounty Category describes the named-target structure." },
      { name: "Emergency", keys: "Emergency quest, Emergency mission, crisis-response contract", entry: "An Emergency quest responds to an active crisis whose delay would sharply worsen harm. Information may be incomplete and ordinary preparation time unavailable. Guilds can revise Rank, reward, or objectives as conditions become known, while responders must balance urgency against uncontrolled escalation." }
    ].map(item => Object.freeze({ title: `Lore — ${item.name} Quests`, keys: item.keys, entry: item.entry })),
    Object.freeze({
      title: "Lore — Lustrian Bounties",
      keys: "Lustrian Bounty, Bounty target, Apex creature bounty, Thronebound bounty",
      entry: "A Bounty targets a specific person or entity rather than a general task. Common targets include Apex creatures, wanted criminals, rogue adventurers, dangerous magical beings, and rogue Administrators. Bounties against a Thronebound are rare, politically significant, and often connected to Dominion law, faction conflict, or dungeon warfare."
    }),
    Object.freeze({
      title: "Lore — Dungeon Submission",
      keys: "Dungeon Submission, political submission, defeated Dungeon treaty, submission terms",
      entry: "Submission is a political outcome in which a defeated dungeon accepts negotiated or imposed terms without a metaphysical dungeon-to-dungeon bond. It may owe reparations, territory, access, restrictions, or temporary tribute while retaining independent advancement, Theme, Thronebound, and Signature."
    }),
    Object.freeze({
      title: "Lore — Dungeon Vassalization",
      keys: "Dungeon Vassalization, vassal Dungeon, overlord Dungeon, vassal core bond",
      entry: "Vassalization creates a formal dungeon-to-dungeon bond. The vassal retains its Thronebound and much of its Theme but pays tribute, accepts imposed advancement limits, and carries some influence from the overlord's Signature. Vassalage is metaphysical and strategic, not merely a treaty."
    }),
    Object.freeze({
      title: "Lore — Core Consumption",
      keys: "Core Consumption, consumed Dungeon core, Dungeon essence absorption, destroyed manifestation",
      entry: "Core Consumption destroys a defeated dungeon's current manifestation and transfers accumulated essence to the victor. It does not grant the entire foreign Theme or every ability. The underlying throne principle may eventually reform elsewhere, but whether consumption delays, alters, or can prevent that process remains unresolved."
    }),
    Object.freeze({
      title: "Lore — Dungeon Legacies",
      keys: "Dungeon Legacy, inherited Dungeon capability, consumed core Legacy, compatible inheritance",
      entry: "A Dungeon Legacy is one limited, compatible inheritance derived from a defeated or consumed dungeon. It may influence a facility, resource, Skill, Trait, population, or other function without replacing the victor's Theme. A Legacy must be adapted through the receiving throne's own Signature and development."
    }),
    Object.freeze({
      title: "Lore — Dungeon Reformation",
      keys: "Dungeon reformation, reformed Dungeon, dormant throne return, post-defeat rebuilding",
      entry: "A defeated dungeon may become dormant, rebuild, reconnect to another world, and seek a new Thronebound. Reformation preserves the setting's enduring dungeon principle without guaranteeing identical identity or timing. The effect of Vassalization, Core Consumption, and Legacy transfer on reformation remains a major unresolved question."
    }),
    Object.freeze({
      title: "Lore — Persistent Discovery",
      keys: "persistent discovery, observed canon, generated location persistence, discovered Site",
      entry: "Most Regions, Sectors, Sites, factions, and local resources receive no permanent identity until they become relevant to play. Once a place or group is observed, recorded, or meaningfully encountered, its generated identity becomes canon for that adventure. Procedural generation creates undiscovered content; it does not rewrite established discoveries."
    })
  ]);
  ...
  const ROOM_DEFINITIONS = Object.freeze({
    ...
    "administrator-quarters": Object.freeze({ name: "Administrator Quarters", unlockTier: 1, kind: "residence", function: "Provides private suites for Administrators; Expansion adds suites while improved or named quarters support recovery and Bond development.", job: "Suite Steward", uniqueWorker: true, administratorSuites: 2, bondGainBonus: 0.1, baseCost: 25, administratorRoles: ["Residential Steward"] }),
    "thronebound-private-chamber": Object.freeze({ name: "Thronebound Private Chamber", unlockTier: 1, kind: "residence", function: "Provides the Thronebound's private recovery space, invited stays, attendants, personal events, and controlled detainment assignments.", job: "Personal Attendant", uniqueWorker: true, privateCapacity: 2, detainmentSlots: 1, bondGainBonus: 0.15, baseCost: 30, administratorRoles: ["Chamberlain"] }),
    ...
    forge: Object.freeze({ name: "Dungeon Forge", unlockTier: 3, kind: "equipment", function: "Unlocks dungeon-themed equipment and improves the gear available to Soldiers and linked characters.", job: "Forge Artisan", jobs: 3, equipmentTier: 1, baseCost: 75 }),
    "population-nexus": Object.freeze({ name: "Population Nexus", unlockTier: 3, kind: "capacity", function: "Supports the controlled growth, organization, and wellbeing of facility-generated population cohorts.", job: "Population Keeper", uniqueWorker: true, upkeepReduction: 0.15, baseCost: 75 }),
    ...
    "portal-gate": Object.freeze({ name: "Portal Gate", unlockTier: 5, kind: "travel", function: "Stabilizes travel among the Dungeon, Lustria, and the Thronebound's Homeworld.", job: "Portal Navigator", uniqueWorker: true, portalRoutes: 1, baseCost: 160 }),
    ...
    "world-gate-array": Object.freeze({ name: "World Gate Array", unlockTier: 9, kind: "travel", function: "Coordinates multiple high-tier gates, remote operations, and Homeworld-Lustria logistics.", job: "World Gate Director", jobs: 3, portalRoutes: 3, baseCost: 620, administratorRoles: ["Gate Director"] }),
    "architect-apotheosis": Object.freeze({ name: "Architect Apotheosis Core", unlockTier: 10, kind: "core", function: "Provides the Tier 10 capstone for perfected facilities, Class Mastery, and sovereign dungeon functions.", job: "Apotheosis Custodian", uniqueWorker: true, masteryGate: true, baseCost: 900, administratorRoles: ["Apotheosis Regent"] })
  });
  const ROOM_MANIFESTATION_NOUNS = Object.freeze({
    ...
    "world-gate-array": "Worldway Array", "architect-apotheosis": "Apotheosis Heart"
  });
  const JOB_MANIFESTATION_NOUNS = Object.freeze({
    ...
    "world-gate-array": "Worldway Directors", "architect-apotheosis": "Apotheosis Keepers"
  });

  const STORY_QUESTS = Object.freeze({
    "story-awakening-1": { category: "Story", chain: "Awakening", step: 1, tier: 0, title: "Awakening I — Become the Dungeon's Master", status: "active", scope: "Dungeon", strictTemplate: true, objective: "Establish practical control of the Dungeon and legitimately awaken it to Tier 1.", description: "The Thronebound must become capable of acting as a Dungeon power. Mechanical lessons remain in the Tutorial and Dungeon chains rather than being duplicated here.", completionText: "The Dungeon is no longer merely awake. Its functions answer reliably to the Thronebound, its first major bond is stable, and the Throne can now turn its attention beyond itself.", prerequisites: [], rewards: { experience: 100, energy: 20 } },
    "story-first-contact-1": { category: "Story", chain: "First Contact", step: 1, tier: 1, title: "First Contact I — Leave the Dungeon", status: "locked", scope: "External", strictTemplate: true, missionType: "Exploration", objective: "Physically leave the Dungeon and begin establishing what lies immediately beyond it without assuming its biome, terrain, inhabitants, or danger.", description: "Crossing the threshold creates only a stable, unresolved Dungeon Sector. It does not take a snapshot from the quest-triggering output.", prerequisites: ["story-awakening-1"], rewards: { experience: 75 } },
    ...
    "story-path-controlled-contact-1": { category: "Story", chain: "Path of Controlled Contact", step: 1, tier: 3, title: "Path of Controlled Contact I — Measured Threshold", status: "locked", scope: "External", strictTemplate: true, objective: "Resolve the Tier 3 doctrine trial by selecting who may approach, what they may learn, and where contact occurs.", prerequisites: ["story-dungeons-place-1"], rewards: { experience: 300 } },
    "story-path-dominion-accord-1": { category: "Story", chain: "Path of Dominion Accord", step: 1, tier: 3, title: "Path of Dominion Accord I — Terms of Recognition", status: "locked", scope: "External", strictTemplate: true, objective: "Resolve the Tier 3 doctrine trial by pursuing formal recognition while protecting essential Dungeon interests.", prerequisites: ["story-dungeons-place-1"], rewards: { experience: 300 } },
    "story-path-patronage-1": { category: "Story", chain: "Path of Patronage", step: 1, tier: 3, title: "Path of Patronage I — The Price of Protection", status: "locked", scope: "External", strictTemplate: true, objective: "Resolve the Tier 3 doctrine trial by negotiating protection or opportunity without surrendering the Dungeon's essential agency.", prerequisites: ["story-dungeons-place-1"], rewards: { experience: 300 } },
    "story-path-armed-independence-1": { category: "Story", chain: "Path of Armed Independence", step: 1, tier: 3, title: "Path of Armed Independence I — Sovereign Deterrence", status: "locked", scope: "External", strictTemplate: true, objective: "Resolve the Tier 3 doctrine trial by demonstrating credible autonomy and defensive strength without assuming conquest is required.", prerequisites: ["story-dungeons-place-1"], rewards: { experience: 300 } },
    "story-dungeons-place-3": { category: "Story", chain: "The Dungeon's Place", step: 3, tier: 3, title: "The Dungeon's Place III — Doctrine Crystallized", status: "locked", scope: "Dungeon", strictTemplate: true, objective: "Review the consequences of the selected path and commit its first doctrine as the basis for later branching Story arcs.", prerequisites: [], rewards: { experience: 350 } }
  });

  const TIER_ONE_QUESTS = Object.freeze({
    "tier1-main-construction": { category: "Dungeon", chain: "Construction Foundation", step: 1, tier: 1, title: "Construction Foundation I", scope: "Dungeon", strictTemplate: true, objective: "Activate {room:material-works} and complete a Cycle that produces Basic {resource:construction}.", prerequisites: ["story-awakening-1"], references: [{ type: "facility", definition: "material-works", role: "focus" }], rewards: { experience: 40 } },
    "tier1-main-sustenance": { category: "Dungeon", chain: "Sustenance Foundation", step: 1, tier: 1, title: "Sustenance Foundation I", scope: "Dungeon", strictTemplate: true, objective: "Activate {room:sustenance-works} and complete a Cycle that produces Basic {resource:sustenance}.", prerequisites: ["story-awakening-1"], references: [{ type: "facility", definition: "sustenance-works", role: "focus" }], rewards: { experience: 40 } },
    "tier1-main-development": { category: "Dungeon", chain: "Development Foundation", step: 1, tier: 1, title: "Development Foundation I", scope: "Dungeon", strictTemplate: true, objective: "Activate {room:development-sanctum} and complete a Cycle that produces Basic {resource:development}.", prerequisites: ["story-awakening-1"], references: [{ type: "facility", definition: "development-sanctum", role: "focus" }], rewards: { experience: 40 } },
    "tier1-main-energy": { category: "Dungeon", chain: "Energy Foundation", step: 1, tier: 1, title: "Energy Foundation I", scope: "Dungeon", strictTemplate: true, objective: "Activate {room:energy-conduit} and complete a Cycle that produces ungraded {resource:energy}.", prerequisites: ["story-awakening-1"], references: [{ type: "facility", definition: "energy-conduit", role: "focus" }], rewards: { experience: 40 } },
    "tier1-main-workers": { category: "Dungeon", chain: "Population Foundation", step: 1, tier: 1, title: "Population Foundation I", scope: "Dungeon", strictTemplate: true, objective: "Maintain the Dungeon's manifested job cohorts through a Cycle with suitable residences and no unpaid {resource:sustenance} upkeep.", prerequisites: ["tier1-main-sustenance"], rewards: { experience: 50 } },
    "tier1-main-expansion": { category: "Dungeon", chain: "Facility Development", step: 1, tier: 1, title: "Facility Development I", scope: "Dungeon", strictTemplate: true, objective: "Expand one established Dungeon facility and complete its reserved construction task.", prerequisites: ["story-awakening-1"], rewards: { experience: 40 } },
    "tier1-main-facility-tier": { category: "Dungeon", chain: "Facility Development", step: 2, tier: 1, title: "Facility Development II", scope: "Dungeon", strictTemplate: true, objective: "Confirm that the Throne Room advanced with the Dungeon and that no facility may exceed Dungeon Tier.", prerequisites: ["tier1-main-expansion"], rewards: { experience: 30 } },
    "tier1-main-administrator": { category: "Dungeon", chain: "Administrative Structure", step: 1, tier: 1, title: "Administrative Structure I", scope: "Dungeon", strictTemplate: true, objective: "Assign a compatible Administrator to an established facility and observe their Rank alter a successful Cycle result.", prerequisites: ["story-awakening-1"], rewards: { experience: 50 } },
    "thronebound-class-requirements": { category: "Thronebound", chain: "Class Awakening", step: 1, tier: 1, title: "Class Awakening I", scope: "Dungeon", strictTemplate: true, description: "Initial Class Selection requires Dungeon Tier 1, a Classless Thronebound, three generated previews, Timeless System Mode in the Throne Room, 20 Basic {resource:development}, and 15 {resource:energy}.", objective: "Satisfy and review every requirement for the Thronebound's first Class Selection.", prerequisites: ["story-awakening-1"], rewards: { experience: 20 } },
    "thronebound-class-previews": { category: "Thronebound", chain: "Class Awakening", step: 2, tier: 1, title: "Class Awakening II", scope: "Dungeon", strictTemplate: true, objective: "Review all three generated Class branches and their Combat Skill, Management Skill, and Trait before making a permanent choice.", prerequisites: ["thronebound-class-requirements"], rewards: { experience: 25 } },
    "tier1-main-class": { category: "Thronebound", chain: "Class Awakening", step: 3, tier: 1, title: "Class Awakening III", scope: "Dungeon", strictTemplate: true, objective: "Accept one reviewed Class branch in Timeless System Mode and establish the first entry in Class Lineage.", prerequisites: ["thronebound-class-previews"], rewards: { experience: 60 } },
    "tier1-main-reserve": { category: "Dungeon", chain: "Self-Sustaining Dungeon", step: 1, tier: 1, title: "Self-Sustaining Dungeon I", scope: "Dungeon", strictTemplate: true, objective: "Complete the Tier 1 foundation, fill Administrator Capacity 3, and hold the ordinary {resource:construction} and {resource:energy} requirements for Tier 2 without artificial resource injection.", prerequisites: ["tier1-main-construction", "tier1-main-sustenance", "tier1-main-development", "tier1-main-energy", "tier1-main-workers", "tier1-main-expansion", "tier1-main-facility-tier", "tier1-main-administrator", "tier1-main-class"], rewards: { experience: 100 } },

    "tutorial-economy-build-material": { category: "Tutorial", chain: "Construction Operations", step: 1, tier: 1, title: "Construction Operations I", description: "A Tutorial may identify the manifested room and its universal System function together.", objective: "Use the System to construct {room:material-works}, which fulfills the \"Material Works\" function.", hints: ["Enter Timeless System Mode in the Throne Room, then ask to construct Material Works."], prerequisites: ["tutorial-system-tier-up"], references: [{ type: "facility", definition: "material-works", role: "focus" }], rewards: { experience: 15 } },
    "tutorial-economy-complete-material": { category: "Tutorial", chain: "Construction Operations", step: 2, tier: 1, title: "Construction Operations II", description: "Construction is reserved work completed through timed Cycles.", objective: "Use Construction Activity until {room:material-works} becomes Active.", hints: ["Begin Construction Activity and describe the Thronebound helping with the active task."], prerequisites: ["tutorial-economy-build-material"], rewards: { experience: 15 } },
    "tutorial-economy-observe-production": { category: "Tutorial", chain: "Construction Operations", step: 3, tier: 1, title: "Construction Operations III", description: "An active production room needs its manifested job cohort before it can produce.", objective: "Complete a production Cycle, then ask the System to show production at {room:material-works}.", hints: ["Begin Production Activity, allow a Cycle to complete, and review Production."], prerequisites: ["tutorial-economy-complete-material"], rewards: { experience: 15 } },
    "tutorial-economy-sustenance": { category: "Tutorial", chain: "Sustenance Operations", step: 1, tier: 1, title: "Sustenance Operations I", description: "The System classifies population assigned to ordinary facility jobs as Worker Cohorts; this Dungeon gives each cohort a manifested name.", objective: "Construct {room:sustenance-works} and {room:worker-habitat} so manifested job cohorts can be sustained and housed.", hints: ["Construct both universal functions; their story-facing names appear when manifested."], prerequisites: ["tutorial-system-tier-up"], rewards: { experience: 20 } },
    "tutorial-economy-jobs": { category: "Tutorial", chain: "Population Interface", step: 1, tier: 1, title: "Population Interface I", description: "Population display separates each cohort's System classification from its manifested job, Work, and Residence.", objective: "Open Population and review the manifested names, Work, and Residence of the Dungeon's job cohorts.", hints: ["Ask the System to show Population after at least one job facility is Active."], prerequisites: ["tutorial-economy-sustenance"], rewards: { experience: 15 } },
    "tutorial-economy-expand": { category: "Tutorial", chain: "Facility Development Interface", step: 1, tier: 1, title: "Facility Development Interface I", description: "Expansion changes the quantity supported by a facility without changing its Tier.", objective: "Expand one active facility and complete the Expansion through Cycles.", hints: ["Ask the System to expand an active manifested room, then use Construction Activity."], prerequisites: ["tutorial-system-tier-up"], rewards: { experience: 20 } },
    "tutorial-economy-tier": { category: "Tutorial", chain: "Facility Development Interface", step: 2, tier: 1, title: "Facility Development Interface II", description: "Tier Up improves quality or capability and cannot exceed Dungeon Tier.", objective: "Ask how facility Tier Ups work and review the Throne Room's completed Tier 1 awakening.", hints: ["Ask the System to explain facility Tier Ups."], prerequisites: ["tutorial-economy-expand"], rewards: { experience: 15 } },
    "tutorial-economy-administrator": { category: "Tutorial", chain: "Administrator Assignment Interface", step: 1, tier: 1, title: "Administrator Assignment Interface I", description: "Administrator role compatibility and Rank affect an assigned facility's results.", objective: "Assign a compatible Administrator to a production facility and complete a Cycle to compare the result.", hints: ["Review Administrators, assign one to a compatible manifested room, then complete Production."], prerequisites: ["tutorial-system-tier-up"], rewards: { experience: 25 } },

    "tutorial-class-previews": { category: "Tutorial", chain: "Class Interface", step: 1, tier: 1, title: "Class Interface I", description: "Class previews are editable proposals, not accepted progression.", objective: "Open Class Evolution and compare all three generated branches.", hints: ["Ask the System to show the Thronebound's Class previews."], prerequisites: ["tutorial-system-tier-up"], rewards: { experience: 15 } },
    "tutorial-class-adjust": { category: "Tutorial", chain: "Class Interface", step: 2, tier: 1, title: "Class Interface II", description: "A preview may be edited or all three options may be regenerated before acceptance.", objective: "Edit an unsuitable preview or ask the System to regenerate the options; accepting unchanged previews also confirms they were suitable.", hints: ["Regenerate only if the current options do not fit the Thronebound and Dungeon."], prerequisites: ["tutorial-class-previews"], rewards: { experience: 10 } },
    "tutorial-class-accept": { category: "Tutorial", chain: "Class Interface", step: 3, tier: 1, title: "Class Interface III", description: "Acceptance is the only operation that mutates Class, lineage, Skills, and Traits.", objective: "Accept one reviewed Class option after the Class Awakening requirements are satisfied.", hints: ["Hold 20 Basic Development and 15 Energy, enter System Mode in the Throne Room, and accept option one, two, or three."], prerequisites: ["tutorial-class-adjust", "thronebound-class-requirements"], rewards: { experience: 30 } },
    "tutorial-class-abilities": { category: "Tutorial", chain: "Class Interface", step: 4, tier: 1, title: "Class Interface IV", description: "The accepted branch establishes Class Lineage, two Skills, and one Trait.", objective: "Ask the System to show the Thronebound's abilities and Class Lineage.", hints: ["Review abilities after Class Selection succeeds."], prerequisites: ["tutorial-class-accept"], rewards: { experience: 15 } },
    "tutorial-class-shop": { category: "Tutorial", chain: "Ability Acquisition", step: 1, tier: 1, title: "Ability Acquisition I", description: "General ability facilities expose fixed-price, theme-neutral entries.", objective: "Construct either {room:general-skill-hall} or {room:general-trait-archive}.", hints: ["Choose the universal Skill or Trait facility that matches the first ability you want to acquire."], prerequisites: ["tutorial-class-abilities"], rewards: { experience: 20 } },
    "tutorial-class-buy": { category: "Tutorial", chain: "Ability Acquisition", step: 2, tier: 1, title: "Ability Acquisition II", description: "The System validates target, price, facility Tier, and duplicates before spending.", objective: "Review the fixed-price shop and acquire one valid entry for a linked character.", hints: ["Ask to show Shops, then buy a numbered Skill or Trait option."], prerequisites: ["tutorial-class-shop"], rewards: { experience: 25 } },
    "tutorial-class-grade": { category: "Tutorial", chain: "Ability Acquisition", step: 3, tier: 1, title: "Ability Acquisition III", description: "Ordinary abilities require maximum mastery before Grade Up and use the Tier 1/4/7/10 Grade bands.", objective: "Ask the System how ability mastery and Grades progress.", hints: ["Ask how mastery and ability Grades work."], prerequisites: ["tutorial-class-buy"], rewards: { experience: 15 } },

    "tutorial-admin-summon": { category: "Tutorial", chain: "Administrator and Bond Interface", step: 1, tier: 1, title: "Administrator and Bond Interface I", description: "Later Administrator roles are drawn only from active Dungeon functions.", objective: "Activate a useful facility function, then summon the second Administrator from the Throne Room.", hints: ["Enter System Mode after at least one Tier 1 facility becomes Active, then summon the Administrator."], prerequisites: ["tutorial-system-tier-up"], rewards: { experience: 20 } },
    "tutorial-admin-assign": { category: "Tutorial", chain: "Administrator and Bond Interface", step: 2, tier: 1, title: "Administrator and Bond Interface II", description: "An Administrator may only be assigned to a compatible active function.", objective: "Assign the Administrator to a compatible manifested facility.", hints: ["Review the Administrator role and the facility's System function before assigning."], prerequisites: ["tutorial-admin-summon"], rewards: { experience: 20 } },
    "tutorial-admin-bond": { category: "Tutorial", chain: "Administrator and Bond Interface", step: 3, tier: 1, title: "Administrator and Bond Interface III", description: "Bond Activity records meaningful time with an individual Administrator.", objective: "Begin Bond Activity with an Administrator and spend a story turn together.", hints: ["Begin Bond Activity from the Throne Room, then narrate a meaningful interaction."], prerequisites: ["tutorial-admin-assign"], rewards: { experience: 15 } },
    "tutorial-admin-threshold": { category: "Tutorial", chain: "Administrator and Bond Interface", step: 4, tier: 1, title: "Administrator and Bond Interface IV", description: "Bond cannot pass an unresolved five-percent Event gate.", objective: "Continue meaningful Bond Activity until the Administrator reaches the 5% gate.", hints: ["Talk, listen, train, work, rest, or share experiences during Bond Activity."], prerequisites: ["tutorial-admin-bond"], rewards: { experience: 20 } },
    "tutorial-admin-event": { category: "Tutorial", chain: "Administrator and Bond Interface", step: 5, tier: 1, title: "Administrator and Bond Interface V", description: "The active Bond Event must be resolved through an appropriate personal scene.", objective: "Complete the active 5% Bond Event with its referenced Administrator.", hints: ["Use the Event objective and relationship context; no command-line completion is required."], prerequisites: ["tutorial-admin-threshold"], rewards: { experience: 25 } },
    "tutorial-admin-rank-level": { category: "Tutorial", chain: "Administrator and Bond Interface", step: 6, tier: 1, title: "Administrator and Bond Interface VI", description: "Rank measures manifestation effectiveness; Level measures character growth.", objective: "Ask the System to explain Administrator Rank, Level, assignment effectiveness, and Bond-gated Rank Up.", hints: ["Ask the System to explain Rank versus Level."], prerequisites: ["tutorial-admin-event"], rewards: { experience: 15 } }
  });
  ...
  const GENERIC_QUEST_STATUS = Object.freeze({
    Story: Object.freeze({ title: "Story Progression Awaiting Conditions", text: "No Story Quest is currently active. Story chains permit only one mandatory progression step at a time and resume when their causal requirements are satisfied." }),
    ...
    Thronebound: Object.freeze({ title: "Further Thronebound Growth Awaits", text: "No additional Thronebound progression objective is active. Class evolution, ability development, Attributes, and later Dungeon Tiers create further opportunities." }),
  ...
  function normalizeQuestRecord(id, quest) {
    ...
    return {
      ...
      scope: clean(source.scope) || (source.category === "Dungeon" || source.category === "Thronebound" || source.category === "Story" ? "Dungeon" : "External"), strictTemplate: !!source.strictTemplate,
      missionType: QUEST_MISSION_TYPES.find(value => value.toLowerCase() === clean(source.missionType || "Internal").toLowerCase()) || "Internal",
      reportRequired: source.reportRequired == null ? ["Guild", "Bounty"].includes(source.category) : !!source.reportRequired, reportLocation: clean(source.reportLocation), fieldComplete: !!source.fieldComplete, reported: !!source.reported, outcome: source.outcome && typeof source.outcome === "object" ? { ...source.outcome } : null, followupQuestId: clean(source.followupQuestId),
      softLock: source.softLock && typeof source.softLock === "object" ? { ...source.softLock } : null,
      repeatable: !!source.repeatable, generic: !!source.generic, dynamic: !!source.dynamic, rewarded: !!source.rewarded, hiddenUntilActive: !!source.hiddenUntilActive,
      stages: Array.isArray(source.stages) ? source.stages.map((stage, index) => ({ ...(stage || {}), id: clean(stage?.id) || `stage-${index + 1}`, taskType: QUEST_MISSION_TYPES.find(value => value.toLowerCase() === clean(stage?.taskType || "Internal").toLowerCase()) || "Internal" })) : [],
  ...
  function completeDungeonAttributes(attributes, theme = "Dungeon") {
    ...
    for (const [name, current] of Object.entries(source).slice(0, 3)) {
      const valueObject = typeof current === "object" ? current : { value: current }, legacyDomainIndex = LEGACY_DUNGEON_ATTRIBUTE_DOMAINS.findIndex(item => item.toLowerCase() === clean(valueObject.domain).toLowerCase());
      const requestedPriority = DUNGEON_ATTRIBUTE_PRIORITIES.find(item => item.toLowerCase() === clean(valueObject.priority).toLowerCase());
      const priority = requestedPriority || (legacyDomainIndex >= 0 ? DUNGEON_ATTRIBUTE_PRIORITIES[legacyDomainIndex] : DUNGEON_ATTRIBUTE_PRIORITIES.find(item => !Object.values(result).some(attribute => attribute.priority === item)));
      if (!priority || !clean(name)) continue;
      result[clean(name)] = { description: clean(valueObject.description) || `A legacy ${clean(theme)} expression of the Dungeon's defining nature.`, aptitude: APTITUDE_OUTCOMES[clean(valueObject.aptitude).toUpperCase()] ? clean(valueObject.aptitude).toUpperCase() : "C", value: Math.max(0, Number(valueObject.value) || 0), priority };
    }
    return result;
  }
  ...
  const emptyGradeStock = amount => ({ Basic: Math.max(0, Number(amount) || 0), Intermediate: 0, Advanced: 0, Mastery: 0 });
  const resourceTemplate = role => {
    const amount = role === "energy" ? 120 : 100;
    return { role, name: `Undefined ${title(role)}`, description: "", collection: "", use: "", amount, graded: role !== "energy", grades: role === "energy" ? undefined : emptyGradeStock(amount) };
  };
  const attributeSet = template => Object.fromEntries(Object.entries(template).map(([name, value]) => [name, { aptitude: "C", value }]));
  ...
  function defaultState() {
    const dms = {
      ...
      population: {
        nature: "Undefined dungeon population", appearance: "Undefined population appearance",
        workers: { current: 0, assignments: {}, cohorts: [] }, soldiers: { current: 0, cohorts: [] }
      },
      administrators: {}, rooms: {}, residences: { assignments: {}, named: {}, stays: {}, detainments: {} },
      activity: { mode: "Idle", targets: [], pace: "Timeless", cycle: 0, progress: 0, location: { major: "Dungeon", secondary: "Throne Room", detail: "" } },
      world: { homeworld: "Undefined Homeworld", homeworldDescription: "", homeworldRegion: "", homeworldAnchor: "", homeworldResidence: "", homeworldTimePeriod: "", homeworldCircumstances: "", secondaryLocation: "", lustria: { sectors: {}, sites: {}, veins: {}, inventory: {}, inventoryGrades: {}, controlledSectors: [] } },
      story: {
      ...
      quests: { focus: "story", notifications: [], relevantCategories: ["Story", "Dungeon", "Tutorial"], records: {
        ...Object.fromEntries(Object.entries(STORY_QUESTS).map(([id, quest]) => [id, { ...quest, prerequisites: [...(quest.prerequisites || [])], rewards: { ...(quest.rewards || {}) } }])),
        "tutorial-system-status": { category: "Tutorial", chain: "System Awakening", step: 1, tier: 0, title: "System Awakening I", status: "active", objective: "Open the Dungeon's broad status overview.", prerequisites: [], rewards: { experience: 10 } },
        "tutorial-system-resources": { category: "Tutorial", chain: "System Awakening", step: 2, tier: 0, title: "System Awakening II", status: "locked", objective: "Review the Dungeon's current resource stocks.", prerequisites: ["tutorial-system-status"], rewards: { energy: 5 } },
        "tutorial-system-mode": { category: "Tutorial", chain: "System Awakening", step: 3, tier: 0, title: "System Awakening III", status: "locked", objective: "Enter Timeless System Mode within the Throne Room.", prerequisites: ["tutorial-system-resources"], rewards: { experience: 10 } },
        "tutorial-system-manager": { category: "Tutorial", chain: "System Awakening", step: 4, tier: 0, title: "System Awakening IV", status: "locked", objective: "Manifest the Dungeon's first Administrator as its Manager.", prerequisites: ["tutorial-system-mode"], rewards: { development: 5 } },
        "tutorial-system-tier-requirements": { category: "Tutorial", chain: "System Awakening", step: 5, tier: 0, title: "System Awakening V", status: "locked", objective: "Review the exact requirements for awakening Tier 1.", prerequisites: ["tutorial-system-manager"], rewards: { energy: 5 } },
        "tutorial-system-tier-up": { category: "Tutorial", chain: "System Awakening", step: 6, tier: 0, title: "System Awakening VI", status: "locked", objective: "Commit the gathered resources and awaken Dungeon Tier 1.", prerequisites: ["tutorial-system-tier-requirements"], rewards: { experience: 50 } },
        "reach-lustria": { category: "Tutorial", chain: "Lustrian Exploration", step: 1, tier: 2, title: "Lustrian Exploration I", status: "locked", objective: "Travel to Lustria and discover a resource-bearing Sector through Survey or Exploration Activity.", prerequisites: [], rewards: { experience: 200, energy: 40 } },
        ...Object.fromEntries(Object.entries(TIER_ONE_QUESTS).map(([id, quest]) => [id, { ...quest, status: "locked", prerequisites: [...(quest.prerequisites || [])], rewards: { ...(quest.rewards || {}) } }]))
      } },
      milestones: { tier1: { produced: { construction: 0, sustenance: 0, development: 0, energy: 0 }, constructed: {}, completedConstruction: {}, productionObserved: false, workerJobsRead: false, stableWorkerSupport: false, expandedFacility: "", tieredFacility: "", tierRulesRead: false, administratorAssigned: false, administratorProductionObserved: false, classPreviewsReviewed: false, classPreviewsRegenerated: false, classAccepted: false, abilitiesReviewed: false, shopFacilityBuilt: false, abilityPurchased: false, masteryGradeRead: false, bondGained: false, bondThresholdReached: false, bondEventCompleted: false, rankLevelRead: false } },
      classPreviews: {}, shops: { custom: {}, research: {} }, equipment: { previews: {}, items: {} }, portals: { anchors: {}, routes: {} }, tasks: [],
      generation: { roomSequence: 0, administratorSequence: 0, sectorSequence: 0, previewSequence: 0, reservationSequence: 0, equipmentSequence: 0, managedCardKeys: [], revealedCardKeys: [] },
    ...
    for (const quest of Object.values(dms.quests.records)) validateQuestTemplate(dms, quest);
    return dms;
  }
  ...
  function normalize(candidate, options = {}) {
    ...
    const dms = {
      ...
      administrators: value.administrators && typeof value.administrators === "object" ? value.administrators : {}, residences: { ...base.residences, ...(value.residences || {}), assignments: { ...base.residences.assignments, ...((value.residences || {}).assignments || {}) }, named: { ...base.residences.named, ...((value.residences || {}).named || {}) }, stays: { ...base.residences.stays, ...((value.residences || {}).stays || {}) }, detainments: { ...base.residences.detainments, ...((value.residences || {}).detainments || {}) } },
    ...
    dms.schema = SCHEMA;
    const legacyWorkerAppearance = clean(value.population?.workerDescription);
    const legacySoldierAppearance = clean(value.population?.soldierDescription);
    dms.population.nature = clean(value.population?.nature) || (legacyWorkerAppearance || legacySoldierAppearance ? "Legacy dungeon population" : base.population.nature);
    ...
    for (const role of RESOURCE_ROLES) {
      ...
      if (role === "energy") { dms.dungeon.resources[role].graded = false; delete dms.dungeon.resources[role].grades; }
      else {
        dms.dungeon.resources[role].graded = true;
        const legacyAmount = Math.max(0, Number(dms.dungeon.resources[role].amount) || 0), savedGrades = current.grades && typeof current.grades === "object" ? current.grades : {};
        dms.dungeon.resources[role].grades = { ...emptyGradeStock(0), ...savedGrades };
        const gradeTotal = Object.values(dms.dungeon.resources[role].grades).reduce((sum, amount) => sum + Math.max(0, Number(amount) || 0), 0);
        if (!gradeTotal && legacyAmount) dms.dungeon.resources[role].grades.Basic = legacyAmount;
        else if (legacyAmount > gradeTotal) dms.dungeon.resources[role].grades.Basic += legacyAmount - gradeTotal;
        dms.dungeon.resources[role].amount = Object.values(dms.dungeon.resources[role].grades).reduce((sum, amount) => sum + Math.max(0, Number(amount) || 0), 0);
      }
    }
    dms.currencies.marks = Math.max(0, Number(dms.currencies.marks) || 0);
    ...
    for (const room of Object.values(dms.rooms)) {
      ...
      const manifested = manifestedRoomIdentity(dms, room.definition), legacySystemName = !clean(room.name) || clean(room.name) === definition.name;
      room.systemName = definition.name; if (legacySystemName) room.name = manifested.name;
      room.jobName = clean(room.jobName) && clean(room.jobName) !== definition.job ? clean(room.jobName) : manifested.jobName;
      const generatedLore = room.definition === "throne-room" ? throneRoomLore(dms, Math.max(0, Number(room.tier) || 0), room.lore || {}) : roomLore(dms, definition, Math.max(1, Number(room.tier) || definition.unlockTier || 1), { systemName: room.systemName, name: room.name, jobName: room.jobName });
      room.lore = { ...generatedLore, ...(room.lore || {}), function: generatedLore.function, job: generatedLore.job };
    }
    ...
    dms.world.lustria.sites = dms.world.lustria.sites && typeof dms.world.lustria.sites === "object" ? dms.world.lustria.sites : {};
    for (const id of Object.keys(dms.quests.records)) if (/^main-awakening-|^main-dungeon-tier-/.test(id)) delete dms.quests.records[id];
    for (const [id, quest] of Object.entries(STORY_QUESTS)) if (!dms.quests.records[id]) dms.quests.records[id] = { ...quest, prerequisites: [...(quest.prerequisites || [])], rewards: { ...(quest.rewards || {}) } };
    dms.quests.records = Object.fromEntries(Object.entries(dms.quests.records).map(([id, quest]) => [id, normalizeQuestRecord(id, quest)]));
    for (const quest of Object.values(dms.quests.records)) validateQuestTemplate(dms, quest);
  ...
  function tierOneMilestone(dms, key, value = true) {
    const tier1 = dms.milestones ||= {}; tier1.tier1 ||= defaultState().milestones.tier1;
    let changed = false;
    if (key.startsWith("produced.")) { const role = key.split(".")[1], next = Number((Number(tier1.tier1.produced[role]) + Number(value || 0)).toFixed(4)); changed = next !== tier1.tier1.produced[role]; tier1.tier1.produced[role] = next; }
    else if (key.startsWith("constructed.")) { const field = key.split(".")[1]; changed = tier1.tier1.constructed[field] !== value; tier1.tier1.constructed[field] = value; }
    else if (key.startsWith("completedConstruction.")) { const field = key.split(".")[1]; changed = tier1.tier1.completedConstruction[field] !== value; tier1.tier1.completedConstruction[field] = value; }
    else { changed = tier1.tier1[key] !== value; tier1.tier1[key] = value; }
    if (changed) markStateChanged(dms);
    updateQuests(dms); return tier1.tier1;
  }
  ...
  function unresolvedScenarioValue(value) { return !clean(value) || /\$\{/.test(clean(value)); }
  function scenarioAnswer(placeholders, question) {
    if (!Array.isArray(placeholders)) return "";
    const normalized = clean(question).replace(/\s+/g, " ");
    const item = placeholders.find(candidate => clean(candidate?.question).replace(/\s+/g, " ") === normalized);
    return unresolvedScenarioValue(item?.answer) ? "" : clean(item.answer);
  }
  function parseGrowthPreferences(value, dms = defaultState()) {
    const requested = unique(Array.isArray(value) ? value : clean(value).split(","));
    if (!requested.length || requested.length > 5) throw new Error("Growth Preferences must contain between one and five Attributes.");
    return requested.map(valueName => {
      const canonical = growthPreferenceNames(dms).find(name => name.toLowerCase() === valueName.toLowerCase());
      if (!canonical) throw new Error(`Unknown Growth Preference ${valueName}. Use ${growthPreferenceNames(dms).join(", ")}.`);
      return canonical;
    });
  }
  function initializationJsonObject(value) {
    if (value && typeof value === "object") return value;
    let source = clean(value).replace(/^```(?:json)?\s*/i, "").replace(/\s*```$/i, "");
    const first = source.indexOf("{"), last = source.lastIndexOf("}");
    if (first < 0 || last < first) throw new Error("Initialization data must be a complete JSON object.");
    source = source.slice(first, last + 1);
    try { return JSON.parse(source); } catch (error) { throw new Error(`Initialization JSON is invalid: ${error.message}`); }
  }
  function generatorField(value) {
  ...
  function adaptGeneratorStoryBible(value) {
    ...
    if (container.format === DMS_INITIALIZATION_FORMAT) return container;
    const bible = container.story_bible && typeof container.story_bible === "object" ? container.story_bible : container;
    const overview = bible.overview || {}, dungeonName = generatorField(overview.dungeon), throneboundName = generatorField(overview.thronebound || overview.protagonist);
    const dungeon = bible[generatorSectionKey(dungeonName)] || bible.dungeon_template || {};
  ...
  function pristineScenarioState(dms) {
    return !dms.initialized && !dms.onboarding.scenarioVariablesImported && !dms.onboarding.aptitudesDefined.length
      && dms.thronebound.name === "Unnamed Thronebound" && dms.thronebound.race === "Undefined"
      && dms.dungeon.name === "Unnamed Dungeon" && dms.dungeon.theme === "Unformed" && dms.dungeon.style === "Undefined"
      && !resourcesReady(dms);
  }
  function scenarioSetup(placeholders = global.state?.placeholders) {
    const answer = scenarioAnswer(placeholders, DMS_INITIALIZATION_QUESTION);
    if (!answer) return { ready: false, missing: ["initializationJson"], answers: { initializationJson: "" } };
    return { ready: true, answers: { initializationJson: answer }, initialization: parseInitializationJson(answer) };
  }
  function initializeFromScenarioVariables(dms, placeholders = global.state?.placeholders) {
    if (!dms || dms.onboarding.scenarioVariablesImported || !pristineScenarioState(dms)) return false;
    const setup = scenarioSetup(placeholders);
    ...
    for (const role of RESOURCE_ROLES) {
      Object.assign(dms.dungeon.resources[role], { role, ...dungeon.resources[role] });
    }
    for (const [name, aptitude] of Object.entries(thronebound.aptitudes)) {
  ...
  function defineResource(dms, role, specification) {
    if (dms.initialized && !systemAvailable(dms)) throw new Error("Established Dungeon resources can only be redefined in System Mode within the Throne Room.");
  ...
  function configure(dms, spec) {
    if (dms.initialized && !systemAvailable(dms)) throw new Error("Established Dungeon identity can only be changed in System Mode within the Throne Room.");
  ...
  function manifestationWords(value, limit = 2) {
    const ignored = new Set(["a", "an", "the", "of", "and", "with", "bound", "dungeon"]);
    const words = clean(value).replace(/[^\p{L}\p{N}' -]+/gu, " ").split(/\s+/).filter(word => word && !ignored.has(word.toLowerCase()));
    return words.slice(0, limit).map(title).join(" ");
  }
  function manifestedRoomIdentity(dms, definitionKey) {
    const definition = ROOM_DEFINITIONS[definitionKey]; if (!definition) return { systemName: clean(definitionKey), name: clean(definitionKey), jobName: "Dungeon Cohort" };
    if (definitionKey === "throne-room") return { systemName: definition.name, name: "Throne Room", jobName: "Throne Cohort" };
    const populationDriven = ["worker-habitat", "administrator-quarters", "barracks", "elite-barracks", "population-nexus"].includes(definitionKey);
    const personal = definitionKey === "thronebound-private-chamber";
    const source = definition.resource ? dms.dungeon.resources[definition.resource]?.name : personal ? dms.thronebound.name : populationDriven ? dms.population.nature : dms.dungeon.theme;
    const stem = manifestationWords(source) || manifestationWords(dms.dungeon.style) || manifestationWords(dms.dungeon.name) || "Dungeon";
    const roomNoun = ROOM_MANIFESTATION_NOUNS[definitionKey] || manifestationWords(definition.name, 3) || "Chamber", jobNoun = JOB_MANIFESTATION_NOUNS[definitionKey] || manifestationWords(definition.job, 3) || "Cohort";
    const name = stem.toLowerCase().includes(roomNoun.toLowerCase()) ? stem : `${stem} ${roomNoun}`;
    const jobName = stem.toLowerCase().includes(jobNoun.toLowerCase()) ? stem : `${stem} ${jobNoun}`;
    return { systemName: definition.name, name, jobName };
  }
  function roomLore(dms, definition, tier, identity = null) {
    if (definition === ROOM_DEFINITIONS["throne-room"]) return throneRoomLore(dms, tier);
    const definitionKey = Object.entries(ROOM_DEFINITIONS).find(([, candidate]) => candidate === definition)?.[0] || "", manifested = identity || manifestedRoomIdentity(dms, definitionKey);
    const worker = populationDescription(dms);
    return {
      appearance: `${manifested.name} is a Tier ${tier} chamber expressed through ${dms.dungeon.style} architecture and the ${dms.dungeon.theme} theme. Its materials, atmosphere, fixtures, and spatial character visibly belong to ${dms.dungeon.name}.`,
      function: `${manifested.name} fulfills the System function "${definition.name}". ${definition.function} In this Dungeon, that function is expressed through ${dms.dungeon.resources[definition.resource]?.name || dms.dungeon.theme}.`,
      job: `${manifested.jobName}: ${worker} manifested for the work performed within ${manifested.name}.`
    };
  }
  ...
  function roomDefinitionKey(reference) {
    const requested = clean(reference).toLowerCase();
    return Object.entries(ROOM_DEFINITIONS).find(([key, definition]) => key.toLowerCase() === requested || definition.name.toLowerCase() === requested)?.[0] || clean(reference);
  }
  function roomByReference(dms, reference) {
    const requested = clean(reference).toLowerCase();
    return dms.rooms[clean(reference)] || Object.values(dms.rooms).find(room => room.name.toLowerCase() === requested || clean(room.systemName).toLowerCase() === requested || room.definition.toLowerCase() === requested || ROOM_DEFINITIONS[room.definition]?.name.toLowerCase() === requested);
  }
  function requirementBalance(dms, costs = {}) {
    const requirements = [], missing = [];
    for (const [role, raw] of Object.entries(costs)) {
      if (role === "marks") {
        const needed = Math.max(0, Number(raw) || 0), held = Math.max(0, Number(dms.currencies.marks) || 0), item = { role, name: "Lustrian Marks", grade: "", needed, held, ready: held >= needed };
        requirements.push(item); if (!item.ready) missing.push(item); continue;
      }
      const resource = dms.dungeon.resources[role]; if (!resource) continue;
      syncResource(resource); const normalized = normalizedResourceDelta(resource, raw), held = normalized.grade ? Number(resource.grades?.[normalized.grade]) || 0 : Number(resource.amount) || 0, item = { role, name: resource.name, grade: normalized.grade, needed: Math.abs(normalized.amount), held, ready: held >= Math.abs(normalized.amount) };
      requirements.push(item); if (!item.ready) missing.push(item);
    }
    return { ready: !missing.length, requirements, missing };
  }
  function formatRequirements(requirements) { return requirements.map(item => `${item.needed} ${item.grade ? `${item.grade} ` : ""}${item.name} (held ${Number(item.held.toFixed(2))})`).join("; ") || "None"; }
  function roomOptionDefinitions(dms) { return Object.entries(ROOM_DEFINITIONS).filter(([key, definition]) => key !== "throne-room" && definition.unlockTier <= dms.dungeon.tier); }
  function roomDefinitionReference(dms, reference) {
    const requested = clean(reference), indexed = requested.match(/^(?:room|facility|option)[-\s#]*(\d+)$/i);
    if (indexed) return roomOptionDefinitions(dms)[Number(indexed[1]) - 1]?.[0] || requested;
    return roomDefinitionKey(requested);
  }
  function roomAvailability(dms, reference) {
    const definitionKey = roomDefinitionReference(dms, reference), definition = ROOM_DEFINITIONS[definitionKey];
    if (!definition) return { definitionKey, visible: false, state: "Unknown", actionable: false, reason: "Unknown facility option." };
    if (definition.unlockTier > dms.dungeon.tier) return { definitionKey, definition, visible: false, state: "Hidden", actionable: false, reason: "This facility is not part of the current progression." };
    const room = Object.values(dms.rooms).find(candidate => candidate.definition === definitionKey), identity = manifestedRoomIdentity(dms, definitionKey), lore = roomLore(dms, definition, Math.max(1, definition.unlockTier), identity), costs = { construction: definition.baseCost, energy: Math.ceil(definition.baseCost / 2) };
    if (room) {
      const state = room.state === "Active" ? "Constructed" : room.state === "Constructing" ? "Under Construction" : room.state, work = { Constructing: "construction", Upgrading: "upgrade", Expanding: "expansion" }[room.state] || room.state.toLowerCase();
      return { definitionKey, definition, identity, lore, room, visible: true, state, actionable: false, costs, reason: room.state === "Active" ? "The facility is already constructed." : `${room.name} already has ${work} work in progress.` };
    }
    const researchTask = dms.tasks.find(task => task.type === "custom-research" && task.definition === definitionKey);
    if (definition.researchRequired && !dms.shops.research[definitionKey]) return { definitionKey, definition, identity, lore, visible: true, state: researchTask ? "Research In Progress" : "Research Required", actionable: false, costs, reason: researchTask ? `Required research is in progress (${researchTask.remaining} Cycle(s) remaining).` : `Dungeon Laboratory research is required before construction.` };
    const affordability = requirementBalance(dms, costs);
    return { definitionKey, definition, identity, lore, visible: true, state: affordability.ready ? "Available" : "Requires Resources", actionable: affordability.ready, costs, affordability, reason: affordability.ready ? "All construction requirements are satisfied." : `Insufficient resources: ${formatRequirements(affordability.missing)}.` };
  }
  function constructionOptions(dms) { return roomOptionDefinitions(dms).map(([key], index) => ({ optionId: `room-${index + 1}`, ...roomAvailability(dms, key) })); }
  function createRoom(dms, definitionKey, free = false) {
    definitionKey = roomDefinitionReference(dms, definitionKey);
    const definition = ROOM_DEFINITIONS[definitionKey];
    if (!definition) throw new Error(`Unknown facility option. Current construction options: ${constructionOptions(dms).map(option => `${option.optionId} (${option.definitionKey})`).join(", ") || "none"}.`);
    const availability = roomAvailability(dms, definitionKey);
    if (!free && !availability.visible) throw new Error("That facility is not available in the current progression.");
    if (!free && !availability.actionable) throw new Error(`${definition.name}: ${availability.reason}`);
    const cost = free ? 0 : definition.baseCost, sequence = dms.generation.roomSequence + 1;
    const id = definitionKey === "throne-room" ? "room-throne" : `room-${sequence}`, taskId = `task-${stableNumber(`${id}|build|${dms.activity.cycle}`)}`;
    ...
    const manifested = manifestedRoomIdentity(dms, definitionKey), room = { id, definition: definitionKey, systemName: manifested.systemName, name: manifested.name, jobName: manifested.jobName, tier: initialTier, expansion: 1, state: free ? "Active" : "Constructing", assignedWorkers: 0, jobPopulation: 0, targetedVeins: [], assignedAdministrator: "", authorityAdministrator: "", lore: roomLore(dms, definition, initialTier, manifested) };
  ...
  function upgradeRoom(dms, roomId) {
    ...
    const taskId = `task-${stableNumber(`${room.id}|tier|${next}|${dms.activity.cycle}`)}`, reservation = reserveResources(dms, { construction: cost, energy: Math.ceil(cost * 0.6) }, `upgrade-room:${room.id}:${next}`, taskId);
    room.state = "Upgrading"; dms.tasks.push({ id: taskId, type: "upgrade-room", roomId: room.id, targetTier: next, remaining: next, reservationId: reservation.id }); applyDerivedState(dms); record(dms, `Began Tier ${next} upgrade for ${room.name}.`); return room;
  }
  function expandRoom(dms, roomId) {
    const room = roomByReference(dms, roomId); if (!room) throw new Error("Unknown facility.");
    ...
    if (room.state !== "Active") throw new Error(`${room.name} already has work in progress.`); const taskId = `task-${stableNumber(`${room.id}|expand|${next}|${dms.activity.cycle}`)}`, reservation = reserveResources(dms, { construction: cost, energy: Math.ceil(cost / 2) }, `expand-room:${room.id}:${next}`, taskId); room.state = "Expanding"; dms.tasks.push({ id: taskId, type: "expand-room", roomId: room.id, targetExpansion: next, remaining: Math.max(1, room.tier), reservationId: reservation.id }); applyDerivedState(dms); record(dms, `Began Expansion ${next} for ${room.name}.`); return room;
  }
  function availableRoomDefinitions(dms) { return Object.entries(ROOM_DEFINITIONS).filter(([key]) => roomAvailability(dms, key).visible); }
  function upgradeDungeon(dms) {
    ...
    const storyRequirement = storyRequirementForTier(next); if (storyRequirement && dms.quests.records[storyRequirement]?.status !== "cleared") throw new Error(`Tier ${next} requires Story milestone ${dms.quests.records[storyRequirement]?.title || storyRequirement}.`);
  ...
  function gradeDefinition(value) {
    const requested = typeof value === "object" ? value.grade : value;
    return RESOURCE_GRADES.find(item => item.name.toLowerCase() === clean(requested || "Basic").toLowerCase() || item.grade === Number(requested));
  }
  function gradeForTier(tier) { return [...RESOURCE_GRADES].reverse().find(item => Number(tier) >= item.tier) || RESOURCE_GRADES[0]; }
  function syncResource(resource) {
    if (!resource.graded) { resource.amount = Math.max(0, Number(resource.amount) || 0); return resource.amount; }
    resource.grades = { ...emptyGradeStock(0), ...(resource.grades || {}) };
    const stored = Object.values(resource.grades).reduce((sum, amount) => sum + Math.max(0, Number(amount) || 0), 0), legacy = Math.max(0, Number(resource.amount) || 0);
    if (legacy > stored) resource.grades.Basic += legacy - stored;
    for (const grade of RESOURCE_GRADES) resource.grades[grade.name] = Number(Math.max(0, Number(resource.grades[grade.name]) || 0).toFixed(4));
    resource.amount = Number(Object.values(resource.grades).reduce((sum, amount) => sum + amount, 0).toFixed(4)); return resource.amount;
  }
  function normalizedResourceDelta(role, value) {
    const resource = role && typeof role === "object" ? role : null;
    const amount = Number(value && typeof value === "object" ? value.amount : value) || 0;
    if (!resource?.graded) return { amount, grade: "" };
    const grade = gradeDefinition(value && typeof value === "object" ? value.grade : "Basic"); if (!grade) throw new Error("Resource Grade must be Basic, Intermediate, Advanced, or Mastery.");
    return { amount, grade: grade.name };
  }
  function resourceStorage(dms) {
    ...
    const base = 1000 * Math.max(1, Number(dms.dungeon.tier) + 1);
    return { enabled: dms.dungeon.tier >= 4, multiplier: Number(multiplier.toFixed(2)), limits: Object.fromEntries(RESOURCE_ROLES.map(role => [role, Number((base * multiplier).toFixed(2))])), amounts: Object.fromEntries(RESOURCE_ROLES.map(role => [role, syncResource(dms.dungeon.resources[role])])) };
  }
  function transactResources(dms, deltas, context = "transaction", options = {}) {
    const normalized = {}, storage = resourceStorage(dms), limits = storage.limits;
    for (const [rawRole, rawValue] of Object.entries(deltas || {})) {
      ...
      const resource = dms.dungeon.resources[role], change = normalizedResourceDelta(resource, rawValue); syncResource(resource);
      const grade = change.grade && gradeDefinition(change.grade); if (change.amount > 0 && grade?.grade > 1 && dms.dungeon.tier < grade.tier && !options.ignoreGradeGate) throw new Error(`${grade.name} resources require Dungeon Tier ${grade.tier}.`);
      const current = change.grade ? Number(resource.grades[change.grade]) || 0 : Number(resource.amount) || 0;
      if (current + change.amount < -1e-9) throw new Error(`Requires ${Math.abs(change.amount)} ${change.grade ? `${change.grade} ` : ""}${resource.name || role}.`);
      normalized[role] = change;
    }
    const changes = {};
    for (const [role, change] of Object.entries(normalized)) {
      if (!change.amount) continue;
      const resource = dms.dungeon.resources[role], before = syncResource(resource), beforeGrade = change.grade ? Number(resource.grades[change.grade]) || 0 : before;
      let applied = change.amount;
      if (applied > 0 && storage.enabled && !options.ignoreCapacity) applied = Math.min(applied, Math.max(0, limits[role] - before));
      if (!applied) continue;
      if (change.grade) { resource.grades[change.grade] = Number((beforeGrade + applied).toFixed(4)); resource.amount = Number(Object.values(resource.grades).reduce((sum, amount) => sum + Math.max(0, Number(amount) || 0), 0).toFixed(4)); } else resource.amount = Number((before + applied).toFixed(4));
      const after = syncResource(resource);
      changes[role] = { before, delta: applied, after, ...(change.grade ? { grade: change.grade, gradeBefore: beforeGrade, gradeAfter: resource.grades[change.grade] } : {}) };
    }
  ...
  function signedAssetMap(values, sign) { return Object.fromEntries(Object.entries(values || {}).filter(([role]) => RESOURCE_ROLES.includes(clean(role).toLowerCase())).map(([role, value]) => [role, value && typeof value === "object" ? { ...value, amount: sign * Math.abs(Number(value.amount) || 0) } : sign * Math.abs(Number(value) || 0)])); }
  function spend(dms, costs, context = "spend") { return transactResources(dms, signedAssetMap(costs, -1), context); }
  function rewardResources(dms, rewards, context = "reward") { return transactResources(dms, signedAssetMap(rewards, 1), context); }
  function transactMarks(dms, delta, context = "marks") {
    delta = Number(delta) || 0; const before = Math.max(0, Number(dms.currencies.marks) || 0);
    if (before + delta < -1e-9) throw new Error(`Requires ${Math.abs(delta)} Lustrian Marks.`);
    dms.currencies.marks = Number((before + delta).toFixed(4));
    if (delta) { dms.resourceTransactions ||= []; dms.resourceTransactions.push({ revision: markStateChanged(dms), cycle: dms.activity.cycle, kind: "marks", context: clean(context), changes: { marks: { before, delta, after: dms.currencies.marks } } }); dms.resourceTransactions = dms.resourceTransactions.slice(-50); }
    return { before, delta, after: dms.currencies.marks };
  }
  function refineResource(dms, role, amount, targetGrade) {
    role = clean(role).toLowerCase(); const resource = dms.dungeon.resources[role], target = gradeDefinition(targetGrade);
    if (!resource || !resource.graded) throw new Error("Only Construction, Sustenance, and Development resources have Grades.");
    if (!target || target.grade <= 1) throw new Error("Choose Intermediate, Advanced, or Mastery as the refinement target.");
    if (dms.dungeon.tier < target.tier) throw new Error(`${target.name} resources require Dungeon Tier ${target.tier}.`);
    const room = Object.values(dms.rooms).find(candidate => candidate.state === "Active" && ROOM_DEFINITIONS[candidate.definition]?.resource === role && candidate.tier >= target.tier);
    if (!room) throw new Error(`An active ${title(role)} production facility at Tier ${target.tier} is required.`);
    amount = Math.max(1, Number(amount) || 0); const source = RESOURCE_GRADES[target.grade - 2]; syncResource(resource);
    if ((resource.grades[source.name] || 0) < amount) throw new Error(`Requires ${amount} ${source.name} ${resource.name}.`);
    transactResources(dms, { [role]: { amount: -amount, grade: source.name } }, `refine:${role}:${target.name}`);
    transactResources(dms, { [role]: { amount, grade: target.name } }, `refine:${role}:${target.name}`, { ignoreCapacity: true });
    record(dms, `Refined ${amount} ${resource.name} from ${source.name} to ${target.name}.`); return { role, amount, sourceGrade: source.name, targetGrade: target.name };
  }
  function reserveResources(dms, costs, context = "reservation", ownerId = "") {
    const resourceCosts = signedAssetMap(costs, -1), markCost = Math.max(0, Number(costs?.marks) || 0);
    for (const [role, value] of Object.entries(resourceCosts)) { const resource = dms.dungeon.resources[role], change = normalizedResourceDelta(resource, value); syncResource(resource); const available = change.grade ? resource.grades[change.grade] : resource.amount; if (available + change.amount < -1e-9) throw new Error(`Requires ${Math.abs(change.amount)} ${change.grade ? `${change.grade} ` : ""}${resource.name}.`); }
    if (dms.currencies.marks < markCost) throw new Error(`Requires ${markCost} Lustrian Marks.`);
    const id = `reservation-${++dms.generation.reservationSequence}`;
    const resourceChanges = transactResources(dms, resourceCosts, `reserve:${context}`); if (markCost) transactMarks(dms, -markCost, `reserve:${context}`);
    dms.reservations[id] = { id, ownerId: clean(ownerId), context: clean(context), resources: Object.fromEntries(Object.entries(resourceChanges).map(([role, change]) => [role, { amount: Math.abs(change.delta), ...(change.grade ? { grade: change.grade } : {}) }])), marks: markCost, status: "Reserved", cycle: dms.activity.cycle };
    markStateChanged(dms); return dms.reservations[id];
  }
  function commitReservation(dms, reservationId) { const reservation = dms.reservations[clean(reservationId)]; if (!reservation || reservation.status !== "Reserved") throw new Error("Unknown or inactive resource reservation."); reservation.status = "Committed"; delete dms.reservations[reservation.id]; markStateChanged(dms); return reservation; }
  function returnReservation(dms, reservationId) { const reservation = dms.reservations[clean(reservationId)]; if (!reservation || reservation.status !== "Reserved") throw new Error("Unknown or inactive resource reservation."); transactResources(dms, reservation.resources, `return:${reservation.context}`, { ignoreCapacity: true }); if (reservation.marks) transactMarks(dms, reservation.marks, `return:${reservation.context}`); reservation.status = "Returned"; delete dms.reservations[reservation.id]; markStateChanged(dms); return reservation; }
  function transactInventory(dms, deltas, context = "inventory") {
    const normalized = {};
    for (const [rawName, rawValue] of Object.entries(deltas || {})) {
      const name = clean(rawName); if (!name) throw new Error("Inventory resource name is required.");
      const explicitGrade = rawValue && typeof rawValue === "object", grade = explicitGrade ? gradeDefinition(rawValue) : RESOURCE_GRADES[0]; if (!grade) throw new Error("Lustrian resource Grade must be Basic, Intermediate, Advanced, or Mastery.");
      const delta = Number(explicitGrade ? rawValue.amount : rawValue) || 0, current = Number(dms.world.lustria.inventory[name]) || 0;
      const grades = dms.world.lustria.inventoryGrades[name] = { ...emptyGradeStock(0), ...(dms.world.lustria.inventoryGrades[name] || {}) };
      const gradeTotal = Object.values(grades).reduce((sum, amount) => sum + Math.max(0, Number(amount) || 0), 0); if (current > gradeTotal) grades.Basic += current - gradeTotal;
      if ((Number(grades[grade.name]) || 0) + delta < -1e-9) throw new Error(`Requires ${Math.abs(delta)} ${grade.name} ${name}.`);
      normalized[name] = { delta, grade: grade.name, explicitGrade };
    }
    const changes = {};
    for (const [name, change] of Object.entries(normalized)) { if (!change.delta) continue; const before = Number(dms.world.lustria.inventory[name]) || 0, grades = dms.world.lustria.inventoryGrades[name], gradeBefore = Number(grades[change.grade]) || 0; grades[change.grade] = Number((gradeBefore + change.delta).toFixed(4)); dms.world.lustria.inventory[name] = Number(Object.values(grades).reduce((sum, amount) => sum + Math.max(0, Number(amount) || 0), 0).toFixed(4)); changes[name] = { before, delta: change.delta, after: dms.world.lustria.inventory[name], ...(change.explicitGrade ? { grade: change.grade, gradeBefore, gradeAfter: grades[change.grade] } : {}) }; }
  ...
  function workerCohort(dms, roomId) { return dms.population.workers.cohorts.find(cohort => cohort.workRoomId === clean(roomId)); }
  function workerEfficiency(dms, roomId) { const cohort = workerCohort(dms, roomId); return cohort ? Number((cohort.efficiency * Math.max(0.5, 1 - cohort.disruption / 200)).toFixed(4)) : 0; }
  function residenceCapacity(room) {
    const definition = ROOM_DEFINITIONS[room?.definition]; if (!definition || room.state !== "Active") return 0;
    return Math.max(0, Number(definition.administratorSuites || definition.privateCapacity || 0) * Math.max(1, room.expansion || 1) * Math.max(1, room.tier || 1));
  }
  function residenceTarget(dms, target) {
    if (/^thronebound$/i.test(clean(target)) || clean(target).toLowerCase() === dms.thronebound.name.toLowerCase()) return { id: "thronebound", character: dms.thronebound };
    const character = resolveCharacter(dms, target); return character?.id ? { id: character.id, character } : null;
  }
  function assignResidence(dms, target, roomReference) {
    const resident = residenceTarget(dms, target), room = roomByReference(dms, roomReference), definition = room && ROOM_DEFINITIONS[room.definition];
    if (!resident) throw new Error("A permanent residence target must be the Thronebound or an Administrator.");
    if (!room || room.state !== "Active" || !(definition?.administratorSuites || definition?.privateCapacity)) throw new Error("Choose active Administrator Quarters or the Thronebound Private Chamber.");
    if (definition.administratorSuites && resident.id === "thronebound") throw new Error("Administrator Quarters suites are reserved for Administrators.");
    const occupied = Object.entries(dms.residences.assignments).filter(([id, assignment]) => id !== resident.id && assignment.roomId === room.id).length;
    if (occupied >= residenceCapacity(room)) throw new Error(`${room.name} has no unassigned residential suite.`);
    dms.residences.assignments[resident.id] = { roomId: room.id };
    record(dms, `${resident.character.name} received a residence assignment in ${room.name}.`); return dms.residences.assignments[resident.id];
  }
  function nameResidence(dms, target, name, theme = "", bonus = "Bond") {
    const resident = residenceTarget(dms, target), assignment = resident && dms.residences.assignments[resident.id]; if (!resident || !assignment) throw new Error("Assign a permanent residence before naming it.");
    name = clean(name); if (!name) throw new Error("A Named Residence requires a unique name."); if (Object.values(dms.residences.named).some(value => value.name.toLowerCase() === name.toLowerCase() && value.residentId !== resident.id)) throw new Error(`Named Residence ${name} already exists.`);
    const canonicalBonus = ["Bond", "Efficiency"].find(value => value.toLowerCase() === clean(bonus).toLowerCase()) || "Bond";
    dms.residences.named[resident.id] = { residentId: resident.id, roomId: assignment.roomId, name, theme: clean(theme) || dms.dungeon.theme, bonus: canonicalBonus };
    record(dms, `${name} became ${resident.character.name}'s Named Residence with a ${canonicalBonus} specialization.`); return dms.residences.named[resident.id];
  }
  function assignPrivateStay(dms, target, roomReference = "Thronebound Private Chamber") {
    const room = roomByReference(dms, roomReference), definition = room && ROOM_DEFINITIONS[room.definition]; if (!room || room.state !== "Active" || !definition?.privateCapacity) throw new Error("An active Thronebound Private Chamber is required.");
    const resident = residenceTarget(dms, target), id = resident?.id || `guest-${stableNumber(clean(target)).toString(36)}`, name = resident?.character.name || clean(target); if (!name) throw new Error("A current-stay assignment requires a named character or Administrator.");
    const occupied = Object.entries(dms.residences.stays).filter(([otherId, stay]) => otherId !== id && stay.roomId === room.id).length; if (occupied >= residenceCapacity(room)) throw new Error(`${room.name} has no available guest space.`);
    dms.residences.stays[id] = { roomId: room.id, name }; record(dms, `${name} is currently staying in ${room.name}.`); return dms.residences.stays[id];
  }
  function assignDetainment(dms, target, roomReference = "Thronebound Private Chamber") {
    const room = roomByReference(dms, roomReference), definition = room && ROOM_DEFINITIONS[room.definition]; if (!room || room.state !== "Active" || !definition?.detainmentSlots) throw new Error("An active Thronebound Private Chamber with a detainment slot is required.");
    const name = clean(target), id = `detained-${stableNumber(name).toString(36)}`; if (!name) throw new Error("A detainment assignment requires a target name.");
    const occupied = Object.values(dms.residences.detainments).filter(value => value.roomId === room.id).length; if (!dms.residences.detainments[id] && occupied >= definition.detainmentSlots * Math.max(1, room.expansion || 1)) throw new Error(`${room.name} has no available detainment assignment.`);
    dms.residences.detainments[id] = { roomId: room.id, name }; record(dms, `${name} received a controlled detainment assignment in ${room.name}.`); return dms.residences.detainments[id];
  }
  function residentialBondMultiplier(dms, administrator) {
    let multiplier = 0.9; const assignment = dms.residences.assignments[administrator.id], room = assignment && dms.rooms[assignment.roomId], definition = room && ROOM_DEFINITIONS[room.definition];
    if (room?.state === "Active") multiplier = 1 + Number(definition.bondGainBonus || 0) + Math.max(0, room.tier - 1) * 0.05;
    const named = dms.residences.named[administrator.id]; if (named?.bonus === "Bond") multiplier += 0.05;
    if (dms.residences.stays[administrator.id]) multiplier += 0.1;
  ...
  function applyDerivedState(dms) {
    ...
    let workers = 0; const previousCohorts = new Map((dms.population.workers.cohorts || []).map(cohort => [cohort.id, cohort])); const cohorts = [];
    for (const room of Object.values(dms.rooms)) {
      const definition = ROOM_DEFINITIONS[room.definition]; if (!definition) continue;
      ...
      if (baseJobs && !["military"].includes(definition.kind)) { const jobName = room.jobName || clean(room.lore.job).split(":")[0] || definition.job; dms.population.workers.assignments[room.id] = { count: room.jobPopulation, tier: room.tier, job: jobName }; room.assignedWorkers = room.jobPopulation; workers += room.jobPopulation; const id = `workers-${room.id}`, previous = previousCohorts.get(id); cohorts.push({ id, workRoomId: room.id, work: room.name, job: jobName, count: room.jobPopulation, tier: room.tier, manifestation: populationDescription(dms), disruption: clamp(previous?.disruption || 0, 0, 100), residenceRoomIds: [], residence: "Temporary Quarters", housingStatus: "Unhoused", housed: 0, efficiency: 0.9, upkeepMultiplier: 1, recoveryRate: 0 }); }
    }
    const housing = Object.values(dms.rooms).filter(room => room.state === "Active" && ROOM_DEFINITIONS[room.definition]?.workerHousing).map(room => ({ room, remaining: ROOM_DEFINITIONS[room.definition].workerHousing * room.tier * Math.max(1, room.expansion || 1) }));
    for (const cohort of cohorts) {
      let housed = 0, improved = 0, improvedBonus = 0, upkeepDiscount = 0; const labels = [];
      for (const pool of housing) { if (pool.remaining <= 0 || housed >= cohort.count) continue; const amount = Math.min(pool.remaining, cohort.count - housed), housingDefinition = ROOM_DEFINITIONS[pool.room.definition]; pool.remaining -= amount; housed += amount; upkeepDiscount += amount * Number(housingDefinition.housingUpkeepDiscount || 0); if (pool.room.tier > cohort.tier) { improved += amount; improvedBonus += amount * Number(housingDefinition.housingEfficiencyBonus || 0); } cohort.residenceRoomIds.push(pool.room.id); labels.push(`${pool.room.name} ${amount}/${cohort.count}`); cohort.recoveryRate = Math.max(cohort.recoveryRate, Number(housingDefinition.recoveryRate || 0)); }
      const housedRatio = cohort.count ? housed / cohort.count : 0; cohort.housed = housed; cohort.residence = labels.join(", ") || "Temporary Quarters"; cohort.housingStatus = housed === 0 ? "Unhoused" : housed < cohort.count ? "Partially Housed" : improved > 0 ? "Improved Housing" : "Properly Housed"; cohort.efficiency = Number((0.9 + housedRatio * 0.1 + (cohort.count ? improvedBonus / cohort.count : 0)).toFixed(4)); cohort.upkeepMultiplier = Number((1 - (cohort.count ? upkeepDiscount / cohort.count : 0)).toFixed(4));
    }
  ...
  function disruptWorkerCohort(dms, cohortId, amount) {
    applyDerivedState(dms); const cohort = dms.population.workers.cohorts.find(value => value.id === clean(cohortId)); if (!cohort) throw new Error("Unknown Worker cohort."); cohort.disruption = clamp(cohort.disruption + Number(amount || 0), 0, 100); record(dms, `${cohort.job} disruption changed to ${cohort.disruption}%.`); return cohort;
  }
  ...
  function recruitSoldiers(dms, archetype, count, barracksId) {
    ...
    const cohort = { id: `soldiers-${dms.population.soldiers.cohorts.length + 1}`, archetype, count, tier: room.tier, sourceRoom: room.id, description: `${populationDescription(dms)} Adapted as ${SOLDIER_ARCHETYPES[archetype].description}.` };
  ...
  function combatPower(dms) {
    const raw = dms.population.soldiers.cohorts.reduce((sum, cohort) => sum + cohort.count * SOLDIER_ARCHETYPES[cohort.archetype].power * Math.pow(cohort.tier, 1.5), 0) + equipmentCombatBonus(dms);
    let multiplier = 1;
  ...
  function defensePower(dms) {
    ...
    const multiplier = 1 + Object.values(dms.rooms).filter(room => room.state === "Active").reduce((sum, room) => sum + (ROOM_DEFINITIONS[room.definition]?.defenseMultiplier || 0) * room.tier, 0);
    return Number((raw * multiplier * dungeonAttributeMultiplier(dms, "Defense")).toFixed(2));
  }
  function equipmentCombatBonus(dms) {
    return Object.values(dms.equipment.items || {}).reduce((sum, item) => { if (item.status !== "Active" || !item.assignedTo) return sum; const cohort = dms.population.soldiers.cohorts.find(candidate => candidate.id === item.assignedTo); return sum + (Number(item.bonuses?.combat) || 0) * (cohort ? cohort.count : 1); }, 0);
  }
  function activeForge(dms) { return Object.values(dms.rooms).find(room => room.definition === "forge" && room.state === "Active"); }
  function generateEquipmentOptions(dms, purpose = "General") {
    const forge = activeForge(dms); if (!forge) throw new Error("An active Dungeon Forge is required.");
    const key = `${clean(purpose) || "General"}|${forge.tier}`, existing = dms.equipment.previews[key]; if (existing) return existing;
    const grade = gradeForTier(forge.tier), themes = clean(dms.dungeon.theme).split(/\s+/).filter(Boolean), themeWord = title(choose(themes.length ? themes : ["Dungeon"], `${dms.dungeon.name}|equipment-theme|${key}`));
    const templates = [
      { slot: "Weapon", noun: "Edge", description: "A combat implement", combat: 2 },
      { slot: "Armor", noun: "Aegis", description: "Protective equipment", combat: 1 },
      { slot: "Tool", noun: "Instrument", description: "A management and field tool", combat: 0 }
    ];
    const options = templates.map((template, index) => ({ id: `equipment-option-${stableNumber(`${dms.dungeon.name}|${key}|${index}`).toString(36)}`, name: `${themeWord} ${template.noun}`, slot: template.slot, tier: forge.tier, grade: grade.name, description: `${template.description} expressed through ${dms.dungeon.theme} and ${dms.dungeon.style}.`, bonuses: { combat: template.combat + stableNumber(`${key}|combat|${index}`) % 3, support: template.slot === "Tool" ? 2 + stableNumber(`${key}|support|${index}`) % 3 : 0, defense: template.slot === "Armor" ? 2 + stableNumber(`${key}|defense|${index}`) % 3 : 0 } }));
    dms.equipment.previews[key] = options; record(dms, `Generated deterministic Tier ${forge.tier} equipment options for ${clean(purpose) || "General"}.`); return options;
  }
  function craftEquipment(dms, optionId, assignedTo = "") {
    const forge = activeForge(dms); if (!forge) throw new Error("An active Dungeon Forge is required.");
    const option = Object.values(dms.equipment.previews).flat().find(candidate => candidate.id === clean(optionId)); if (!option) throw new Error("Unknown equipment option; generate Forge options first.");
    if (option.tier > forge.tier * (ROOM_DEFINITIONS[forge.definition].equipmentTier || 0)) throw new Error(`The Dungeon Forge cannot craft Tier ${option.tier} equipment.`);
    const sequence = dms.generation.equipmentSequence + 1, itemId = `equipment-${sequence}`, taskId = `task-${stableNumber(`${itemId}|craft|${dms.activity.cycle}`)}`, grade = option.grade || gradeForTier(option.tier).name;
    const reservation = reserveResources(dms, { construction: { amount: 20 * option.tier, grade }, development: { amount: 10 * option.tier, grade }, energy: 10 * option.tier }, `craft-equipment:${itemId}`, taskId);
    dms.generation.equipmentSequence = sequence; dms.tasks.push({ id: taskId, type: "craft-equipment", itemId, option: { ...option }, assignedTo: clean(assignedTo), remaining: Math.max(1, option.tier), reservationId: reservation.id }); record(dms, `Began crafting ${option.name} (${itemId}).`); return dms.tasks[dms.tasks.length - 1];
  }
  function finalizeEquipmentTask(dms, task) { const item = { ...task.option, id: task.itemId, optionId: task.option.id, assignedTo: clean(task.assignedTo), status: "Active", craftedAt: dms.activity.cycle + 1 }; dms.equipment.items[item.id] = item; return item; }
  function assignEquipment(dms, itemId, target) {
    const item = dms.equipment.items[clean(itemId)]; if (!item || item.status !== "Active") throw new Error("Unknown active equipment item.");
    const character = resolveCharacter(dms, target), cohort = dms.population.soldiers.cohorts.find(candidate => candidate.id === clean(target));
    const targetId = /^thronebound$/i.test(clean(target)) ? "thronebound" : character?.id || cohort?.id; if (!targetId) throw new Error("Equipment target must be the Thronebound, an Administrator, or a Soldier cohort.");
    for (const current of Object.values(dms.equipment.items)) if (current.id !== item.id && current.assignedTo === targetId && current.slot === item.slot) current.assignedTo = "";
    item.assignedTo = targetId; applyDerivedState(dms); record(dms, `Assigned ${item.name} to ${targetId}.`); return item;
  }
  ...
  function summonAdministrator(dms, requestedName = "", requestedRace = "") {
    ...
    const nextSequence = dms.generation.administratorSequence + 1, roles = administratorRoles(dms), availableRoles = roles.filter(value => value !== "Manager");
    if (nextSequence > 1 && !availableRoles.length) throw new Error("No active non-Throne facility function can produce a valid Administrator role. Complete construction of a relevant facility first.");
    const sequence = ++dms.generation.administratorSequence, id = `administrator-${sequence}`;
    const role = sequence === 1 ? "Manager" : choose(availableRoles, `${dms.dungeon.name}|administrator-role|${sequence}`);
  ...
  function assignAdministrator(dms, administratorId, roomId) {
    const administrator = resolveCharacter(dms, administratorId), room = roomByReference(dms, roomId); if (!administrator?.id || !room) throw new Error("Unknown Administrator or facility.");
    ...
    room.assignedAdministrator = administrator.id; administrator.assignedRooms = [room.id]; if (dms.dungeon.tier >= 1) tierOneMilestone(dms, "administratorAssigned", true); record(dms, `${administrator.name} was assigned to ${room.name}.`); return room;
  }
  ...
  function addAdministratorBond(dms, administratorId, amount) {
    ...
    if (dms.dungeon.tier < 1) throw new Error("Administrator Bond progression becomes available at Dungeon Tier 1.");
    const threshold = currentBondThreshold(administrator), before = administrator.bond.value, gained = clamp(amount, 0, 100) * residentialBondMultiplier(dms, administrator); administrator.bond.value = Number(Math.min(threshold, before + gained).toFixed(2));
    if (administrator.bond.value > before && dms.dungeon.tier >= 1) tierOneMilestone(dms, "bondGained", true); if (administrator.bond.value >= 5 && dms.dungeon.tier >= 1) tierOneMilestone(dms, "bondThresholdReached", true);
    if (administrator.bond.value >= threshold && !dms.quests.records[`bond-${administrator.id}-${threshold}`]) {
      const softLock = threshold % 20 === 0 ? { type: "gift", tier: Math.max(1, Math.ceil(threshold / 20)) } : threshold % 15 === 0 ? { type: "location", tier: Math.max(1, Math.ceil(threshold / 20)) } : null, questId = `bond-${administrator.id}-${threshold}`;
      dms.quests.records[questId] = normalizeQuestRecord(questId, { id: questId, category: "Bond", chain: `${administrator.name} Bond`, step: threshold / 5, tier: dms.dungeon.tier, title: `${administrator.name} Bond Event ${threshold}%`, status: "active", scope: "Dungeon", missionType: "Internal", description: "A personal threshold in the Dungeon bond has been reached. The bond cannot rise farther until this event is meaningfully resolved in play.", objective: softLock?.type === "gift" ? `Share a Tier ${softLock.tier} gift or equivalent meaningful act with {administrator:bond}.` : softLock?.type === "location" ? `Visit and share a meaningful scene with {administrator:bond} at a location accessible from Tier ${softLock.tier}.` : `Complete a personal Bond scene with {administrator:bond}.`, references: [{ type: "administrator", id: administrator.id, role: "bond" }], softLock, rewards: { experience: 25 + threshold * 2 }, dynamic: true });
      queueQuestNotification(dms, "active", dms.quests.records[questId]); markStateChanged(dms);
    }
  ...
  function completeBondEvent(dms, administratorId) {
    ...
    administrator.bond.completedEvents.push(threshold); transitionQuest(dms, quest, "cleared"); if (threshold === 5 && dms.dungeon.tier >= 1) tierOneMilestone(dms, "bondEventCompleted", true); record(dms, `${administrator.name}'s ${threshold}% Bond Event was completed.`); return administrator.bond;
  }
  ...
  function generateClassPreviews(dms, target) {
    ...
    const key = previewKey(target), existing = Array.isArray(dms.classPreviews[key]) && dms.classPreviews[key].length > 0, next = character.class.tier + 1; if (next > dms.dungeon.classTierLimit) throw new Error(`Class Tier ${next} requires Dungeon Tier ${next}.`);
    ...
    dms.classPreviews[key] = previews; if (key === "thronebound" && existing && dms.dungeon.tier >= 1) tierOneMilestone(dms, "classPreviewsRegenerated", true); refreshCards(dms); return previews;
  }
  ...
  function acceptClassPreview(dms, target, option = 1) {
    ...
    if (next === 1 && !character.id) { if (!systemAvailable(dms)) throw new Error("Initial Class Selection must occur in the Throne Room during System Mode."); if (previews.length !== 3) throw new Error("Initial Class Selection requires exactly three generated Thronebound Class previews."); if (!dms.milestones.tier1.classPreviewsReviewed) throw new Error("Review the three Class previews before accepting the Thronebound's first Class."); }
    ...
    const chosenSkills = character.id ? [character.attributeSpecialization === "combat" ? preview.combatSkill : preview.managementSkill] : [preview.combatSkill, preview.managementSkill];
    for (const skill of chosenSkills) if (!clean(skill.name) || hasNamed(character.class.skills, skill.name)) throw new Error(`Duplicate or invalid Skill: ${skill.name || "Unnamed"}.`);
    if (!clean(preview.trait.name) || hasNamed(character.class.traits, preview.trait.name)) throw new Error(`Duplicate or invalid Trait: ${preview.trait.name || "Unnamed"}.`);
    if (new Set(chosenSkills.map(skill => clean(skill.name).toLowerCase())).size !== chosenSkills.length) throw new Error("A Class preview cannot grant duplicate Skills.");
    ...
    addTrait(character, preview.trait.name, preview.trait.description, next, `Class Tier ${next}`); character.class.lineage ||= []; character.class.lineage.push({ tier: next, className: preview.className, description: preview.description, combatSkill: character.id && character.attributeSpecialization !== "combat" ? "" : preview.combatSkill.name, managementSkill: character.id && character.attributeSpecialization === "combat" ? "" : preview.managementSkill.name, trait: preview.trait.name, acceptedCycle: dms.activity.cycle }); delete dms.classPreviews[key]; if (key === "thronebound" && dms.dungeon.tier >= 1) { tierOneMilestone(dms, "classAccepted", true); if (!dms.milestones.tier1.classPreviewsRegenerated) tierOneMilestone(dms, "classPreviewsRegenerated", "accepted-unchanged"); } record(dms, `${character.name} accepted ${preview.className} at Class Tier ${next}.`); refreshCards(dms); return character;
  }
  ...
  function canonicalLocation(dms, major) {
    const requested = clean(major), lower = requested.toLowerCase();
    if (lower === clean(dms?.dungeon?.name).toLowerCase()) return "Dungeon";
    if (lower === clean(dms?.world?.homeworld).toLowerCase()) return "Homeworld";
    return LOCATIONS.find(location => location.toLowerCase() === lower) || "";
  }
  function setLocation(dms, major, secondary = "", detail = "") {
    const canonical = canonicalLocation(dms, major); if (!canonical) throw new Error(`Major location must be ${LOCATIONS.join(", ")}, the Dungeon name, or the Homeworld name.`);
    ...
    if (canonical === "Homeworld" && !clean(secondary)) secondary = dms.world.homeworldAnchor;
    dms.activity.location = { major: canonical, secondary: clean(secondary), detail: clean(detail) }; if (canonical !== "Dungeon" && dms.dungeon.tier >= 2) recordPortalAnchor(dms, canonical, secondary, detail); record(dms, `Location changed to ${canonical}${secondary ? ` — ${secondary}` : ""}.`); return dms.activity.location;
  }
  function setActivity(dms, mode, targets, pace) {
    ...
    if (canonicalMode === "System" && !(dms.activity.location.major === "Dungeon" && /^Throne Room$/i.test(dms.activity.location.secondary))) throw new Error("System Mode can only be entered within the Throne Room.");
    if (canonicalMode === "Bond" && dms.dungeon.tier < 1) throw new Error("Bond Activity becomes available at Dungeon Tier 1.");
    if (canonicalMode === "Bond" && !unique(targets).some(target => resolveCharacter(dms, target)?.id)) throw new Error("Bond Activity requires an Administrator target.");
    dms.activity.mode = canonicalMode; dms.activity.targets = unique(targets); dms.activity.pace = canonicalPace;
    if (canonicalMode === "System") dms.onboarding.systemEntered = true;
    updateQuests(dms); record(dms, `Activity changed to ${canonicalMode} / ${canonicalPace}.`); return dms.activity;
  }
  ...
  function recordPortalAnchor(dms, major, secondary = "", detail = "") {
    const signature = [clean(major), clean(secondary), clean(detail)].join("|"), id = `anchor-${stableNumber(signature).toString(36)}`;
    if (!dms.portals.anchors[id]) { dms.portals.anchors[id] = { id, major: clean(major), secondary: clean(secondary), detail: clean(detail), discoveredAt: dms.activity.cycle, status: "Known" }; markStateChanged(dms); }
    return dms.portals.anchors[id];
  }
  function portalRouteLimit(dms) { return Object.values(dms.rooms).filter(room => room.state === "Active").reduce((sum, room) => sum + (ROOM_DEFINITIONS[room.definition]?.portalRoutes || 0) * room.tier, 0); }
  function openPortalRoute(dms, anchorId) {
    const anchor = dms.portals.anchors[clean(anchorId)]; if (!anchor) throw new Error("Unknown Portal Anchor."); const limit = portalRouteLimit(dms); if (!limit) throw new Error("An active Portal Gate is required to establish persistent routes.");
    const existing = Object.values(dms.portals.routes).find(route => route.anchorId === anchor.id); if (existing) { existing.status = "Active"; markStateChanged(dms); return existing; }
    const active = Object.values(dms.portals.routes).filter(route => route.status === "Active").length; if (active >= limit) throw new Error(`Portal route capacity is ${limit}.`);
    spend(dms, { energy: 25 * Math.max(1, dms.dungeon.tier) }, "open-portal-route"); const id = `route-${stableNumber(`${dms.dungeon.name}|${anchor.id}`).toString(36)}`, route = { id, anchorId: anchor.id, status: "Active", openedAt: dms.activity.cycle }; dms.portals.routes[id] = route; record(dms, `Opened portal route ${id} to ${anchor.major}${anchor.secondary ? ` — ${anchor.secondary}` : ""}.`); return route;
  }
  function closePortalRoute(dms, routeId) { const route = dms.portals.routes[clean(routeId)]; if (!route || route.status !== "Active") throw new Error("Unknown active portal route."); route.status = "Closed"; record(dms, `Closed portal route ${route.id}.`); return route; }
  function travelPortalRoute(dms, routeId) { const route = dms.portals.routes[clean(routeId)], anchor = route && dms.portals.anchors[route.anchorId]; if (!route || route.status !== "Active" || !anchor) throw new Error("Unknown active portal route."); spend(dms, { energy: 2 }, "portal-travel"); setLocation(dms, anchor.major, anchor.secondary, anchor.detail); return { route, anchor }; }

  function dungeonSectorRecord(dms) {
    const sector = dms.story.dungeonSector;
    dms.world.lustria.sectors[sector.id] ||= { id: sector.id, kind: "Dungeon Sector", relationship: sector.relationship, distance: sector.distance, name: sector.name, status: sector.discoveryState, threat: 0, veins: [], sites: [], classification: { ...sector.classification }, observations: [] };
    return dms.world.lustria.sectors[sector.id];
  }
  function recordDungeonSectorObservation(dms, phase, summary, facts = {}) {
    const canonicalPhase = ["First Exit", "Perimeter", "Intrusion"].find(value => value.toLowerCase() === clean(phase).toLowerCase());
    if (!canonicalPhase) throw new Error("Dungeon Sector observation phase must be First Exit, Perimeter, or Intrusion.");
    const note = clean(summary); if (!note) throw new Error("A Dungeon Sector observation requires an established narrative fact or compact observation note.");
    const sector = dms.story.dungeonSector, id = `observation-${stableNumber(`${canonicalPhase}|${note}`).toString(36)}`;
    if (!sector.observations.some(observation => observation.id === id)) sector.observations.push({ id, phase: canonicalPhase, summary: note, facts: facts && typeof facts === "object" ? { ...facts } : {}, cycle: dms.activity.cycle });
    if (canonicalPhase === "First Exit" && STORY_SECTOR_STATES.indexOf(sector.discoveryState) < 1) sector.discoveryState = "Initial Observation";
    if (canonicalPhase === "Perimeter" && STORY_SECTOR_STATES.indexOf(sector.discoveryState) < 2) sector.discoveryState = "Local Survey";
    if (canonicalPhase === "Intrusion" && STORY_SECTOR_STATES.indexOf(sector.discoveryState) < 3) sector.discoveryState = "Encountered";
    const worldSector = dungeonSectorRecord(dms); worldSector.status = sector.discoveryState; worldSector.observations = sector.observations.map(observation => ({ id: observation.id, phase: observation.phase, summary: observation.summary, cycle: observation.cycle }));
    markStateChanged(dms); updateQuests(dms); return sector.observations.find(observation => observation.id === id);
  }
  function beginDungeonExterior(dms) {
    if (dms.dungeon.tier < 1) throw new Error("The Dungeon must reach Tier 1 before the Thronebound begins the First Contact Story chain.");
    setLocation(dms, "Lustria", "Dungeon Exterior", "Immediate perimeter of the Dungeon"); setActivity(dms, "Travel", ["Dungeon Exterior"], "Slow");
    const sector = dms.story.dungeonSector; sector.exteriorEntered = true; dungeonSectorRecord(dms); markStateChanged(dms); updateQuests(dms);
    return sector;
  }
  function addDungeonSectorTravelContext(dms) {
    const sector = dms.story.dungeonSector; if (!sector.exteriorEntered || dms.activity.location.major !== "Lustria") return sector.travelContext;
    sector.travelContext += 1; sector.travelSinceSnapshot += 1; markStateChanged(dms); return sector.travelContext;
  }
  function scheduleDungeonSectorSnapshot(dms, label = "Investigated local point") {
    const sector = dms.story.dungeonSector;
    if (!sector.exteriorEntered || dms.activity.location.major !== "Lustria") throw new Error("Dungeon Sector snapshots can only be prepared after leaving the Dungeon.");
    if (sector.travelContext < 2 || sector.travelSinceSnapshot < 1) throw new Error("Establish more travel or survey context before investigating a snapshot milestone.");
    if (sector.pendingSnapshot) return sector.pendingSnapshot;
    const phase = sector.observations.some(observation => observation.phase === "First Exit") ? "Perimeter" : "First Exit";
  ...
  function capturePendingDungeonSectorSnapshot(dms, narrative = previousNarrativeOutput()) {
    ...
    if (!pending || !textValue) return null;
    const observation = recordDungeonSectorObservation(dms, pending.phase, textValue, { milestone: pending.label });
    sector.pendingSnapshot = null; sector.travelSinceSnapshot = 0; markStateChanged(dms); return observation;
  }
  function startStoryIntrusion(dms) {
    const intrusion = dms.story.intrusion; if (intrusion.triggered) return intrusion;
    Object.assign(intrusion, { triggered: true, active: true, classification: "Unknown", motive: "Unknown", origin: "Unknown", resolution: "", dungeonSurvived: true, evidence: "The Dungeon detected a hostile or sufficiently threatening presence entering or approaching its controlled interior." });
    record(dms, "The Dungeon registered an unresolved hostile or threatening intrusion; identity, motive, and origin remain unknown."); return intrusion;
  }
  function resolveStoryIntrusion(dms, details = {}) {
    const intrusion = dms.story.intrusion; if (!intrusion.triggered) startStoryIntrusion(dms);
    const resolution = clean(details.resolution), classification = clean(details.classification);
    if (!resolution) throw new Error("Resolving the Story intrusion requires an established resolution.");
    if (!classification || /^Unknown$/i.test(classification)) throw new Error("Record at least a broad classification of the intrusion before resolving it.");
    Object.assign(intrusion, { active: false, classification, motive: clean(details.motive) || "Unknown", origin: clean(details.origin) || "Unknown", resolution, dungeonSurvived: details.dungeonSurvived !== false, evidence: clean(details.evidence) || intrusion.evidence });
    recordDungeonSectorObservation(dms, "Intrusion", intrusion.evidence || `${classification}; resolved by ${resolution}.`, { classification, motive: intrusion.motive, origin: intrusion.origin, resolution });
    record(dms, `Story intrusion resolved through ${resolution}; classification ${classification}.`); return intrusion;
  }
  function scheduleStoryIntrusionResolution(dms, resolution) {
    const intrusion = dms.story.intrusion; if (!intrusion.active) throw new Error("There is no active Story intrusion to resolve.");
    intrusion.pendingResolution ||= { resolution: clean(resolution), preparedCycle: dms.activity.cycle }; markStateChanged(dms); return intrusion.pendingResolution;
  }
  function capturePendingStoryIntrusionResolution(dms, confirmation, narrative = previousNarrativeOutput()) {
    const intrusion = dms.story.intrusion, pending = intrusion.pendingResolution, confirmationText = clean(confirmation), evidence = clean(narrative);
    if (!pending || !evidence || !/\b(?:gone|ended|resolved|over|withdrew|withdrawn|captured|contained|expelled|driven\s+away|sealed|retreated|no\s+longer\s+(?:active|a\s+threat)|dungeon\s+(?:survived|is\s+safe))\b/i.test(confirmationText)) return null;
  ...
  function ensureStoryRemoteSector(dms) {
    ...
    const sector = { id, kind: "Remote Sector", relationship: "Beyond Dungeon Sector", distance: "Reachable", name, threat: 10 + stableNumber(`${id}|threat`) % 15, status: "Generated", discoveryState: "Unobserved", veins: [], sites: [], classification: { biome: choose(["Arcane Wilds", "Broken Uplands", "Living Wetlands", "Resonant Badlands"], `${id}|biome`), certainty: "Procedural lead" } };
    dms.world.lustria.sectors[id] = sector; dms.story.remote.sectorId = id; markStateChanged(dms); return sector;
  }
  function ensureStoryRemoteSite(dms) {
    const sector = ensureStoryRemoteSector(dms); if (dms.story.remote.siteId && dms.world.lustria.sites[dms.story.remote.siteId]) return dms.world.lustria.sites[dms.story.remote.siteId];
    const id = `site-${sector.id.replace(/^sector-/, "")}-story`, name = choose(["Wayfarer's Lantern", "Resonant Waystation", "The Far Marker", "Crossroads Enclave"], `${sector.id}|story-site`), site = { id, sectorId: sector.id, name, kind: "Contact Site", status: "Generated", visited: false };
  ...
  function recordStoryKnowledge(dms, kind, details = "") {
    ...
    const dominionFields = { "major power": "majorPower", "dominion power": "majorPower", regulation: "regulatesDungeons", "dungeon regulation": "regulatesDungeons", "tier visibility": "tierVisibility", visibility: "tierVisibility", "classification consequences": "classificationConsequences", classification: "classificationConsequences", "external growth": "externalGrowth", "external advancement": "externalGrowth" };
    if (key === "organized society") dms.story.knowledge.organizedSociety = true;
    else if (key === "directed adaptation") { dms.story.knowledge.adaptationDiscovered = true; dms.story.knownPaths = Object.keys(STORY_DEVELOPMENT_PATHS); }
    else if (key === "dominion") for (const field of Object.keys(dms.story.knowledge.dominion)) dms.story.knowledge.dominion[field] = true;
    else if (dominionFields[key]) dms.story.knowledge.dominion[dominionFields[key]] = true;
    else throw new Error("Story knowledge must identify organized society, Dominion, a Dominion fact, or directed adaptation.");
    if (clean(details)) dms.story.milestones[`knowledge:${key}`] = clean(details); markStateChanged(dms); updateQuests(dms); return dms.story.knowledge;
  }
  function selectDevelopmentPath(dms, path) {
    const key = Object.keys(STORY_DEVELOPMENT_PATHS).find(candidate => candidate === clean(path).toLowerCase() || STORY_DEVELOPMENT_PATHS[candidate].name.toLowerCase() === clean(path).toLowerCase());
    if (!key) throw new Error(`Development Path must be ${Object.values(STORY_DEVELOPMENT_PATHS).map(item => item.name).join(", ")}.`);
    if (!dms.story.knowledge.adaptationDiscovered) throw new Error("Directed Dungeon adaptation has not yet been discovered.");
    if (dms.story.pathCommitted) throw new Error("The crystallized Dungeon doctrine cannot be changed through ordinary path selection.");
    dms.story.selectedPath = key; markStateChanged(dms); updateQuests(dms); record(dms, `${STORY_DEVELOPMENT_PATHS[key].name} selected as the emerging Dungeon development approach.`); return STORY_DEVELOPMENT_PATHS[key];
  }
  function recordStoryMilestone(dms, key, details = true) { dms.story.milestones[clean(key)] = details; markStateChanged(dms); updateQuests(dms); return dms.story.milestones[clean(key)]; }
  function commitDevelopmentPath(dms) {
    if (!dms.story.selectedPath) throw new Error("Select an emerging Development Path first.");
    const branchId = `story-path-${dms.story.selectedPath}-1`; if (dms.quests.records[branchId]?.status !== "cleared") throw new Error("Complete the selected Tier 3 path trial before crystallizing its doctrine.");
    dms.story.pathCommitted = true; dms.story.milestones.doctrine = STORY_DEVELOPMENT_PATHS[dms.story.selectedPath].doctrine; markStateChanged(dms); updateQuests(dms); return STORY_DEVELOPMENT_PATHS[dms.story.selectedPath];
  }
  ...
  function storyMapStatus(dms) {
    const storyQuests = Object.values(dms.quests.records).filter(quest => quest.category === "Story"), completed = storyQuests.filter(quest => quest.status === "cleared").map(quest => quest.title), current = storyQuests.filter(quest => quest.status === "active").map(quest => quest.title);
    const currentQuest = storyQuests.find(quest => quest.status === "active"), upcoming = currentQuest ? storyQuests.filter(quest => quest.status === "locked" && !quest.hiddenUntilActive && (quest.prerequisites || []).includes(currentQuest.id)).filter(quest => !quest.id.startsWith("story-path-") || dms.story.knownPaths.includes(quest.id.replace(/^story-path-/, "").replace(/-1$/, ""))).map(quest => quest.title) : [];
    const lines = [`Completed: ${completed.join("; ") || "None"}`, `Current: ${current.join("; ") || "None"}`, `Known Upcoming: ${upcoming.join("; ") || "Unknown"}`, `Future: ${dms.story.knowledge.adaptationDiscovered ? "Major Dungeon Adaptation" : "Unknown"}`];
    if (dms.story.knownPaths.length) lines.push(`Known Branches: ${dms.story.knownPaths.map(key => STORY_DEVELOPMENT_PATHS[key].name).join(", ")}`, `Selected Approach: ${dms.story.selectedPath ? STORY_DEVELOPMENT_PATHS[dms.story.selectedPath].name : "None"}${dms.story.pathCommitted ? " (Doctrine crystallized)" : ""}`);
    return lines.join("\n");
  }
  ...
  function scoutSector(dms, requestedName) {
    ...
    for (let index = 0; index < discoveries; index++) {
      ...
      const veinGrade = RESOURCE_GRADES[Math.min(RESOURCE_GRADES.length - 1, Math.floor(Math.max(0, threat - 1) / 25))];
      const vein = { id: veinId, sectorId: id, resourceKey: resource.key, name: `${resource.name} Site`, grade: veinGrade.name, richness: 1 + stableNumber(`${seed}|richness|${index}`) % 5, remaining: 100 + stableNumber(`${seed}|remaining|${index}`) % 401, status: "Discovered" };
  ...
  function targetVein(dms, roomId, veinId) {
    ...
    const veinGrade = gradeDefinition(vein.grade || "Basic"); if (room.tier < veinGrade.tier) throw new Error(`${veinGrade.name} ${vein.name} requires a Tier ${veinGrade.tier} extraction facility.`);
    ...
    const limit = Math.max(1, (ROOM_DEFINITIONS[room.definition].veinTargets || 0) * room.tier);
  ...
  function cancelTask(dms, taskId) {
    const task = dms.tasks.find(candidate => candidate.id === clean(taskId)); if (!task) throw new Error("Unknown active task.");
    const room = dms.rooms[task.roomId];
    if (task.type === "build-room" && room) delete dms.rooms[room.id];
    else if (["upgrade-room", "expand-room"].includes(task.type) && room) room.state = "Active";
    if (task.reservationId && dms.reservations[task.reservationId]) returnReservation(dms, task.reservationId);
    dms.tasks = dms.tasks.filter(candidate => candidate.id !== task.id); applyDerivedState(dms); updateQuests(dms); record(dms, `Cancelled ${task.id}; reserved resources were returned.`); return task;
  }
  function resolveCycle(dms) {
    const report = { dungeonResources: {}, lustriaResources: {}, upkeep: 0 };
    const completedTasks = [];
    for (const task of dms.tasks) { task.remaining -= 1; if (task.remaining > 0) continue; const room = dms.rooms[task.roomId]; if (task.type === "build-room" && room) { room.state = "Active"; if (dms.dungeon.tier >= 1) { tierOneMilestone(dms, `completedConstruction.${room.definition}`, true); if (["general-skill-hall", "general-trait-archive"].includes(room.definition)) tierOneMilestone(dms, "shopFacilityBuilt", true); } } else if (task.type === "upgrade-room" && room) { room.tier = task.targetTier; room.state = "Active"; room.lore = roomLore(dms, ROOM_DEFINITIONS[room.definition], room.tier); if (dms.dungeon.tier >= 1) tierOneMilestone(dms, "tieredFacility", room.id); } else if (task.type === "expand-room" && room) { room.expansion = task.targetExpansion; room.state = "Active"; if (dms.dungeon.tier >= 1) tierOneMilestone(dms, "expandedFacility", room.id); } else if (task.type === "custom-research") dms.shops.research[task.definition] = { theme: task.theme, completedAt: dms.activity.cycle + 1 }; else if (task.type === "craft-equipment") finalizeEquipmentTask(dms, task); if (task.reservationId && dms.reservations[task.reservationId]) commitReservation(dms, task.reservationId); completedTasks.push(task.id); }
    ...
    for (const room of Object.values(dms.rooms)) {
      ...
      const administrator = dms.administrators[room.assignedAdministrator], administratorEffect = administratorAssignmentEffectiveness(dms, administrator);
      if (definition.resource) {
        const operators = definition.uniqueWorker ? (assigned > 0 ? 1 : 0) : assigned;
        const cohortEffect = workerEfficiency(dms, room.id), amount = Number((operators * definition.baseProduction * room.tier * multiplier * administratorEffect * cohortEffect).toFixed(2));
        const output = definition.resource === "energy" ? amount : { amount, grade: gradeForTier(room.tier).name };
        const changes = rewardResources(dms, { [definition.resource]: output }, `production:${room.id}`), produced = Math.max(0, Number(changes[definition.resource]?.delta) || 0); report.dungeonResources[definition.resource] = (report.dungeonResources[definition.resource] || 0) + produced; if (produced > 0 && dms.dungeon.tier >= 1) { tierOneMilestone(dms, `produced.${definition.resource}`, produced); if (administrator) tierOneMilestone(dms, "administratorProductionObserved", true); }
      }
      if (definition.extraction && assigned > 0) for (const veinId of room.targetedVeins) {
        ...
        const resource = LUSTRIAN_RESOURCES.find(item => item.key === vein.resourceKey); transactInventory(dms, { [resource.name]: { amount, grade: vein.grade || "Basic" } }, `extraction:${room.id}:${vein.id}`); report.lustriaResources[resource.name] = (report.lustriaResources[resource.name] || 0) + amount;
      }
    }
    report.workerRecovery = {}; for (const cohort of dms.population.workers.cohorts) { const before = cohort.disruption; cohort.disruption = Math.max(0, Number((cohort.disruption - cohort.recoveryRate).toFixed(2))); if (cohort.disruption !== before) report.workerRecovery[cohort.id] = before - cohort.disruption; }
    const upkeepReduction = Math.min(0.75, Object.values(dms.rooms).filter(room => room.state === "Active").reduce((sum, room) => sum + (ROOM_DEFINITIONS[room.definition]?.upkeepReduction || 0) * room.tier, 0));
  ...
  function naturalSystemCommand(words) {
    ...
    const queries = [
      ...
      [/^(?:show\s+)?(?:my\s+|thronebound\s+)?class\s+previews?$/i, "class previews thronebound"], [/^(?:show\s+)?(?:my\s+|thronebound\s+)?(?:abilities|skills\s+and\s+traits|class\s+lineage)$/i, "abilities thronebound"],
      [/^(?:explain|show|how\s+do)\s+(?:facility\s+)?tier(?:\s+ups?)?(?:\s+work)?$/i, "facility tiers"], [/^(?:explain|show)\s+(?:administrator\s+)?rank(?:\s+and|\s+versus|\s+vs\.?)\s+level$/i, "administrator development"], [/^(?:explain|show|how\s+do)\s+(?:ability\s+)?mastery\s+and\s+grades?(?:\s+work)?$/i, "ability grades"]
    ];
    ...
    if ((match = request.match(/^(?:begin|enter|start)\s+(construction|production|administration|training)\s+(?:activity|work)(?:\s+(?:with|for|on|targeting)\s+(.+))?$/i))) return `mode ${title(match[1])}|${match[2] || ""}|${/^(?:construction|production)$/i.test(match[1]) ? "Standard" : /^training$/i.test(match[1]) ? "Slow" : "Standard"}`;
    ...
    if ((match = request.match(/^expand\s+(.+)$/i))) return `room expand ${match[1]}`;
    if ((match = request.match(/^(?:tier\s+up|upgrade)\s+(?:the\s+)?(.+?)(?:\s+facility)?$/i)) && !/^dungeon$/i.test(match[1])) return `room upgrade ${match[1]}`;
    ...
    if ((match = request.match(/^assign\s+(?!a\s+private\s+suite\b)(?!.*\s+to\s+detainment\b)(.+?)\s+to\s+(.+)$/i))) return `administrator assign ${match[1]}|${match[2]}`;
    if ((match = request.match(/^(?:regenerate|refresh)\s+(?:my\s+|the\s+)?class\s+previews?$/i))) return "class regenerate thronebound";
    if ((match = request.match(/^accept\s+(?:my\s+)?class\s+(?:option\s+)?(?:number\s+)?(one|two|three|[1-3])$/i))) return `class accept thronebound|${({ one: 1, two: 2, three: 3 }[match[1].toLowerCase()] || match[1])}`;
    if ((match = request.match(/^(?:select|choose|adopt)\s+(?:the\s+)?(.+?)\s+(?:development\s+)?(?:path|approach)$/i))) return `story path ${match[1]}`;
    if ((match = request.match(/^buy\s+(?:general\s+)?(skill|trait)\s+(?:option\s+)?(?:number\s+)?(one|two|three|[1-3])(?:\s+for\s+(.+))?$/i))) return `shop buy general|${match[3] || "thronebound"}|${match[1].toLowerCase()}|1|${({ one: 1, two: 2, three: 3 }[match[2].toLowerCase()] || match[2])}`;
    if ((match = request.match(/^(?:begin|enter|start)\s+bond\s+(?:activity\s+)?with\s+(.+)$/i))) return `bond begin ${match[1]}`;
    if ((match = request.match(/^assign\s+(?:a\s+)?private\s+suite\s+to\s+(.+)$/i))) return `residence assign ${match[1]}|Administrator Quarters`;
    if ((match = request.match(/^name\s+(.+?)(?:'s|’s)\s+(?:suite|residence)\s+(.+?)(?:\s+with\s+(bond|efficiency)\s+specialization)?$/i))) return `residence name ${match[1]}|${match[2]}|${match[3] || "Bond"}`;
    if ((match = request.match(/^invite\s+(.+?)\s+to\s+stay\s+in\s+(.+)$/i))) return `residence stay ${match[1]}|${match[2]}`;
    if ((match = request.match(/^assign\s+(.+?)\s+to\s+detainment\s+in\s+(.+)$/i))) return `residence detain ${match[1]}|${match[2]}`;
    return "";
  }
  function narrativeManagementCommand(words) {
    let phrase = spokenSystemPhrase(words);
    if (!phrase || /\bsystem\b/i.test(phrase) || /^(?:do|can|could|should|would|what|which|how|why)\b/i.test(phrase) || /\b(?:do not|don't|cannot|can't|won't|wouldn't)\b/i.test(phrase)) return "";
    phrase = phrase.replace(/^(?:i|we)\s+(?:(?:order|instruct|command)\s+(?:the\s+)?(?:dungeon|workers|staff|manager|administrator)?\s*to\s+|(?:begin|start|attempt|try)\s+to\s+|will\s+)?/i, "").trim();
    let match;
    if ((match = phrase.match(/^(?:build|construct)\s+(?:the\s+)?(.+)$/i))) return `room build ${match[1]}`;
    if ((match = phrase.match(/^expand\s+(?:the\s+)?(.+)$/i))) return `room expand ${match[1]}`;
    if ((match = phrase.match(/^(?:tier\s+up|upgrade)\s+(?:the\s+)?(.+?)(?:\s+facility)?$/i)) && !/^dungeon$/i.test(match[1])) return `room upgrade ${match[1]}`;
    if (/^(?:upgrade|advance|awaken)\s+(?:the\s+)?dungeon(?:\s+to\s+tier\s+\d+)?$/i.test(phrase)) return "dungeon upgrade";
    if ((match = phrase.match(/^(?:buy|purchase)\s+(?:general\s+)?(skill|trait)\s+(?:option\s+)?(?:number\s+)?(one|two|three|[1-3])(?:\s+for\s+(.+))?$/i))) return `shop buy general|${match[3] || "thronebound"}|${match[1].toLowerCase()}|1|${({ one: 1, two: 2, three: 3 }[match[2].toLowerCase()] || match[2])}`;
    return "";
  }
  ...
  function formatQuestNotifications(dms, notifications = dms.quests.notifications || []) {
    return notifications.map(notification => {
      ...
      if (notification.type === "active") return `A new directive crystallizes within the Throne.\n\n**New Quest — ${renderQuestText(dms, quest, notification.title)}**\n${renderQuestText(dms, quest, quest?.objective || "Review the active Quest card for its current objective.")}`;
      if (notification.type === "progress") return `The directive changes as one condition settles into place.\n\n**Quest Progress — ${renderQuestText(dms, quest, notification.title)}**\nNext Stage: ${renderQuestText(dms, quest, notification.stageTitle || "Continue the active objective")}`;
      ...
      return `${renderQuestText(dms, quest, notification.text || defaultQuestCompletionText(quest || notification))}\n\n**Quest Complete — ${renderQuestText(dms, quest, notification.title)}**\nReward: ${questRewardSummary(notification.rewards)}${next ? `\nNext Quest: ${renderQuestText(dms, next, next.title)}` : ""}`;
    }).join("\n\n");
  }
  ...
  function questCardEntry(dms, quest) {
    const keyTerms = formatTriggerGroups(quest.triggerGroups), progress = quest.stages?.length ? `${Math.min(quest.progress?.stage || 0, quest.stages.length)}/${quest.stages.length} stages` : quest.reportRequired && quest.fieldComplete && !quest.reported ? "Field objective complete; report to the Guild" : quest.status === "cleared" ? "Complete" : "Current objective active", rendered = value => renderQuestText(dms, quest, value);
    if (quest.category === "Tutorial") return `${rendered(quest.title)}\nCategory: Tutorial\nChain: ${quest.chain}${quest.step ? `, Step ${quest.step}` : ""}\nTier: ${quest.tier}\nStatus: ${title(quest.status)}\n\nPurpose\n${rendered(quest.description || quest.objective)}\n\nHow to Use\n${(quest.hints || []).map(rendered).join(" ") || "Use the named System concept naturally; no exact sentence is required."}\n\nRequirements\n${questConditionsText(dms, quest)}\n\nKey Terms\n${keyTerms || "No language trigger; completion is measured from authoritative state."}\n\nWhy It Matters\n${rendered(quest.description || "This lesson establishes a reusable Dungeon function.")}\n\nObjective\n${rendered(quest.objective)}\n\nProgress\n${progress}\n\nRewards\n${questRewardSummary(quest.rewards)}`;
    return `${rendered(quest.title)}\nCategory: ${quest.category}\nChain: ${quest.chain}${quest.step ? `, Step ${quest.step}` : ""}\nMission Type: ${quest.missionType}\nTier: ${quest.tier}\nStatus: ${title(quest.status)}\n\nBrief\n${rendered(quest.description || quest.objective)}\n\nObjective\n${rendered(quest.objective)}\n\nRelevant Context\n${questConditionsText(dms, quest)}\n\nKey Terms\n${keyTerms || "None; authoritative state determines completion."}\n\nProgress\n${progress}\n\nRewards\n${questRewardSummary(quest.rewards)}`;
  }
  function questCategoryRelevant(dms, category) {
    ...
    if (category === "Bond") return dms.dungeon.tier >= 1 && Object.keys(dms.administrators).length > 0;
  ...
  function tutorialGuidance(dms) {
    const relevant = new Set(dms.dungeon.tier >= 1 ? ["Story", "Dungeon", "Thronebound", "Tutorial", "Bond"] : ["Story", "Tutorial"]), byChain = new Map();
    for (const quest of Object.values(dms.quests.records).filter(quest => relevant.has(quest.category) && quest.status === "active" && Number(quest.tier || 0) <= dms.dungeon.tier).sort((a, b) => Number(a.tier || 0) - Number(b.tier || 0) || Number(a.step || 0) - Number(b.step || 0))) if (!byChain.has(quest.chain)) byChain.set(quest.chain, quest);
    const lessons = [...byChain.values()];
  ...
  function systemConceptAvailable(dms, concept) {
    if (!concept || concept.tier > dms.dungeon.tier) return false;
    if (concept.id === "production") return Object.values(dms.rooms).some(room => ROOM_DEFINITIONS[room.definition]?.resource);
    if (concept.id === "population") return dms.population.workers.cohorts.length > 0 || dms.population.soldiers.cohorts.length > 0;
    if (concept.id === "residences") return Object.values(dms.rooms).some(room => ["worker-habitat", "administrator-quarters", "thronebound-private-chamber"].includes(room.definition));
    if (concept.id === "skills-traits") return dms.thronebound.class.tier > 0;
    if (concept.id === "bond") return dms.dungeon.tier >= 1 && Object.keys(dms.administrators).length > 0;
    if (concept.id === "tasks") return dms.tasks.length > 0;
    if (concept.id === "summoning") {
      if (Object.keys(dms.administrators).length >= dms.dungeon.administratorCapacity) return false;
      if (!Object.values(dms.administrators).some(administrator => administrator.role === "Manager")) return true;
      return administratorRoles(dms).some(role => role !== "Manager");
    }
    if (concept.id === "portal-anchors") return Object.keys(dms.portals.anchors).length > 0;
    if (concept.id === "discoveries") return Object.keys(dms.world.lustria.sectors).length > 0;
    return true;
  }
  function systemHelp(dms) {
    const concepts = SYSTEM_CONCEPTS.filter(concept => systemConceptAvailable(dms, concept));
    const manager = Object.values(dms.administrators).find(administrator => administrator.role === "Manager"), activeFunctions = Object.values(dms.rooms).some(room => room.state === "Active" && room.definition !== "throne-room"), openAdministratorSlot = Object.keys(dms.administrators).length < dms.dungeon.administratorCapacity;
    const management = [dms.dungeon.tier >= 1 ? "construct or develop a visible facility" : "review the awakening requirements", !manager ? "summon the Manager" : openAdministratorSlot && activeFunctions ? "summon an Administrator for an active function" : "", dms.dungeon.tier >= 1 && activeFunctions ? "assign an Administrator to a compatible active facility" : "", dms.dungeon.tier >= 1 && dms.thronebound.class.tier === 0 ? "review or accept an initial Class" : "", Object.values(dms.rooms).some(room => ["general-skill-hall", "general-trait-archive"].includes(room.definition) && room.state === "Active") ? "purchase a visible fixed-price shop entry" : "", dms.dungeon.tier < VERIFIED_DUNGEON_TIER ? "awaken the next verified Tier when its requirements are complete" : ""].filter(Boolean);
    return [
      ...
      `Available concepts: ${concepts.map(concept => `\"${concept.id.split("-").map(title).join(" ")}\"`).join(", ")}.`,
      `Current management operations: ${management.join(", ") || "none"}. Options outside current Tier, story relevance, or generated state are omitted.`,
  ...
  function applyActivityTurn(dms, inputText, actionCount = 0) {
    ...
    if (natural) {
      ...
      } catch (error) { benefit.system = `Action not performed: ${error.message} No task began, no resources were spent, and authoritative state is unchanged.`; }
      dms.activity.lastSystemOutput = benefit.system; benefit.note = benefit.system; return benefit;
    }
    const narrativeManagement = narrativeManagementCommand(words);
    if (narrativeManagement) {
      let resolution;
    ...
    if (/\b(?:report|turn\s+in|submit|claim)\b/i.test(words) && /\b(?:guild|bounty|contract|quest)\b/i.test(words)) {
      try {
        const reportable = Object.values(dms.quests.records).filter(quest => quest.status === "active" && quest.reportRequired && quest.fieldComplete), named = reportable.find(quest => words.toLowerCase().includes(quest.title.toLowerCase()) || words.toLowerCase().includes(quest.id.toLowerCase())), result = reportQuest(dms, named?.id || "");
        benefit.reportedQuest = result.quest.id; benefit.note = `${result.quest.title} was formally reported to the Guild. Its rewards are now issued.${result.followup ? ` A confirmed lead opened ${result.followup.title}.` : ""}`;
      } catch (error) { benefit.note = `The Guild report cannot be accepted: ${error.message}`; }
    }
    if (dms.quests.records["story-first-contact-1"]?.status === "active" && dms.activity.location.major === "Dungeon" && /\b(?:leave|exit|depart|cross|step|walk|go|venture)\b/i.test(words) && /\b(?:dungeon|threshold|entrance|outside|exterior|gate)\b/i.test(words)) { beginDungeonExterior(dms); benefit.story = "dungeon-exterior-entered"; benefit.note = "The unresolved Dungeon Sector now exists. No environmental facts were recorded from the quest-triggering output."; }
    if (dms.story.dungeonSector.exteriorEntered && dms.activity.location.major === "Lustria" && ["Travel", "Survey", "Exploration"].includes(dms.activity.mode) && /\b(?:travel|walk|move|circle|range|explore|survey|follow|continue|advance)\b/i.test(words)) addDungeonSectorTravelContext(dms);
    if (dms.quests.records["story-first-contact-2"]?.status === "active" && dms.activity.location.major === "Lustria" && /\b(?:investigate|examine|inspect|study|search|explore)\b/i.test(words) && /\b(?:site|place|location|landmark|structure|ruin|trail|vicinity|area|point|feature)\b/i.test(words)) {
    ...
    if (dms.activity.mode === "Bond" && dms.activity.targets[0]) {
      const administrator = resolveCharacter(dms, dms.activity.targets[0]);
      if (administrator?.id && /\b(?:confide|promise|reveal|share|resolve|complete|face|accept)\b/i.test(words) && administrator.bond.value >= currentBondThreshold(administrator) && !administrator.bond.completedEvents.includes(currentBondThreshold(administrator))) {
        try { completeBondEvent(dms, administrator.id); benefit.bond = administrator.bond.value; benefit.note = `${administrator.name}'s ${administrator.bond.value}% Bond Event was completed through the scene.`; } catch (error) { benefit.note = `The Bond Event remains gated: ${error.message}`; }
      } else if (administrator?.id && /\b(?:talk|speak|listen|spend|share|comfort|support|learn|rest|dine|walk|train|work|help|meet|visit)\b/i.test(words)) {
        const bond = addAdministratorBond(dms, administrator.id, 2); benefit.bond = bond.value; benefit.note = `${administrator.name}'s Bond reached ${bond.value}%; meaningful progress stops at each unresolved 5% Bond Event.`;
      }
    }
  ...
  function configureAptitude(dms, attributeName, aptitude) {
    if (dms.initialized && !systemAvailable(dms)) throw new Error("Established Aptitudes can only be changed in System Mode within the Throne Room.");
    aptitude = clean(aptitude).toUpperCase(); if (!APTITUDE_OUTCOMES[aptitude]) throw new Error(`Aptitude must be ${Object.keys(APTITUDE_OUTCOMES).join(", ")}.`);
    const attribute = [...Object.values(dms.thronebound.attributes.combat), ...Object.values(dms.thronebound.attributes.support)].find((value, index) => aptitudeNames(dms)[index].toLowerCase() === clean(attributeName).toLowerCase());
    if (!attribute) throw new Error("Unknown Thronebound Attribute."); attribute.aptitude = aptitude; const canonicalName = aptitudeNames(dms).find(name => name.toLowerCase() === clean(attributeName).toLowerCase()); dms.onboarding.aptitudesDefined = unique([...dms.onboarding.aptitudesDefined, canonicalName]); dms.initialized = identityReady(dms); updateQuests(dms); record(dms, `Configured ${canonicalName} Aptitude ${aptitude}.`); return attribute;
  }
  function configureGrowthPreferences(dms, attributes) {
    if (dms.initialized && !systemAvailable(dms)) throw new Error("Established Growth Preferences can only be changed in System Mode within the Throne Room.");
    dms.thronebound.growthPreferences = parseGrowthPreferences(Array.isArray(attributes) ? attributes.join(",") : attributes, dms);
    dms.initialized = identityReady(dms); updateQuests(dms); record(dms, `Configured Growth Preferences: ${dms.thronebound.growthPreferences.join(", ")}.`); return dms.thronebound.growthPreferences;
  }
  ...
  function awardQuest(dms, quest) {
    ...
    if (Number(rewards.marks || 0)) transactMarks(dms, Number(rewards.marks), `quest:${quest.title}`);
    const levels = [];
  ...
  function questReferenceByRole(dms, quest, role) {
    const reference = (quest?.references || []).find(candidate => clean(candidate.role).toLowerCase() === clean(role).toLowerCase());
    return reference ? questReference(dms, reference) : { known: false };
  }
  function questTokenValue(dms, quest, typeName, key) {
    typeName = clean(typeName).toLowerCase(); key = clean(key);
    if (typeName === "room" || typeName === "job" || typeName === "system") {
      const definitionKey = roomDefinitionKey(key), definition = ROOM_DEFINITIONS[definitionKey]; if (!definition) return "";
      const room = Object.values(dms.rooms).find(candidate => candidate.definition === definitionKey), manifested = room || manifestedRoomIdentity(dms, definitionKey);
      if (typeName === "room") return manifested.name;
      if (typeName === "job") return room?.jobName || manifested.jobName;
      return definition.name;
    }
    if (typeName === "resource") return dms.dungeon.resources[key.toLowerCase()]?.name || "";
    if (typeName === "administrator") {
      const roleReference = (quest?.references || []).find(reference => clean(reference.role).toLowerCase() === key.toLowerCase() && clean(reference.type).toLowerCase() === "administrator"), administrator = roleReference ? dms.administrators[clean(roleReference.id)] : key.toLowerCase() === "manager" ? Object.values(dms.administrators).find(candidate => candidate.role === "Manager") : dms.administrators[key] || Object.values(dms.administrators).find(candidate => candidate.name.toLowerCase() === key.toLowerCase());
      return administrator?.name || (key.toLowerCase() === "manager" ? "the Manager" : "");
    }
    if (["reference", "sector", "site"].includes(typeName)) {
      const resolved = questReferenceByRole(dms, quest, key); return resolved.known ? resolved.label : "";
    }
    return "";
  }
  function renderQuestText(dms, quest, value) {
    return clean(value).replace(/\{(room|job|system|resource|administrator|reference|sector|site):([^}]+)\}/gi, (token, typeName, key) => {
  ...
  function validateQuestTemplate(dms, quest) {
    ...
    for (const [, typeName, key] of tokens) {
    ...
    if (quest.strictTemplate && quest.category !== "Tutorial") {
      ...
      const bannedManifestation = /\b(?:workers?|soldiers?|maids?|servants?|guards?|researchers?|miners?|farmers?|smiths?)\b/i.exec(tokenless);
      if (bannedManifestation) throw new Error(`Quest ${quest.id} uses unmanifested population vocabulary: ${bannedManifestation[0]}.`);
      for (const [definitionKey, definition] of Object.entries(ROOM_DEFINITIONS)) if (definitionKey !== "throne-room" && new RegExp(`\\b${definition.name.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")}\\b`, "i").test(tokenless)) throw new Error(`Quest ${quest.id} must reference the ${definition.name} function through a presentation token.`);
    }
  ...
  function processQuestAction(dms, inputText, context = {}) {
    const progressed = [], completed = [], awaitingReport = [];
    for (const quest of Object.values(dms.quests.records)) {
      ...
      if (context.outcome) recordQuestOutcome(dms, quest.id, context.outcome);
      if (quest.reportRequired) {
        quest.fieldComplete = true; markStateChanged(dms); queueQuestNotification(dms, "progress", quest, { stageTitle: "Return to the Guild and report the completed field objective" }); awaitingReport.push(quest.id);
      } else { completeQuest(dms, quest.id); completed.push(quest.id); }
    }
    return { progressed, completed, awaitingReport };
  }
  function createQuest(dms, category, titleText, objective, rewards = {}, prerequisites = [], details = {}) {
    ...
    validateQuestTemplate(dms, quest);
  ...
  function recordQuestOutcome(dms, questId, outcome) {
    const quest = dms.quests.records[clean(questId)]; if (!quest) throw new Error("Unknown Quest.");
    const source = outcome && typeof outcome === "object" ? outcome : { kind: outcome }, kind = clean(source.kind).toLowerCase();
    if (!kind) throw new Error("A Quest outcome requires a kind.");
    let reference = null;
    if (source.reference) { reference = { ...source.reference }; if (!questReference(dms, reference).known) throw new Error("A Quest outcome may only identify a reference already established as adventure canon."); }
    quest.outcome = { kind, reference }; markStateChanged(dms); return quest.outcome;
  }
  function createOutcomeFollowup(dms, quest) {
    if (quest.followupQuestId || quest.outcome?.kind !== "monster" || !(quest.category === "Bounty" || ["Hunt", "Bounty"].includes(quest.missionType))) return null;
    const target = quest.outcome.reference || (quest.references || []).find(reference => clean(reference.role).toLowerCase() === "target");
    if (!target || !questReference(dms, target).known) return null;
    const followup = createQuest(dms, quest.category, `${quest.chain || quest.title} — Hunt`, "Track and defeat {reference:target}, preserve credible proof, then return to the Guild to report.", { experience: 75 * Math.max(1, quest.tier), marks: 20 * Math.max(1, quest.tier) }, [quest.id], {
      chain: quest.chain || quest.title, step: Number(quest.step || 0) + 1, scope: "External", strictTemplate: true, missionType: "Hunt", reportRequired: true, reportLocation: quest.reportLocation || "Guild", references: [{ ...target, role: "target" }], description: "The investigation established a specific monster target. This Hunt is a new contract stage, not an assumed outcome of unrelated exploration or escort work.", triggerGroups: [{ any: ["hunt", "track", "slay", "defeat"] }]
    });
    quest.followupQuestId = followup.id; markStateChanged(dms); return followup;
  }
  function completeQuest(dms, questId, options = {}) {
    const quest = dms.quests.records[clean(questId)]; if (!quest) throw new Error("Unknown Quest.");
    if (!questPrerequisitesMet(dms, quest)) throw new Error("Quest prerequisites are not cleared.");
    if (quest.status !== "active") throw new Error("Unknown or inactive Quest.");
    if (quest.reportRequired && !(quest.fieldComplete && (options.reported || quest.reported))) throw new Error("This Guild contract must be completed in the field and reported to the Guild before rewards are issued.");
    if (options.reported) quest.reported = true;
    const transition = transitionQuest(dms, quest, "cleared");
    for (const candidate of Object.values(dms.quests.records)) if (candidate.status === "locked" && questPrerequisitesMet(dms, candidate) && Number(candidate.tier || 0) <= dms.dungeon.tier) transitionQuest(dms, candidate, "active");
    const followup = createOutcomeFollowup(dms, quest); record(dms, `Completed ${quest.category || "Dungeon"} Quest: ${quest.title}.`); return { quest, levels: transition.levels, followup };
  }
  function reportQuest(dms, questReferenceText) {
    const requested = clean(questReferenceText).toLowerCase(), candidates = Object.values(dms.quests.records).filter(quest => quest.status === "active" && quest.reportRequired && quest.fieldComplete && (!requested || quest.id.toLowerCase() === requested || quest.title.toLowerCase().includes(requested)));
    if (candidates.length !== 1) throw new Error(candidates.length ? "Specify which completed Guild contract is being reported." : "No completed field objective is ready to report.");
    const quest = candidates[0], secondary = clean(dms.activity.location.secondary).toLowerCase(), expected = clean(quest.reportLocation || "Guild").toLowerCase();
    if (dms.activity.location.major !== "Lustria" || !(secondary.includes("guild") || (expected && secondary.includes(expected)))) throw new Error(`Report this contract in Lustria at ${quest.reportLocation || "a Guild location"}.`);
    return completeQuest(dms, quest.id, { reported: true });
  }
  ...
  function upgradeSkillGrade(dms, target, skillName) {
    ...
    const next = CLASS_GRADES.find(entry => entry.grade === skill.grade + 1); if (!next) throw new Error("Ability is already at Mastery Grade."); if (dms.dungeon.tier < next.tier) throw new Error(`${next.name} Grade requires Dungeon Tier ${next.tier}.`); if (next.name === "Mastery" && !Object.values(dms.rooms).some(room => room.state === "Active" && ROOM_DEFINITIONS[room.definition]?.masteryGate)) throw new Error("Mastery Grade requires an active Architect Apotheosis Core."); spend(dms, { development: 25 * next.tier, energy: 20 * next.tier }); skill.grade = next.grade; skill.gradeName = next.name; skill.tier = next.tier; skill.mastery = 0; return skill;
  }
  ...
  function shopDefinition(kind, custom = false) { return custom ? (kind === "skill" ? "custom-skill-studio" : "custom-trait-atelier") : (kind === "skill" ? "general-skill-hall" : "general-trait-archive"); }
  function shopDiscount(dms) { return Math.min(0.5, Object.values(dms.rooms).filter(room => room.state === "Active").reduce((sum, room) => sum + (ROOM_DEFINITIONS[room.definition]?.skillDiscount || 0) * room.tier, 0)); }
  function shopOptions(dms, target = "thronebound", kind = "skill", tier = 1, custom = false) {
    kind = clean(kind).toLowerCase(); tier = clamp(Math.floor(tier), 1, 10);
    const character = resolveCharacter(dms, target); if (!character) return { visible: false, reason: "Unknown linked character.", options: [] };
    const definitionKey = shopDefinition(kind, custom), facility = Object.values(dms.rooms).find(room => room.definition === definitionKey && room.state === "Active");
    if (!facility || facility.tier < tier) return { visible: false, reason: `${ROOM_DEFINITIONS[definitionKey].name} is not active at Tier ${tier}.`, options: [], facility };
    const entries = custom ? dms.shops.custom[kind]?.entries : shopEntries(kind, tier), discount = shopDiscount(dms);
    if (!entries?.length) return { visible: false, reason: `The custom ${kind} shop has not been generated.`, options: [], facility };
    const options = entries.filter(entry => Number(entry.tier || tier) <= facility.tier).map((entry, index) => {
      const purchased = kind === "skill" ? hasNamed(character.class.skills, entry.name) : hasNamed(character.class.traits, entry.name), price = Math.max(1, Math.ceil(entry.cost * (1 - discount))), affordability = requirementBalance(dms, { development: price, energy: price });
      return { index: index + 1, entry, price, purchased, state: purchased ? "Purchased" : affordability.ready ? "Available" : "Requires Resources", actionable: !purchased && affordability.ready, affordability };
    });
    return { visible: true, character, facility, options };
  }
  function buyShopEntry(dms, target, kind, tier, entryNumber, custom = false) {
    ...
    tier = clamp(Math.floor(tier), 1, 10); const availability = shopOptions(dms, target, kind, tier, custom);
    if (!availability.visible) throw new Error(availability.reason);
    const option = availability.options[clamp(Math.floor(entryNumber), 1, availability.options.length) - 1]; if (!option) throw new Error("Unknown or unavailable shop entry.");
    if (option.purchased) throw new Error(`Duplicate ${title(kind)}: ${option.entry.name} is already purchased for ${availability.character.name}.`);
    if (!option.actionable) throw new Error(`${option.entry.name}: Insufficient resources: ${formatRequirements(option.affordability.missing)}.`);
    const character = availability.character, entry = option.entry, price = option.price;
    spend(dms, { development: price, energy: price });
    ...
    if (!custom && dms.dungeon.tier >= 1) tierOneMilestone(dms, "abilityPurchased", true);
    return entry;
  }
  ...
  function ensureFutureStoryTier(dms, tier) {
    if (tier < 4 || tier > 10) return [];
    const framework = STORY_TIER_FRAMEWORK[tier], previous = storyRequirementForTier(tier), entryId = `story-tier-${tier}-entry`, branchId = `story-tier-${tier}-branch-${dms.story.selectedPath || "unselected"}`, convergenceId = `story-tier-${tier}-convergence`, path = STORY_DEVELOPMENT_PATHS[dms.story.selectedPath];
    if (!dms.quests.records[entryId]) dms.quests.records[entryId] = normalizeQuestRecord(entryId, { category: "Story", chain: framework.chain, step: 1, tier, title: `${framework.chain} I — New Consequences`, objective: framework.purpose, prerequisites: previous ? [previous] : [], rewards: { experience: 100 * tier }, dynamic: true });
    if (path && !dms.quests.records[branchId]) dms.quests.records[branchId] = normalizeQuestRecord(branchId, { category: "Story", chain: `${framework.chain}: ${path.name}`, step: 2, tier, title: `${framework.chain} II — ${path.name}`, objective: `Resolve this Tier's Story problem through the established ${path.name} doctrine or deliberately create the evidence needed to revise it.`, prerequisites: [entryId], rewards: { experience: 125 * tier }, dynamic: true });
    if (!dms.quests.records[convergenceId]) dms.quests.records[convergenceId] = normalizeQuestRecord(convergenceId, { category: "Story", chain: framework.chain, step: 3, tier, title: `${framework.chain} III — Consequence`, objective: `Establish the lasting Tier ${tier} consequence and reconnect the selected branch to the shared Story spine.`, prerequisites: path ? [branchId] : [entryId], rewards: { experience: 150 * tier }, dynamic: true });
    return [entryId, ...(path ? [branchId] : []), convergenceId];
  }
  function updateStoryQuests(dms, options = {}) {
    const quests = dms.quests.records, intrusion = dms.story.intrusion, perimeterCount = dms.story.dungeonSector.observations.filter(observation => observation.phase === "Perimeter").length, dominionKnown = Object.values(dms.story.knowledge.dominion).every(Boolean);
    const ordered = [
      ["story-awakening-1", dms.dungeon.tier >= 1],
      ["story-first-contact-1", !!dms.story.dungeonSector.exteriorEntered && dms.activity.location.major !== "Dungeon"],
    ...
    if (dms.story.selectedPath) ordered.push([`story-path-${dms.story.selectedPath}-1`, !!dms.story.milestones[`path-trial:${dms.story.selectedPath}`]], ["story-dungeons-place-3", !!dms.story.pathCommitted]);
    for (const quest of Object.values(quests)) if (quest.category === "Story" && quest.status !== "cleared") quest.status = "locked";
    for (const [id, complete] of ordered) {
    ...
    if (dms.dungeon.tier >= 4 && dms.story.pathCommitted) {
      const ids = ensureFutureStoryTier(dms, dms.dungeon.tier);
      for (const id of ids) {
        const quest = quests[id]; if (!quest || quest.status === "cleared" || !questPrerequisitesMet(dms, quest)) continue;
        transitionQuest(dms, quest, "active", options);
        if (!dms.story.milestones[id]) return quest;
        transitionQuest(dms, quest, "cleared", options);
      }
    }
    return null;
  ...
  function updateQuests(dms, options = {}) {
    ...
    const gated = (id, complete) => {
      const quest = quests[id]; if (!quest || quest.status === "cleared") return;
      if (!questPrerequisitesMet(dms, quest) || Number(quest.tier || 0) > dms.dungeon.tier) { setStatus(id, "locked"); return; }
      if (quest.status === "locked") { setStatus(id, "active"); return; }
      if (quest.status === "active" && complete) setStatus(id, "cleared");
    };
    ...
    const tierOneCost = tierRules(1).upgradeCost, construction = dms.dungeon.resources.construction; syncResource(construction); syncResource(dms.dungeon.resources.energy);
    const tierOneReady = identityReady(dms) && capacityFilled && (construction.grades?.Basic || 0) >= tierOneCost.construction && dms.dungeon.resources.energy.amount >= tierOneCost.energy;
    updateStoryQuests(dms, options);
    gated("tutorial-system-status", !!dms.onboarding.statusRead);
    gated("tutorial-system-resources", !!dms.onboarding.resourcesRead);
    gated("tutorial-system-mode", !!dms.onboarding.systemEntered);
    gated("tutorial-system-manager", managerExists);
    gated("tutorial-system-tier-requirements", !!dms.onboarding.tierRequirementsRead);
    gated("tutorial-system-tier-up", dms.dungeon.tier >= 1);
    const tier1 = dms.milestones.tier1, activeRoom = definition => Object.values(dms.rooms).some(room => room.definition === definition && room.state === "Active"), tierTwoCost = tierRules(2).upgradeCost;
    const tierOneConditions = {
      "tier1-main-construction": tier1.produced.construction > 0,
      "tier1-main-sustenance": tier1.produced.sustenance > 0,
      "tier1-main-development": tier1.produced.development > 0,
      "tier1-main-energy": tier1.produced.energy > 0,
      "tier1-main-workers": !!tier1.stableWorkerSupport,
      "tier1-main-expansion": !!tier1.expandedFacility,
      "tier1-main-facility-tier": !!tier1.tieredFacility && !!tier1.tierRulesRead,
      "tier1-main-administrator": !!tier1.administratorAssigned && !!tier1.administratorProductionObserved,
      "thronebound-class-requirements": !!tier1.classAccepted || (dms.dungeon.tier >= 1 && dms.thronebound.class.tier === 0 && (dms.classPreviews.thronebound || []).length === 3 && (dms.dungeon.resources.development.grades?.Basic || 0) >= 20 && dms.dungeon.resources.energy.amount >= 15 && systemAvailable(dms)),
      "thronebound-class-previews": !!tier1.classPreviewsReviewed || !!tier1.classAccepted,
      "tier1-main-class": dms.thronebound.class.tier >= 1 && !!tier1.classAccepted,
      "tier1-main-reserve": Object.keys(dms.administrators).length >= 3 && (dms.dungeon.resources.construction.grades?.Basic || 0) >= tierTwoCost.construction && dms.dungeon.resources.energy.amount >= tierTwoCost.energy,
      "tutorial-economy-build-material": !!tier1.constructed["material-works"],
      "tutorial-economy-complete-material": activeRoom("material-works"),
      "tutorial-economy-observe-production": !!tier1.productionObserved && tier1.produced.construction > 0,
      "tutorial-economy-sustenance": activeRoom("sustenance-works") && activeRoom("worker-habitat"),
      "tutorial-economy-jobs": !!tier1.workerJobsRead,
      "tutorial-economy-expand": !!tier1.expandedFacility,
      "tutorial-economy-tier": !!tier1.tieredFacility && !!tier1.tierRulesRead,
      "tutorial-economy-administrator": !!tier1.administratorProductionObserved,
      "tutorial-class-previews": !!tier1.classPreviewsReviewed,
      "tutorial-class-adjust": !!tier1.classPreviewsRegenerated || !!tier1.classAccepted,
      "tutorial-class-accept": !!tier1.classAccepted && dms.thronebound.class.tier >= 1,
      "tutorial-class-abilities": !!tier1.abilitiesReviewed,
      "tutorial-class-shop": !!tier1.shopFacilityBuilt || activeRoom("general-skill-hall") || activeRoom("general-trait-archive"),
      "tutorial-class-buy": !!tier1.abilityPurchased,
      "tutorial-class-grade": !!tier1.masteryGradeRead,
      "tutorial-admin-summon": Object.keys(dms.administrators).length >= 2,
      "tutorial-admin-assign": !!tier1.administratorAssigned,
      "tutorial-admin-bond": !!tier1.bondGained,
      "tutorial-admin-threshold": !!tier1.bondThresholdReached,
      "tutorial-admin-event": !!tier1.bondEventCompleted,
      "tutorial-admin-rank-level": !!tier1.rankLevelRead
    };
    for (const [id, complete] of Object.entries(tierOneConditions)) gated(id, dms.dungeon.tier >= 1 && complete);
    setStatus("reach-lustria", dms.dungeon.tier < 2 ? "locked" : Object.keys(dms.world.lustria.sectors).length ? "cleared" : "active");
    for (const quest of Object.values(quests)) if (quest.category !== "Story" && quest.status === "locked" && Number(quest.tier || 0) <= dms.dungeon.tier && questPrerequisitesMet(dms, quest)) transitionQuest(dms, quest, "active", options);
  }

  function observeOnboarding(dms, key) { if (!dms.onboarding[key]) { dms.onboarding[key] = true; updateQuests(dms); markStateChanged(dms); } }
  function dungeonSignature(dms) {
    const seed = stableNumber(`${dms.dungeon.name}|${dms.dungeon.theme}|${dms.thronebound.name}`), attributeStrength = dungeonAttributeStrength(dms), strength = dms.dungeon.tier === 0 ? 0 : Math.max(1, dms.dungeon.tier * 10 + attributeStrength + seed % 10);
    return { state: dms.dungeon.tier === 0 ? "Nascent" : "Awakened", strength, externallyDetectable: dms.dungeon.tier >= 4, theme: dms.dungeon.theme };
  }
  function status(dms, observe = false) {
    if (observe) observeOnboarding(dms, "statusRead");
    ...
    return [
      ...
      `Growth Preferences: ${(dms.thronebound.growthPreferences || []).join(", ") || "Not defined"}`,
      `Workers: ${dms.population.workers.current} facility jobs | Soldiers: ${dms.population.soldiers.current}`,
      `Resources: ${RESOURCE_ROLES.map(role => `${dms.dungeon.resources[role].name} ${Number(syncResource(dms.dungeon.resources[role]).toFixed(2))}`).join(" | ")} | Marks ${dms.currencies.marks}`,
      `Tasks: ${dms.tasks.length} active | Reservations: ${Object.keys(dms.reservations).length}`,
      `Save Revision: ${dms.persistence.revision} | Cache Revision: ${dms.persistence.cacheRevision}`,
  ...
  function constructionOptionsStatus(dms) {
    const options = constructionOptions(dms);
    if (!options.length) return "No construction options are relevant at the current Dungeon Tier.";
    return options.map(option => {
      const requirements = option.affordability?.requirements || requirementBalance(dms, option.costs).requirements;
      return `${option.optionId} [${option.state}] ${option.identity.name} — System Function: ${option.definition.name} — Cost: ${formatRequirements(requirements)}${option.state === "Available" ? "" : ` — ${option.reason}`}`;
    }).join("\n");
  }
  function facilityDevelopmentStatus(dms, room) {
    if (room.definition === "throne-room") return "Tier follows the Dungeon; no independent construction action.";
    if (room.state !== "Active") return `No additional work may begin while ${room.state.toLowerCase()} is in progress.`;
    const definition = ROOM_DEFINITIONS[room.definition], actions = [];
    if (room.tier < dms.dungeon.roomTierLimit) {
      const next = room.tier + 1, cost = Math.max(20, definition.baseCost) * next, costs = { construction: cost, energy: Math.ceil(cost * 0.6) }, readiness = requirementBalance(dms, costs);
      actions.push(`Tier ${next} Upgrade [${readiness.ready ? "Available" : "Requires Resources"}] ${formatRequirements(readiness.requirements)}`);
    }
    const nextExpansion = (room.expansion || 1) + 1, expansionCost = Math.max(10, Math.ceil(definition.baseCost * nextExpansion * 0.75)), expansionCosts = { construction: expansionCost, energy: Math.ceil(expansionCost / 2) }, expansionReadiness = requirementBalance(dms, expansionCosts);
    actions.push(`Expansion ${nextExpansion} [${expansionReadiness.ready ? "Available" : "Requires Resources"}] ${formatRequirements(expansionReadiness.requirements)}`);
    return actions.join("; ");
  }
  function facilitiesStatus(dms) {
    const constructed = Object.values(dms.rooms).map(room => `${room.id} [${room.state}] ${room.name} — Tier ${room.tier}, Expansion ${room.expansion || 1}, Jobs ${room.jobPopulation}, Administrator ${dms.administrators[room.assignedAdministrator]?.name || "Unassigned"}\n  Development: ${facilityDevelopmentStatus(dms, room)}`).join("\n");
    return `Constructed Facilities\n${constructed || "None"}\n\nCurrent Construction Options\n${constructionOptionsStatus(dms)}`;
  }
  ...
  function classSelectionRequirementsStatus(dms) {
    const checks = [
      [dms.dungeon.tier >= 1, "Dungeon Tier 1"], [dms.thronebound.class.tier === 0, "Thronebound remains Classless"], [(dms.classPreviews.thronebound || []).length === 3, "three generated Class previews"], [systemAvailable(dms), "Timeless System Mode in the Throne Room"], [(dms.dungeon.resources.development.grades?.Basic || 0) >= 20, `20 Basic ${dms.dungeon.resources.development.name}`], [dms.dungeon.resources.energy.amount >= 15, `15 ${dms.dungeon.resources.energy.name}`]
    ];
    return `Initial Class Selection Requirements\n${checks.map(([ready, label]) => `${ready ? "Ready" : "Pending"}: ${label}`).join("\n")}\nAcceptance grants the selected Class, one Combat Skill, one Management Skill, one Trait, and the first permanent Class-lineage entry.`;
  }
  function evolutionStatus(dms) { const previews = dms.classPreviews.thronebound || []; if (dms.thronebound.class.tier === 0 && dms.dungeon.tier >= 1) return `${classSelectionRequirementsStatus(dms)}${previews.length ? `\n\n${classPreviewsStatus(dms, "thronebound", true)}` : ""}`; if (previews.length) return classPreviewsStatus(dms, "thronebound", true); return dms.dungeon.tier < 1 ? "Class Evolution is dormant. The Thronebound remains Classless until Dungeon Tier 1, when three Theme-derived branches become available." : "No pending Class previews. Generate or review the current Class Evolution options from the Throne Room; later evolutions also require the appropriate Class Evolution facility Tier."; }
  ...
  function questsStatus(dms) { const active = Object.entries(dms.quests.records).filter(([, quest]) => quest.status === "active").sort((left, right) => Number(left[1].tier || 0) - Number(right[1].tier || 0) || Number(left[1].step || 0) - Number(right[1].step || 0)); const lines = active.map(([id, quest]) => `${id} [${quest.category}] ${renderQuestText(dms, quest, quest.title)}: ${renderQuestText(dms, quest, quest.objective)}${quest.reportRequired && quest.fieldComplete ? " Field objective complete; report it at the Guild." : ""}${quest.triggerGroups?.length ? ` Key terms: ${formatTriggerGroups(quest.triggerGroups)}.` : ""}`); for (const category of QUEST_CATEGORIES) if (questCategoryRelevant(dms, category) && !active.some(([, quest]) => quest.category === category)) lines.push(`${category}: ${GENERIC_QUEST_STATUS[category].text}`); return lines.join("\n") || "No quest category is currently relevant."; }
  ...
  function abilitiesStatus(dms, target = "thronebound", observe = false) { const character = resolveCharacter(dms, target); if (!character) throw new Error("Unknown linked character."); if (observe && !character.id && dms.dungeon.tier >= 1) tierOneMilestone(dms, "abilitiesReviewed", true); return [`${character.name}: ${character.class.name}, Class Tier ${character.class.tier}`, `Lineage: ${character.class.lineage.map(item => `Tier ${item.tier} ${item.className}`).join(" → ") || "None"}`, `Skills: ${character.class.skills.map(item => `${item.name} [${item.gradeName}, ${item.mastery}%]`).join(", ") || "None"}`, `Traits: ${character.class.traits.map(item => `${item.name} [${item.gradeName}, ${item.mastery}%]`).join(", ") || "None"}`].join("\n"); }
  function shopsStatus(dms, target = "thronebound") {
    const lines = [];
    for (const kind of ["skill", "trait"]) {
      const facility = Object.values(dms.rooms).find(room => room.definition === shopDefinition(kind, false) && room.state === "Active"); if (!facility) continue;
      for (let tier = 1; tier <= facility.tier; tier++) {
        const shop = shopOptions(dms, target, kind, tier, false); if (!shop.visible) continue;
        lines.push(`${title(kind)} Shop Tier ${tier} — Target: ${shop.character.name}\n${shop.options.map(option => `${option.index}. [${option.state}] ${option.entry.name} — ${option.entry.description} Cost: ${option.price} ${dms.dungeon.resources.development.name} + ${option.price} ${dms.dungeon.resources.energy.name}${option.state === "Requires Resources" ? `; missing ${formatRequirements(option.affordability.missing)}` : ""}`).join("\n")}`);
      }
    }
    if (lines.length) return lines.join("\n\n");
    return dms.dungeon.tier < 1 ? "No ability shop is relevant during Tier 0 awakening." : "No active ability shop is currently available. Review Current Construction Options for facilities relevant to this Tier.";
  }
  function residenceStatus(dms) { applyDerivedState(dms); const workerHousing = dms.population.workers.cohorts.map(cohort => `${cohort.job}: ${cohort.residence} [${cohort.housingStatus}]`).join("\n") || "No Worker cohorts."; const characterHousing = Object.entries(dms.residences.assignments).map(([id, assignment]) => `${id}: ${dms.residences.named[id]?.name || dms.rooms[assignment.roomId]?.name || assignment.roomId}${dms.residences.stays[id] ? `; Current Stay ${dms.rooms[dms.residences.stays[id].roomId]?.name}` : ""}`).join("\n") || "No private character residences assigned."; return `Worker Residences\n${workerHousing}\n\nNamed and Private Residences\n${characterHousing}`; }
  function facilityTierStatus(dms, observe = false) { if (observe && dms.dungeon.tier >= 1) tierOneMilestone(dms, "tierRulesRead", true); return `Facility Tier cannot exceed Dungeon Tier ${dms.dungeon.tier}. The Throne Room reached Tier ${dms.rooms["room-throne"]?.tier || 0} with the Dungeon awakening. Expansion increases jobs or residential slots; a later facility Tier Up improves per-job yield, benefits, Appearance, and potential Worker Tier.`; }
  function administratorDevelopmentStatus(dms, observe = false) { if (observe && dms.dungeon.tier >= 1) tierOneMilestone(dms, "rankLevelRead", true); return "Administrator Rank (F–SSS) measures assignment effectiveness and can rise through Bond-gated Rank Up. Level measures personal experience and growth. A high-Rank summon may still be Level 1; Rank and Level never replace one another."; }
  ...
  function roomContext(dms, room) {
    ...
    return `Dungeon Room: ${room.name}. System Function: ${room.systemName || definition?.name}. State: ${room.state}. Tier: ${room.tier}. Expansion: ${room.expansion || 1}. Appearance: ${clean(room.lore?.appearance)} Function: ${clean(room.lore?.function || definition?.function)} Job: ${room.jobName || clean(room.lore?.job).split(":")[0] || definition?.job || "None"}. Throne Authority: ${authority || "None"}. Work Assignment: ${assigned || "Unassigned"}.`;
  }
  ...
  function migrateSavePayload(value) {
    ...
    return { ...value, sv: SAVE_SCHEMA, migratedFrom: Number(value.sv) };
  }
  ...
  function plotEssentialsText(dms) {
    const resourceLines = RESOURCE_ROLES.map(role => {
      ...
      const stock = resource.graded ? RESOURCE_GRADES.map(grade => `${grade.name} ${resource.grades[grade.name]}`).join("; ") : `${resource.amount} ungraded`;
      return `- ${title(role)} — ${resource.name}: ${stock}`;
    }).join("\n");
  ...
  function compactWorldSave(dms) { return { sv: SAVE_SCHEMA, rev: dms.persistence.revision, lustria: { sectors: dms.world.lustria.sectors, sites: dms.world.lustria.sites, veins: dms.world.lustria.veins, inventory: dms.world.lustria.inventory, inventoryGrades: dms.world.lustria.inventoryGrades, controlledSectors: dms.world.lustria.controlledSectors }, portals: dms.portals }; }
  function subsystemCardTitle(key, index = 0) { return index ? `${SAVE_CARD_TITLES[key]} ${index + 1}` : SAVE_CARD_TITLES[key]; }
  function nextSaveReserveKey() {
    let index = 1;
    while (global.storyCards.some(card => cardHasKey(card, `${SAVE_CARD_RESERVE_PREFIX}${index}`))) index++;
    return `${SAVE_CARD_RESERVE_PREFIX}${index}`;
  }
  function releaseSaveCard(index) {
    const card = global.storyCards[index], update = storyCardApi("update");
    if (!card || !update) return false;
    const reserveKey = nextSaveReserveKey();
    update(index, reserveKey, "Reserved hidden DMS save-card slot.", "System — DMS Reserve");
    card.keys = reserveKey; card.entry = "Reserved hidden DMS save-card slot."; card.type = "System — DMS Reserve"; card.__dmsManaged = false;
    return true;
  }
  function removeSubsystemCards(key, keep = 0) {
    ...
    for (let index = global.storyCards.length - 1; index >= 0; index--) {
      ...
      if ((card.title === base || new RegExp(`^${base.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")} \\d+$`).test(clean(card.title)) || saveKey) && !keptKeys.includes(saveKey || saveCardKeyForTitle(card.title))) {
        if (releaseSaveCard(index)) continue;
  ...
  function writeSubsystemCards(key, payload) {
    ...
    if (serialized.length <= SAVE_CARD_TARGET) entries = [serialized];
    else {
      let dataSize = 1000;
      do { const data = []; for (let offset = 0; offset < serialized.length; offset += dataSize) data.push(serialized.slice(offset, offset + dataSize)); entries = data.map((part, index) => JSON.stringify({ sv: SAVE_SCHEMA, rev: payload.rev, chunkIndex: index, chunkCount: data.length, data: part })); dataSize -= 100; } while (entries.some(entry => entry.length > SAVE_CARD_TARGET) && dataSize >= 200);
    }
  ...
  function readSubsystemCards(key) {
    ...
    if (!Number.isFinite(Number(first.chunkCount))) return first;
    const count = Math.max(1, Number(first.chunkCount) || 1), chunks = [];
    for (let index = 0; index < count; index++) { const chunk = savePayload(saveCardByTitle(subsystemCardTitle(key, index))); if (!chunk || Number(chunk.rev) !== Number(first.rev) || Number(chunk.chunkIndex) !== index || Number(chunk.chunkCount) !== count || typeof chunk.data !== "string") return null; chunks.push(chunk.data); }
    try { return migrateSavePayload(JSON.parse(chunks.join(""))); } catch { return null; }
  }
  function writeSaveCards(dms) {
    if (!Array.isArray(global.storyCards)) return false;
    const existing = readSaveCards(); if (existing && existing.revision > Number(dms.persistence.revision || 0)) return false;
    const parts = ["progression"], hasOperations = Object.keys(dms.rooms).length || dms.tasks.length || Object.keys(dms.reservations).length || dms.population.soldiers.cohorts.length || Object.keys(dms.shops.research).length || Object.keys(dms.equipment.items).length || Object.keys(dms.equipment.previews).length, lustria = dms.world.lustria, hasWorld = Object.keys(lustria.sectors).length || Object.keys(lustria.veins).length || Object.keys(lustria.inventory).length || lustria.controlledSectors.length || Object.keys(dms.portals.anchors).length || Object.keys(dms.portals.routes).length;
    if (hasOperations) parts.push("operations"); if (hasWorld) parts.push("world");
    ...
    for (const card of global.storyCards) if (clean(card.keys).split(",").some(key => key.startsWith("DMS_SAVE_"))) setStoryCardPresentation(card, false, false);
  ...
  function readSaveCards() {
    ...
    const core = readSubsystemCards("core"); if (!core) return null;
    const required = Array.isArray(core.parts) ? core.parts : ["progression", "operations", "world"], values = { core }, rev = Number(core.rev);
    for (const key of required) { const value = readSubsystemCards(key); if (!value || Number(value.rev) !== rev) return null; values[key] = value; }
  ...
  function restoreSavedAbilities(saved, lore = []) {
  ...
  function restoreClassLineage(saved) {
    return (Array.isArray(saved) ? saved : []).map(item => Array.isArray(item) ? { tier: Math.max(1, Number(item[0]) || 1), className: clean(item[1]), description: clean(item[2]), combatSkill: clean(item[3]), managementSkill: clean(item[4]), trait: clean(item[5]), acceptedCycle: Math.max(0, Number(item[6]) || 0) } : { ...item, tier: Math.max(1, Number(item?.tier) || 1), className: clean(item?.className) }).filter(item => item.className);
  }
  ...
  function loadSaveCards(candidate, snapshot = readSaveCards()) {
    ...
    if (Array.isArray(core.identity)) {
      let thronebound, race, dungeonName, theme, style, populationNature, populationAppearance, homeworld, homeworldDescription, homeworldAnchor, secondaryLocation, resourceLore;
      if (Number(core.idv) === 2) [thronebound, race, dungeonName, theme, style, populationNature, populationAppearance, homeworld, homeworldDescription, homeworldAnchor, secondaryLocation, ...resourceLore] = core.identity;
      else { let workers, soldiers; [thronebound, race, dungeonName, theme, style, workers, soldiers, homeworld, secondaryLocation, ...resourceLore] = core.identity; populationNature = "Legacy dungeon population"; populationAppearance = unique([workers, soldiers]).join("; "); }
      dms.thronebound.name = clean(thronebound) || dms.thronebound.name; dms.thronebound.race = clean(race) || dms.thronebound.race; dms.dungeon.name = clean(dungeonName) || dms.dungeon.name; dms.dungeon.theme = clean(theme) || dms.dungeon.theme; dms.dungeon.style = clean(style) || dms.dungeon.style; dms.population.nature = clean(populationNature) || dms.population.nature; dms.population.appearance = clean(populationAppearance) || dms.population.appearance; dms.world.homeworld = clean(homeworld) || dms.world.homeworld; dms.world.homeworldDescription = clean(homeworldDescription) || dms.world.homeworldDescription; dms.world.homeworldAnchor = clean(homeworldAnchor) || dms.world.homeworldAnchor; dms.world.secondaryLocation = clean(secondaryLocation); RESOURCE_ROLES.forEach((role, index) => { const lore = resourceLore[index]; if (Array.isArray(lore)) Object.assign(dms.dungeon.resources[role], { name: clean(lore[0]) || dms.dungeon.resources[role].name, description: clean(lore[1]), collection: clean(lore[2]), use: clean(lore[3]) }); });
      if (Number(core.idv) !== 2) { dms.world.homeworldDescription ||= `${dms.world.homeworld} is the Thronebound's established world of origin; its fuller description remains editable.`; dms.world.homeworldAnchor ||= `${dms.world.homeworld} Return Anchor`; }
    }
    ...
    for (const role of RESOURCE_ROLES) {
      ...
      if (role !== "energy" && Array.isArray(saved)) { resource.grades = emptyGradeStock(0); RESOURCE_GRADES.forEach((grade, index) => { resource.grades[grade.name] = Math.max(0, Number(saved[index]) || 0); }); resource.amount = 0; syncResource(resource); }
      else if (Number.isFinite(Number(saved))) { resource.amount = Number(saved); if (resource.graded) { resource.grades = emptyGradeStock(0); resource.grades.Basic = Math.max(0, Number(saved)); } syncResource(resource); }
    }
    dms.currencies.marks = Math.max(0, Number(core.marks) || 0);
    ...
    if (progression.story && typeof progression.story === "object") { const saved = progression.story; dms.story = { ...dms.story, ...saved, knownPaths: unique(saved.knownPaths || []), milestones: { ...dms.story.milestones, ...(saved.milestones || {}) }, knowledge: { ...dms.story.knowledge, ...(saved.knowledge || {}), dominion: { ...dms.story.knowledge.dominion, ...(saved.knowledge?.dominion || {}) } }, dungeonSector: { ...dms.story.dungeonSector, ...(saved.dungeonSector || {}), classification: { ...dms.story.dungeonSector.classification, ...(saved.dungeonSector?.classification || {}) }, observations: Array.isArray(saved.dungeonSector?.observations) ? saved.dungeonSector.observations : [], report: { ...dms.story.dungeonSector.report, ...(saved.dungeonSector?.report || {}) } }, intrusion: { ...dms.story.intrusion, ...(saved.intrusion || {}) }, remote: { ...dms.story.remote, ...(saved.remote || {}) }, customSectors: { ...dms.story.customSectors, ...(saved.customSectors || {}) } }; }
    ...
    dms.rooms = {}; for (const [id, saved] of Object.entries(operations.rooms || {})) { const definition = ROOM_DEFINITIONS[saved.definition]; if (!definition) continue; const restoredTier = saved.definition === "throne-room" ? Math.max(0, Number(saved.tier) || 0) : Math.max(1, Number(saved.tier) || definition.unlockTier || 1), manifested = manifestedRoomIdentity(dms, saved.definition), name = clean(saved.name) || manifested.name, jobName = clean(saved.job) || manifested.jobName, roomCard = managedCardByKey(`DMS_ROOM_${id.toUpperCase().replace(/\W/g, "_")}`), recoveredAppearance = cardField(roomCard, "Appearance"), lore = saved.definition === "throne-room" ? throneRoomLore(dms, restoredTier, { baseAppearance: dms.dungeon.lore.throneRoom || recoveredAppearance }) : roomLore(dms, definition, restoredTier, { systemName: definition.name, name, jobName }); if (recoveredAppearance) lore.appearance = recoveredAppearance; dms.rooms[id] = { id, definition: saved.definition, systemName: definition.name, name, jobName, tier: restoredTier, expansion: Math.max(1, Number(saved.expansion) || 1), state: saved.state || "Active", assignedWorkers: 0, jobPopulation: 0, targetedVeins: Array.isArray(saved.targetedVeins) ? saved.targetedVeins : [], assignedAdministrator: saved.assignedAdministrator || "", authorityAdministrator: saved.authorityAdministrator || "", lore }; }
  ...
  function setStoryCardPresentation(card, visible = true, spoiler = false) {
    if (!card || typeof card !== "object") return false;
    try {
      card.showInStoryCards = !!visible;
      card.isSpoiler = !!spoiler;
      const changedLocally = card.showInStoryCards === !!visible && card.isSpoiler === !!spoiler;
      // AI Dungeon's supported updateStoryCard API persists keys, entry, and type only.
      // These fields are authoritative for exported/imported decks, but runtime changes
      // use reveal-by-replacement so DMS never depends on unsupported metadata writes.
      return changedLocally && !hasLiveStoryCardApi();
    } catch { return false; }
  }
  function ensureCard(titleText, keys = "", dms = cardRegistryState) {
    ...
    if (card) remember();
    if (!card) {
      if (registry?.includes(registryKey) && !/^DMS_SAVE_/i.test(registryKey)) return null;
      if (storyCardApi("add")) {
        const reserveIndex = /^DMS_SAVE_/i.test(keys) && !keys.startsWith(SAVE_CARD_RESERVE_PREFIX) ? global.storyCards.findIndex(candidate => clean(candidate.keys).split(",").some(value => clean(value).startsWith(SAVE_CARD_RESERVE_PREFIX))) : -1;
        if (reserveIndex >= 0 && storyCardApi("update")) { card = global.storyCards[reserveIndex]; storyCardApi("update")(reserveIndex, keys, "", "System — DMS Save"); card.keys = keys; card.entry = ""; card.type = "System — DMS Save"; }
        else { const before = global.storyCards.length, result = storyCardApi("add")(keys, "", "System Cards"); card = Number.isInteger(result) ? global.storyCards[result] : global.storyCards.find(candidate => cardHasKey(candidate, keys)); if (!card && global.storyCards.length > before) card = global.storyCards[global.storyCards.length - 1]; if (!card) { card = { keys, entry: "", type: "System Cards" }; global.storyCards.push(card); } }
      }
    ...
    if (card) { remember(); if (!storyCardApi("add") && !storyCardApi("update")) { card.title = titleText; card.description ||= "Managed by the Dungeon Management System."; } card.keys = keys || card.keys; card.__dmsManaged = true; if (typeof card.showInStoryCards !== "boolean") setStoryCardPresentation(card, true, false); }
    return card;
  }
  ...
  function hasLiveStoryCardApi() { return !!(storyCardApi("add") && storyCardApi("update") && storyCardApi("remove")); }
  function forgetManagedCard(dms, key) {
    if (!dms?.generation) return;
    dms.generation.managedCardKeys = (dms.generation.managedCardKeys || []).filter(value => value !== key);
    dms.generation.revealedCardKeys = (dms.generation.revealedCardKeys || []).filter(value => value !== key);
  }
  function removeManagedCard(dms, key) {
    if (!Array.isArray(global.storyCards)) return false;
    let removed = false;
    for (let index = global.storyCards.length - 1; index >= 0; index--) if (cardHasKey(global.storyCards[index], key)) {
      const remove = storyCardApi("remove"), before = global.storyCards.length;
      if (remove) remove(index);
      if (!remove || global.storyCards.length === before) global.storyCards.splice(index, 1);
      removed = true;
    }
    forgetManagedCard(dms, key);
    return removed;
  }
  function revealManagedCard(dms, titleText, key) {
    dms.generation.revealedCardKeys ||= [];
    if (!hasLiveStoryCardApi()) {
      const card = ensureCard(titleText, key, dms); if (card) setStoryCardPresentation(card, true, false); return card;
    }
    if (!dms.generation.revealedCardKeys.includes(key)) {
      removeManagedCard(dms, key);
      dms.generation.revealedCardKeys.push(key);
    }
    return ensureCard(titleText, key, dms);
  }
  ...
  function refreshCards(dms) {
    ...
    for (const [definitionKey, definition] of Object.entries(ROOM_DEFINITIONS)) {
      ...
      if (availability.room) { removeManagedCard(dms, key); continue; }
      if (!availability.visible) {
        const hidden = ensureCard(titleText, key); if (hidden) { hidden.type = "System — Locked Facilities"; hidden.entry ||= "This facility is not part of the current player-visible progression."; setStoryCardPresentation(hidden, false, true); }
        continue;
      }
      const option = currentConstructionOptions.find(candidate => candidate.definitionKey === definitionKey), card = revealManagedCard(dms, titleText, key), requirements = availability.affordability?.requirements || requirementBalance(dms, availability.costs).requirements;
      if (card) { card.type = "Available Facilities"; card.entry = `${option?.optionId || definitionKey} [${availability.state}]\nManifested Name: ${availability.identity.name}\nSystem Function: ${definition.name}\nConstruction Requirements: ${formatRequirements(requirements)}${availability.state === "Available" ? "" : `\nCurrent Block: ${availability.reason}`}\nPlanned Appearance: ${availability.lore.appearance}\nFunction: ${availability.lore.function}\nJob: ${availability.identity.jobName}`; setStoryCardPresentation(card, true, false); }
    }
    ...
    for (const room of Object.values(dms.rooms)) {
      ...
      if (card) { const residential = definition.workerHousing ? `\nWorker Residences: ${definition.workerHousing * room.tier * Math.max(1, room.expansion || 1)}` : definition.administratorSuites ? `\nPrivate Suites: ${residenceCapacity(room)}` : definition.privateCapacity ? `\nGuest Capacity: ${residenceCapacity(room)}; Detainment Assignments: ${definition.detainmentSlots * Math.max(1, room.expansion || 1)}` : "", authority = dms.administrators[room.authorityAdministrator]?.name; card.entry = `System Function: ${room.systemName || definition.name}\nState: ${room.state}\nTier: ${room.tier}\nExpansion: ${room.expansion || 1}\nAppearance: ${room.lore.appearance}\nFunction: ${room.lore.function}\nJob: ${room.jobName || room.lore.job.split(":")[0]}\nThrone Authority: ${authority || "None"}\nWork Assignment: ${dms.administrators[room.assignedAdministrator]?.name || "Unassigned"}${residential}`; }
      const cohort = workerCohort(dms, room.id), jobName = room.jobName || room.lore.job.split(":")[0], job = cohort ? ensureCard(`DMS Job Cohort — ${room.id} — ${jobName}`, `DMS_JOB_${room.id.toUpperCase().replace(/\W/g, "_")}`) : null;
    ...
    for (const card of [...(global.storyCards || [])]) for (const key of String(card.keys || "").split(",").map(clean)) if (/^DMS_CLASS_PREVIEW_/i.test(key) && !activeClassPreviewKeys.has(key)) removeManagedCard(dms, key);
    for (const kind of ["skill", "trait"]) {
      const facility = Object.values(dms.rooms).find(room => room.definition === shopDefinition(kind, false) && room.state === "Active");
      for (let tier = 1; tier <= 10; tier++) {
        const key = `DMS_GENERAL_${kind.toUpperCase()}_SHOP_T${tier}`, shop = facility && tier <= facility.tier ? shopOptions(dms, "thronebound", kind, tier, false) : { visible: false };
        if (!shop.visible) { removeManagedCard(dms, key); continue; }
        const card = revealManagedCard(dms, `DMS General ${title(kind)} Shop — Tier ${tier}`, key);
        if (card) { card.type = "Ability Shops"; card.entry = `${title(kind)} Shop Tier ${tier}\nTarget: ${shop.character.name}\n${shop.options.map(option => `${option.index}. [${option.state}] ${option.entry.name} — ${option.entry.description} Cost: ${option.price} ${dms.dungeon.resources.development.name} + ${option.price} ${dms.dungeon.resources.energy.name}${option.state === "Requires Resources" ? `; missing ${formatRequirements(option.affordability.missing)}` : ""}`).join("\n")}`; setStoryCardPresentation(card, true, false); }
      }
    }
    for (const kind of ["skill", "trait"]) {
      const shop = dms.shops.custom[kind], key = `DMS_CUSTOM_${kind.toUpperCase()}_SHOP`, availability = shop ? shopOptions(dms, "thronebound", kind, Object.values(dms.rooms).find(room => room.definition === shopDefinition(kind, true) && room.state === "Active")?.tier || 1, true) : { visible: false };
      if (!shop || !availability.visible) { removeManagedCard(dms, key); continue; }
      const card = revealManagedCard(dms, `DMS Custom ${title(kind)} Shop — ${shop.theme}`, key);
      if (card) { card.type = "Ability Shops"; card.entry = `Theme: ${shop.theme}\nTarget: ${availability.character.name}\n${availability.options.map(option => `${option.index}. [${option.state}] ${option.entry.name} — ${option.entry.description} Cost: ${option.price} ${dms.dungeon.resources.development.name} + ${option.price} ${dms.dungeon.resources.energy.name}`).join("\n")}`; setStoryCardPresentation(card, true, false); }
    }
    for (const [purpose, options] of Object.entries(dms.equipment.previews)) { const card = ensureCard(`DMS Equipment Options — ${purpose}`, `DMS_EQUIPMENT_OPTIONS_${stableNumber(purpose).toString(36).toUpperCase()}`); if (card) card.entry = options.map(option => `${option.id}: ${option.name} [${option.grade}, Tier ${option.tier}, ${option.slot}] — ${option.description} Bonuses: ${JSON.stringify(option.bonuses)}`).join("\n"); }
    for (const item of Object.values(dms.equipment.items)) { const card = ensureCard(`DMS Equipment — ${item.id} — ${item.name}`, `DMS_EQUIPMENT_${item.id.toUpperCase().replace(/\W/g, "_")}`); if (card) card.entry = `${item.name}\nSlot: ${item.slot}\nTier: ${item.tier}\nGrade: ${item.grade}\nAssigned To: ${item.assignedTo || "Unassigned"}\nBonuses: ${JSON.stringify(item.bonuses)}\nDescription: ${item.description}`; }
  ...
  function commandProgressionTier(body) {
    const gates = [
  ...
  function execute(dms, raw) {
    ...
    if (!body || /^help$/i.test(body)) return systemHelp(dms);
    const progressionTier = commandProgressionTier(body); if (dms.dungeon.tier < progressionTier) throw new Error("That function is not available in the current progression.");
    ...
    else if (/^administrator\s+development$/i.test(body)) output = administratorDevelopmentStatus(dms, true);
    else if (/^ability\s+grades$/i.test(body)) { tierOneMilestone(dms, "masteryGradeRead", true); output = "Abilities gain mastery through training. At 100% mastery, an ordinary ability may Grade Up when the Dungeon reaches its next Grade band: Basic Tier 1, Intermediate Tier 4, Advanced Tier 7, Mastery Tier 10. Unique, Apex, and Growth abilities use their own rules."; }
    else if (/^activity$/i.test(body)) output = activityStatus(dms);
    else if (/^discoveries$/i.test(body)) output = discoveryStatus(dms);
    else if (/^signature$/i.test(body)) output = signatureStatus(dms);
    else if (/^tier\s+requirements$/i.test(body)) output = tierRequirementsStatus(dms, true);
    else if (/^load$/i.test(body)) { const loaded = loadSaveCards(dms); for (const key of Object.keys(dms)) delete dms[key]; Object.assign(dms, loaded); output = `Loaded DMS Save revision ${dms.persistence.revision}.`; }
    else if ((match = body.match(/^setup\s+(.+)$/i))) { const values = split(match[1]), legacy = values.length <= 9; configure(dms, legacy ? { thronebound: values[0], race: values[1], name: values[2], theme: values[3], style: values[4], workerDescription: values[5], soldierDescription: values[6], homeworld: values[7], secondaryLocation: values[8] } : { thronebound: values[0], race: values[1], name: values[2], theme: values[3], style: values[4], populationNature: values[5], populationAppearance: values[6], homeworld: values[7], homeworldDescription: values[8], homeworldAnchor: values[9], growthPreferences: values[10] }); output = "Tier 0 dungeon identity recorded. Scenario variables remain the intended initialization path; this command is a fallback only."; }
    ...
    else if ((match = body.match(/^story\s+path\s+(.+)$/i))) { const path = selectDevelopmentPath(dms, match[1]); output = `${path.name} selected as the Dungeon's emerging approach. It remains reversible until Tier 3 doctrine crystallization.`; }
    else if (/^room\s+list$/i.test(body)) output = constructionOptionsStatus(dms);
    ...
    else if (/^task\s+list$/i.test(body)) output = dms.tasks.map(task => `${task.id} [${task.type}] ${task.remaining} Cycle(s); reservation ${task.reservationId || "None"}`).join("\n") || "No active tasks.";
    else if ((match = body.match(/^task\s+cancel\s+(.+)$/i))) { const task = cancelTask(dms, match[1]); output = `Cancelled ${task.id}; its reservation was returned.`; }
    ...
    else if ((match = body.match(/^bond\s+begin\s+(.+)$/i))) { const administrator = resolveCharacter(dms, match[1]); if (!administrator?.id) throw new Error("Bond Activity requires an Administrator target."); setActivity(dms, "Bond", [administrator.id], "Slow"); output = `Bond Activity begun with ${administrator.name} at Slow Pace. Meaningful personal actions can now develop Bond and complete eligible Bond Events.`; }
    ...
    else if ((match = body.match(/^class\s+(?:preview|regenerate)(?:\s+(.+))?$/i))) { const previews = generateClassPreviews(dms, match[1] || "thronebound"); output = `Generated ${previews.length} editable Class Preview card(s).`; }
    ...
    else if ((match = body.match(/^residence\s+assign\s+(.+)$/i))) { const [target, room] = split(match[1]), resident = residenceTarget(dms, target), assignment = assignResidence(dms, target, room || "Administrator Quarters"); output = `${resident.character.name} received a private suite in ${dms.rooms[assignment.roomId].name}.`; }
    else if ((match = body.match(/^residence\s+name\s+(.+)$/i))) { const [target, name, bonus] = split(match[1]), residence = nameResidence(dms, target, name, "", bonus || "Bond"); output = `${residence.name} established with its ${residence.bonus} specialization.`; }
    else if ((match = body.match(/^residence\s+stay\s+(.+)$/i))) { const [target, room] = split(match[1]), stay = assignPrivateStay(dms, target, room || "Thronebound Private Chamber"); output = `${stay.name} is currently staying in ${dms.rooms[stay.roomId].name}.`; }
    else if ((match = body.match(/^residence\s+detain\s+(.+)$/i))) { const [target, room] = split(match[1]), detainment = assignDetainment(dms, target, room || "Thronebound Private Chamber"); output = `${detainment.name} received a controlled detainment assignment in ${dms.rooms[detainment.roomId].name}.`; }
    else if ((match = body.match(/^equipment\s+preview(?:\s+(.+))?$/i))) { const options = generateEquipmentOptions(dms, match[1] || "General"); output = options.map(option => `${option.id}: ${option.name} [${option.grade} ${option.slot}] ${JSON.stringify(option.bonuses)}`).join("\n"); }
    else if ((match = body.match(/^equipment\s+craft\s+(.+)$/i))) { const [optionId, target] = split(match[1]), task = craftEquipment(dms, optionId, target); output = `Crafting ${task.option.name} as ${task.itemId}; ${task.remaining} Cycle(s).`; }
    else if ((match = body.match(/^equipment\s+assign\s+(.+)$/i))) { const [itemId, target] = split(match[1]), item = assignEquipment(dms, itemId, target); output = `${item.name} assigned to ${item.assignedTo}.`; }
    else if (/^portal\s+anchors$/i.test(body)) output = Object.values(dms.portals.anchors).map(anchor => `${anchor.id} [${anchor.status}] ${anchor.major}${anchor.secondary ? ` — ${anchor.secondary}` : ""}`).join("\n") || "No known Portal Anchors.";
    else if (/^portal\s+routes$/i.test(body)) output = `Capacity ${Object.values(dms.portals.routes).filter(route => route.status === "Active").length}/${portalRouteLimit(dms)}\n${Object.values(dms.portals.routes).map(route => `${route.id} [${route.status}] ${route.anchorId}`).join("\n") || "No portal routes."}`;
    else if ((match = body.match(/^portal\s+open\s+(.+)$/i))) { const route = openPortalRoute(dms, match[1]); output = `Opened ${route.id} to ${route.anchorId}.`; }
    else if ((match = body.match(/^portal\s+close\s+(.+)$/i))) { const route = closePortalRoute(dms, match[1]); output = `Closed ${route.id}.`; }
    else if ((match = body.match(/^portal\s+travel\s+(.+)$/i))) { const result = travelPortalRoute(dms, match[1]); output = `Travelled through ${result.route.id} to ${result.anchor.major}${result.anchor.secondary ? ` — ${result.anchor.secondary}` : ""}.`; }
    ...
    else if ((match = body.match(/^quest\s+report(?:\s+(.+))?$/i))) { const result = reportQuest(dms, match[1] || ""); output = `Reported ${result.quest.title}; Levels gained ${result.levels?.length || 0}.${result.followup ? ` Follow-up: ${result.followup.title}.` : ""}`; }
    else if (/^quest\s+complete\b/i.test(body)) throw new Error("Direct Quest completion is disabled. Fulfill the objective through play; Guild and Bounty contracts must then be reported to the Guild.");
  ...
  const api = Object.freeze({ DMS_VERSION, DMS_DEVELOPMENT_STATE, SCHEMA, SAVE_SCHEMA, SAVE_CARD_TITLES, SAVE_CARD_TARGET, SAVE_CARD_MAX, VERIFIED_DUNGEON_TIER, DMS_INITIALIZATION_FORMAT, DMS_INITIALIZATION_VERSION, DMS_INITIALIZATION_QUESTION, DUNGEON_ATTRIBUTE_PRIORITIES, LEGACY_DUNGEON_ATTRIBUTE_DOMAINS, CONTEXT_INJECTION_TABLE, RESOURCE_ROLES, RESOURCE_GRADES, SCENARIO_QUESTIONS, LOCATIONS, MODES, PACES, ACTIVITY_PACES, SOLDIER_ARCHETYPES, ADMINISTRATOR_RANKS, APTITUDE_OUTCOMES, QUEST_CATEGORIES, QUEST_MISSION_TYPES, STORY_SECTOR_STATES, STORY_DEVELOPMENT_PATHS, STORY_TIER_FRAMEWORK, STORY_QUESTS, SYSTEM_CONCEPTS, CLASS_GRADES, ROOM_DEFINITIONS, ROOM_MANIFESTATION_NOUNS, JOB_MANIFESTATION_NOUNS, LUSTRIAN_RESOURCES, GLOBAL_LUSTRIA_LORE, defaultState, normalize, configure, defineResource, adaptGeneratorStoryBible, parseInitializationJson, scenarioSetup, initializeFromScenarioVariables, syncScenarioPlot, plotEssentialsText, activityStateText, authorNoteText, coreIdentityReady, resourcesReady, aptitudeNames, aptitudesReady, growthPreferencesReady, uniqueAttributesReady, dungeonAttributesReady, populationDescription, identityReady, tierRules, availableRoomDefinitions, roomAvailability, constructionOptions, constructionOptionsStatus, manifestedRoomIdentity, createRoom, upgradeRoom, expandRoom, upgradeDungeon, applyDerivedState, disruptWorkerCohort, workerEfficiency, assignResidence, nameResidence, assignPrivateStay, assignDetainment, transactResources, transactInventory, transactMarks, spend, rewardResources, refineResource, reserveResources, commitReservation, returnReservation, resourceStorage, cancelTask, recruitSoldiers, combatPower, defensePower, summonAdministrator, createAdministrator, assignAdministrator, administratorAssignmentEffectiveness, addAdministratorBond, completeBondEvent, rankUpAdministrator, generateClassPreviews, acceptClassPreview, buySkill, shopOptions, buyShopEntry, trainSkill, upgradeSkillGrade, defineUniqueAttribute, configureAptitude, configureGrowthPreferences, confirmAptitudes, growAttributes, growDungeonAttributes, dungeonAttributeMultiplier, trainAttribute, createQuest, completeQuest, reportQuest, recordQuestOutcome, questPrerequisitesMet, awardQuest, questReference, renderQuestText, validateQuestTemplate, questRequiredConditionsMet, questCompletionConditionsMet, processQuestAction, triggerGroupMatches, triggerGroupsMatch, formatTriggerGroups, formatQuestNotifications, drainQuestNotifications, researchCustomShop, defineCustomShop, generateEquipmentOptions, craftEquipment, assignEquipment, recordPortalAnchor, openPortalRoute, closePortalRoute, travelPortalRoute, portalRouteLimit, canonicalLocation, setLocation, setActivity, systemAvailable, canonicalDmsCommand, systemConcept, systemConceptAvailable, naturalSystemCommand, narrativeManagementCommand, narrativeResolutionText, tutorialGuidance, systemHelp, applyActivityTurn, dungeonSectorRecord, beginDungeonExterior, addDungeonSectorTravelContext, scheduleDungeonSectorSnapshot, capturePendingDungeonSectorSnapshot, recordDungeonSectorObservation, startStoryIntrusion, resolveStoryIntrusion, compileDungeonSectorReport, reviewDungeonSectorReport, ensureStoryRemoteSector, ensureStoryRemoteSite, visitStoryLocation, recordStoryKnowledge, selectDevelopmentPath, recordStoryMilestone, commitDevelopmentPath, storyRequirementForTier, storyMapStatus, ensureFutureStoryTier, updateStoryQuests, scoutSector, targetVein, secureSector, resolveCycle, advanceActivity, updateQuests, dungeonSignature, status, resourcesStatus, facilitiesStatus, administratorsStatus, administratorCapacityStatus, summoningStatus, populationStatus, productionStatus, classPreviewsStatus, classSelectionRequirementsStatus, evolutionStatus, abilitiesStatus, shopsStatus, residenceStatus, bondStatus, questsStatus, facilityTierStatus, administratorDevelopmentStatus, activityStatus, discoveryStatus, signatureStatus, tierRequirementsStatus, contextGuidance, controlledGenerationContext, setStoryCardPresentation, refreshCards, assertSaveCardCharacterLimits, writeSaveCards, readSaveCards, loadSaveCards, execute, stableNumber });
  global.DMSCore = api;
  ...
  if (typeof global.state !== "undefined") {
    const root = () => {
      ...
      let dms = normalize(global.state.DMS, { updateQuests: false });
      ...
      try { initializeFromScenarioVariables(dms, global.state.placeholders); delete global.state.DMSSetupError; }
      catch (error) { global.state.DMSSetupError = `Scenario variable setup was not imported: ${error.message}`; }
      syncScenarioPlot(dms);
    ...
    global.DungeonManagement = function DungeonManagement(hook) {
      ...
      if (hook === "input") {
        ...
        dms.activity.lastOutcome = outcome;
        if (outcome.narrativeResolution) global.state.DMSNarrativeResolution = outcome.narrativeResolution; else delete global.state.DMSNarrativeResolution;
        writeSaveCards(dms); return;
      }
      if (hook === "context") {

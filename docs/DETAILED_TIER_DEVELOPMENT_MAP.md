...
- First Contact captures delayed narrative snapshots, supplies every accumulated record to the Manager-report generation turn, preserves unsupported fields as `Unknown`, and records the resulting Sector description in lore and system cards. After the intrusion and report, the Perimeter Scout Post establishes the scouting foundation required by Tier 2.
